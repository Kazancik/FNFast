...
class HXCPP_CLASS_ATTRIBUTES LoadingState_obj : public  ::backend::MusicBeatState_obj
{
	...
	public:
		...
		static void checkAudioSources( ::Dynamic song, ::Dynamic onDone);
		static ::Dynamic checkAudioSources_dyn();
		...
		static void ensureSongMaterials( ::Dynamic song);
		static ::Dynamic ensureSongMaterials_dyn();
