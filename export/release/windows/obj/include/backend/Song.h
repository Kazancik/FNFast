...
HXLINE(  67)		( ( ::backend::Song)(__this) )->format = HX_("psych_v1",bf,0a,17,5b);
HXLINE(  66)		( ( ::backend::Song)(__this) )->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  65)		( ( ::backend::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  64)		( ( ::backend::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  62)		( ( ::backend::Song)(__this) )->speed = ((Float)1);
HXLINE(  61)		( ( ::backend::Song)(__this) )->disableNoteRGB = false;
