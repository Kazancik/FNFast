...
HX_DEFINE_STACK_FRAME(_hx_pos_b4e7cc65cbc49df7_727_new,"openfl.filters._GlowFilter.InnerCombineKnockoutShader","new",0x68ce62f5,"openfl.filters._GlowFilter.InnerCombineKnockoutShader.new","openfl/filters/GlowFilter.hx",727,0x5f568606)
...
void InnerCombineKnockoutShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b4e7cc65cbc49df7_727_new)
...
HXLINE( 728)		super::__construct(null());
HXLINE( 730)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_b9e2c483_1,2);
HXLINE( 700)		this->_hx___isGenerated = true;
HXDLIN( 700)		this->_hx___initGL();
            	}
