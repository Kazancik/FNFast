...
HX_DEFINE_STACK_FRAME(_hx_pos_c52fd1f1f4f31101_688_new,"openfl.filters._GlowFilter.CombineKnockoutShader","new",0x663c6195,"openfl.filters._GlowFilter.CombineKnockoutShader.new","openfl/filters/GlowFilter.hx",688,0x5f568606)
...
void CombineKnockoutShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c52fd1f1f4f31101_688_new)
...
HXLINE( 689)		super::__construct(null());
HXLINE( 691)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_af84f323_1,2);
HXLINE( 661)		this->_hx___isGenerated = true;
HXDLIN( 661)		this->_hx___initGL();
            	}
