...
HX_DEFINE_STACK_FRAME(_hx_pos_9729ccfc0a6c6d24_501_new,"openfl.filters._GlowFilter.InvertAlphaShader","new",0xf5d98ca4,"openfl.filters._GlowFilter.InvertAlphaShader.new","openfl/filters/GlowFilter.hx",501,0x5f568606)
namespace openfl{
namespace filters{
namespace _GlowFilter{

void InvertAlphaShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_9729ccfc0a6c6d24_501_new)
...
HXLINE( 478)		this->_hx___isGenerated = true;
HXDLIN( 478)		this->_hx___initGL();
            	}
