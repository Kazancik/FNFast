...
HX_DEFINE_STACK_FRAME(_hx_pos_bfba60fe12c23493_610_new,"openfl.filters._GlowFilter.CombineShader","new",0x929ab2fb,"openfl.filters._GlowFilter.CombineShader.new","openfl/filters/GlowFilter.hx",610,0x5f568606)
...
void CombineShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_bfba60fe12c23493_610_new)
...
HXLINE( 611)		super::__construct(null());
HXLINE( 613)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_1cf91989_1,2);
HXLINE( 583)		this->_hx___isGenerated = true;
HXDLIN( 583)		this->_hx___initGL();
            	}
