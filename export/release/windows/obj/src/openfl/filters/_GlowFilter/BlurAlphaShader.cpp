...
HX_DEFINE_STACK_FRAME(_hx_pos_6216d328fc85d16b_569_new,"openfl.filters._GlowFilter.BlurAlphaShader","new",0x982180f3,"openfl.filters._GlowFilter.BlurAlphaShader.new","openfl/filters/GlowFilter.hx",569,0x5f568606)
...
void BlurAlphaShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6216d328fc85d16b_569_new)
...
HXLINE( 570)		super::__construct(null());
HXLINE( 572)		this->uRadius->value = ::Array_obj< Float >::fromData( _hx_array_data_3a938b81_1,2);
HXLINE( 573)		this->uColor->value = ::Array_obj< Float >::fromData( _hx_array_data_3a938b81_2,4);
HXLINE( 574)		this->uStrength->value = ::Array_obj< Float >::fromData( _hx_array_data_3a938b81_3,1);
HXLINE( 510)		this->_hx___isGenerated = true;
HXDLIN( 510)		this->_hx___initGL();
            	}
