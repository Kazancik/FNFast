...
HX_DEFINE_STACK_FRAME(_hx_pos_4c03b94c358d6de6_336_new,"openfl.filters._BlurFilter.BlurShader","new",0x1c9d0f9f,"openfl.filters._BlurFilter.BlurShader.new","openfl/filters/BlurFilter.hx",336,0x46563eac)
static const Float _hx_array_data_309f542d_1[] = {
	(Float)0,(Float)0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_4c03b94c358d6de6_345___update,"openfl.filters._BlurFilter.BlurShader","__update",0x96830d8a,"openfl.filters._BlurFilter.BlurShader.__update","openfl/filters/BlurFilter.hx",345,0x46563eac)
namespace openfl{
namespace filters{
namespace _BlurFilter{

void BlurShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4c03b94c358d6de6_336_new)
HXLINE( 183)		if (::hx::IsNull( this->_hx___glFragmentSource )) {
HXLINE( 185)			this->_hx___glFragmentSource = HX_("uniform sampler2D openfl_Texture;\n\n\t\tvarying vec2 vBlurCoords[7];\n\n\t\tvoid main(void) {\n\n\t\t\tvec4 sum = vec4(0.0);\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[0]) * 0.00443;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[1]) * 0.05399;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[2]) * 0.24197;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[3]) * 0.39894;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[4]) * 0.24197;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[5]) * 0.05399;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[6]) * 0.00443;\n\n\t\t\tgl_FragColor = sum;\n\n\t\t}",d4,2c,4c,ca);
            		}
...
HXLINE( 337)		super::__construct(null());
HXLINE( 340)		this->uRadius->value = ::Array_obj< Float >::fromData( _hx_array_data_309f542d_1,2);
HXLINE( 292)		this->_hx___isGenerated = true;
HXDLIN( 292)		this->_hx___initGL();
            	}
...
void BlurShader_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_4c03b94c358d6de6_345___update)
HXLINE( 347)		this->uTextureSize->value = ::Array_obj< Float >::__new(2)->init(0,this->_hx___texture->input->width)->init(1,this->_hx___texture->input->height);
HXLINE( 350)		this->super::_hx___update();
            	}
