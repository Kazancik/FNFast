...
HX_DEFINE_STACK_FRAME(_hx_pos_07af302b8e600910_584_new,"openfl.filters._DropShadowFilter.HideShader","new",0x8120a732,"openfl.filters._DropShadowFilter.HideShader.new","openfl/filters/DropShadowFilter.hx",584,0x048fdea4)
...
void HideShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_07af302b8e600910_584_new)
...
HXLINE( 585)		super::__construct(null());
HXLINE( 587)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_2554e640_1,2);
HXLINE( 560)		this->_hx___isGenerated = true;
HXDLIN( 560)		this->_hx___initGL();
            	}
