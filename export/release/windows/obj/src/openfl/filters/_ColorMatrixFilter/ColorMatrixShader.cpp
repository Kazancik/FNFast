...
HX_DEFINE_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_282_new,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","new",0xf11da59b,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.new","openfl/filters/ColorMatrixFilter.hx",282,0xb64128b5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_292_init,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","init",0x058bf975,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.init","openfl/filters/ColorMatrixFilter.hx",292,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_255_boot,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","boot",0x00ec4297,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.boot","openfl/filters/ColorMatrixFilter.hx",255,0xb64128b5)
namespace openfl{
namespace filters{
namespace _ColorMatrixFilter{

void ColorMatrixShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_282_new)
...
HXLINE( 283)		super::__construct(null());
HXLINE( 286)		this->uMultipliers->value = ::Array_obj< Float >::fromData( _hx_array_data_a1263c29_1,16);
HXLINE( 287)		this->uOffsets->value = ::Array_obj< Float >::fromData( _hx_array_data_a1263c29_2,4);
HXLINE( 255)		this->_hx___isGenerated = true;
HXDLIN( 255)		this->_hx___initGL();
            	}
...
void ColorMatrixShader_obj::init(::Array< Float > matrix){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_292_init)
HXLINE( 294)		::Array< Float > multipliers = this->uMultipliers->value;
HXLINE( 295)		::Array< Float > offsets = this->uOffsets->value;
HXLINE( 297)		multipliers[0] = matrix->__get(0);
HXLINE( 298)		multipliers[1] = matrix->__get(1);
HXLINE( 299)		multipliers[2] = matrix->__get(2);
HXLINE( 300)		multipliers[3] = matrix->__get(3);
HXLINE( 301)		multipliers[4] = matrix->__get(5);
HXLINE( 302)		multipliers[5] = matrix->__get(6);
HXLINE( 303)		multipliers[6] = matrix->__get(7);
HXLINE( 304)		multipliers[7] = matrix->__get(8);
HXLINE( 305)		multipliers[8] = matrix->__get(10);
HXLINE( 306)		multipliers[9] = matrix->__get(11);
HXLINE( 307)		multipliers[10] = matrix->__get(12);
HXLINE( 308)		multipliers[11] = matrix->__get(13);
HXLINE( 309)		multipliers[12] = matrix->__get(15);
HXLINE( 310)		multipliers[13] = matrix->__get(16);
HXLINE( 311)		multipliers[14] = matrix->__get(17);
HXLINE( 312)		multipliers[15] = matrix->__get(18);
HXLINE( 314)		offsets[0] = (matrix->__get(4) / ((Float)255.0));
HXLINE( 315)		offsets[1] = (matrix->__get(9) / ((Float)255.0));
HXLINE( 316)		offsets[2] = (matrix->__get(14) / ((Float)255.0));
HXLINE( 317)		offsets[3] = (matrix->__get(19) / ((Float)255.0));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_255_boot)
HXDLIN( 255)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
