...
HXDLIN( 407)			 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(skin,parentFolder,null());
HXDLIN( 407)			::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN( 407)			 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp6;
HXDLIN( 407)			bool _hx_tmp7;
HXDLIN( 407)			if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE( 407)				_hx_tmp7 = ::lime::utils::Assets_obj::exists(xml,null());
            			}
            			else {
HXLINE( 407)				_hx_tmp7 = true;
            			}
HXDLIN( 407)			if (_hx_tmp7) {
HXLINE( 407)				_hx_tmp6 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            			}
            			else {
HXLINE( 407)				::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + skin) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN( 407)				_hx_tmp6 = null();
            			}
HXDLIN( 407)			this->set_frames(_hx_tmp6);
HXLINE( 408)			this->loadNoteAnims();
HXLINE( 409)			if (!(this->isSustainNote)) {
HXLINE( 411)				this->centerOffsets(null());
HXLINE( 412)				{
HXLINE( 412)					 ::flixel::math::FlxBasePoint this1 = this->origin;
HXDLIN( 412)					Float y = (( (Float)(this->frameHeight) ) * ((Float)0.5));
HXDLIN( 412)					this1->set_x((( (Float)(this->frameWidth) ) * ((Float)0.5)));
