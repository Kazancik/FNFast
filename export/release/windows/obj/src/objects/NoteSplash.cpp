...
HXDLIN(  73)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(key,parentFolder,null());
HXDLIN(  73)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN(  73)		 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp2;
HXDLIN(  73)		bool _hx_tmp3;
HXDLIN(  73)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE(  73)			_hx_tmp3 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE(  73)			_hx_tmp3 = true;
            		}
HXDLIN(  73)		if (_hx_tmp3) {
HXLINE(  73)			_hx_tmp2 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE(  73)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + key) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  73)			_hx_tmp2 = null();
            		}
HXDLIN(  73)		this->set_frames(_hx_tmp2);
...
HXLINE(  77)			::String key1 = this->texture;
...
HXDLIN(  77)			 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp4;
HXDLIN(  77)			bool _hx_tmp5;
HXDLIN(  77)			if (!(::sys::FileSystem_obj::exists(xml1))) {
HXLINE(  77)				_hx_tmp5 = ::lime::utils::Assets_obj::exists(xml1,null());
            			}
            			else {
HXLINE(  77)				_hx_tmp5 = true;
            			}
HXDLIN(  77)			if (_hx_tmp5) {
HXLINE(  77)				_hx_tmp4 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image1,::lime::utils::Assets_obj::getText(xml1));
            			}
            			else {
...
HXDLIN(  77)				_hx_tmp4 = null();
            			}
HXDLIN(  77)			this->set_frames(_hx_tmp4);
HXLINE(  78)			if (::hx::IsNull( this->frames )) {
HXLINE(  80)				this->texture = ::objects::NoteSplash_obj::defaultNoteSplash;
HXLINE(  81)				::String key2 = this->texture;
HXDLIN(  81)				::String parentFolder2 = null();
HXDLIN(  81)				 ::flixel::graphics::FlxGraphic image2 = ::backend::Paths_obj::image(key2,parentFolder2,null());
HXDLIN(  81)				::String xml2 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key2) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder2,null());
HXDLIN(  81)				 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp6;
HXDLIN(  81)				bool _hx_tmp7;
HXDLIN(  81)				if (!(::sys::FileSystem_obj::exists(xml2))) {
HXLINE(  81)					_hx_tmp7 = ::lime::utils::Assets_obj::exists(xml2,null());
            				}
            				else {
HXLINE(  81)					_hx_tmp7 = true;
            				}
HXDLIN(  81)				if (_hx_tmp7) {
HXLINE(  81)					_hx_tmp6 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image2,::lime::utils::Assets_obj::getText(xml2));
            				}
            				else {
HXLINE(  81)					::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + key2) + HX_(" at path: ",f8,de,24,03)) + xml2),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  81)					_hx_tmp6 = null();
            				}
HXDLIN(  81)				this->set_frames(_hx_tmp6);
            			}
            		}
