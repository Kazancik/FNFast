...
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_56_setAlignmentFromString,"objects.Alphabet","setAlignmentFromString",0xf8f58cbd,"objects.Alphabet.setAlignmentFromString","objects/Alphabet.hx",56,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_68_set_alignment,"objects.Alphabet","set_alignment",0x90b4bc45,"objects.Alphabet.set_alignment","objects/Alphabet.hx",68,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_76_updateAlignment,"objects.Alphabet","updateAlignment",0xd204f4d9,"objects.Alphabet.updateAlignment","objects/Alphabet.hx",76,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_96_set_text,"objects.Alphabet","set_text",0x90f56e8b,"objects.Alphabet.set_text","objects/Alphabet.hx",96,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_106_clearLetters,"objects.Alphabet","clearLetters",0xc9cf6021,"objects.Alphabet.clearLetters","objects/Alphabet.hx",106,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_124_setScale,"objects.Alphabet","setScale",0x9ce6c469,"objects.Alphabet.setScale","objects/Alphabet.hx",124,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_139_set_scaleX,"objects.Alphabet","set_scaleX",0x2fb43fec,"objects.Alphabet.set_scaleX","objects/Alphabet.hx",139,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_150_set_scaleY,"objects.Alphabet","set_scaleY",0x2fb43fed,"objects.Alphabet.set_scaleY","objects/Alphabet.hx",150,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_161_softReloadLetters,"objects.Alphabet","softReloadLetters",0x324db629,"objects.Alphabet.softReloadLetters","objects/Alphabet.hx",161,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_177_update,"objects.Alphabet","update",0x5df268aa,"objects.Alphabet.update","objects/Alphabet.hx",177,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_191_snapToPosition,"objects.Alphabet","snapToPosition",0x56a3fbcf,"objects.Alphabet.snapToPosition","objects/Alphabet.hx",191,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_203_createLetters,"objects.Alphabet","createLetters",0x8cde98b0,"objects.Alphabet.createLetters","objects/Alphabet.hx",203,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_19_ensureInit,"objects.Alphabet","ensureInit",0x205a5b0f,"objects.Alphabet.ensureInit","objects/Alphabet.hx",19,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_16_boot,"objects.Alphabet","boot",0x2edccc93,"objects.Alphabet.boot","objects/Alphabet.hx",16,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_200_boot,"objects.Alphabet","boot",0x2edccc93,"objects.Alphabet.boot","objects/Alphabet.hx",200,0x083c86d0)
namespace objects{
...
HXLINE(  44)		::objects::Alphabet_obj::ensureInit();
...
void Alphabet_obj::setAlignmentFromString(::String align){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_56_setAlignmentFromString)
...
HXLINE(  61)			this->set_alignment(::objects::Alignment_obj::CENTERED_dyn());
HXDLIN(  61)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(  59)			this->set_alignment(::objects::Alignment_obj::RIGHT_dyn());
HXDLIN(  59)			goto _hx_goto_1;
            		}
            		/* default */{
HXLINE(  63)			this->set_alignment(::objects::Alignment_obj::LEFT_dyn());
            		}
            		_hx_goto_1:;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Alphabet_obj,setAlignmentFromString,(void))
 ...
 ::objects::Alignment Alphabet_obj::set_alignment( ::objects::Alignment align){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_68_set_alignment)
...
void Alphabet_obj::updateAlignment(){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_76_updateAlignment)
HXDLIN(  76)		int _g = 0;
HXDLIN(  76)		::Array< ::Dynamic> _g1 = this->letters;
HXDLIN(  76)		while((_g < _g1->length)){
HXDLIN(  76)			 ::objects::AlphaCharacter letter = _g1->__get(_g).StaticCast<  ::objects::AlphaCharacter >();
HXDLIN(  76)			_g = (_g + 1);
...
HXLINE(  90)			letter->alignOffset = (newOffset * this->scale->x);
HXLINE(  91)			letter->offset->set_x((letter->offset->x + letter->alignOffset));
            		}
            	}
...
::String Alphabet_obj::set_text(::String newText){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_96_set_text)
...
void Alphabet_obj::clearLetters(){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_106_clearLetters)
HXLINE( 107)		int i = this->letters->length;
HXLINE( 108)		while((i > 0)){
HXLINE( 110)			i = (i - 1);
HXLINE( 111)			 ::objects::AlphaCharacter letter = this->letters->__get(i).StaticCast<  ::objects::AlphaCharacter >();
HXLINE( 112)			if (::hx::IsNotNull( letter )) {
HXLINE( 114)				letter->kill();
HXLINE( 115)				this->letters->remove(letter);
HXLINE( 116)				this->remove(letter,null());
            			}
            		}
...
void Alphabet_obj::setScale(Float newX, ::Dynamic newY){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_124_setScale)
HXLINE( 125)		Float lastX = this->scale->x;
HXLINE( 126)		Float lastY = this->scale->y;
HXLINE( 127)		if (::hx::IsNull( newY )) {
HXLINE( 127)			newY = newX;
            		}
HXLINE( 129)		this->scaleX = newX;
HXLINE( 131)		this->scaleY = ( (Float)(newY) );
HXLINE( 133)		this->scale->set_x(newX);
HXLINE( 134)		this->scale->set_y(( (Float)(newY) ));
HXLINE( 135)		this->softReloadLetters((newX / lastX),(( (Float)(newY) ) / lastY));
            	}
...
Float Alphabet_obj::set_scaleX(Float value){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_139_set_scaleX)
HXLINE( 140)		if ((value == this->scaleX)) {
HXLINE( 140)			return value;
            		}
HXLINE( 142)		Float ratio = (value / this->scale->x);
HXLINE( 143)		this->scale->set_x(value);
HXLINE( 144)		this->scaleX = value;
HXLINE( 145)		this->softReloadLetters(ratio,1);
...
Float Alphabet_obj::set_scaleY(Float value){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_150_set_scaleY)
HXLINE( 151)		if ((value == this->scaleY)) {
HXLINE( 151)			return value;
            		}
HXLINE( 153)		Float ratio = (value / this->scale->y);
HXLINE( 154)		this->scale->set_y(value);
HXLINE( 155)		this->scaleY = value;
HXLINE( 156)		this->softReloadLetters(1,ratio);
...
void Alphabet_obj::softReloadLetters(::hx::Null< Float >  __o_ratioX, ::Dynamic ratioY){
            	...
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_161_softReloadLetters)
HXLINE( 162)		if (::hx::IsNull( ratioY )) {
HXLINE( 162)			ratioY = ratioX;
            		}
HXLINE( 164)		{
HXLINE( 164)			int _g = 0;
HXDLIN( 164)			::Array< ::Dynamic> _g1 = this->letters;
HXDLIN( 164)			while((_g < _g1->length)){
HXLINE( 164)				 ::objects::AlphaCharacter letter = _g1->__get(_g).StaticCast<  ::objects::AlphaCharacter >();
HXDLIN( 164)				_g = (_g + 1);
HXLINE( 166)				if (::hx::IsNotNull( letter )) {
HXLINE( 168)					letter->setupAlphaCharacter((((letter->x - this->x) * ratioX) + this->x),(((letter->y - this->y) * ( (Float)(ratioY) )) + this->y),null(),null());
            				}
            			}
            		}
            	}
...
void Alphabet_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_177_update)
HXLINE( 178)		if (this->isMenuItem) {
HXLINE( 180)			Float lerpVal = ::Math_obj::exp((-(elapsed) * ((Float)9.6)));
HXLINE( 181)			if (this->changeX) {
HXLINE( 182)				Float a = ((( (Float)(this->targetY) ) * this->distancePerItem->x) + this->startPosition->x);
HXDLIN( 182)				this->set_x((a + (lerpVal * (this->x - a))));
            			}
HXLINE( 183)			if (this->changeY) {
HXLINE( 184)				Float a1 = (((( (Float)(this->targetY) ) * ((Float)1.3)) * this->distancePerItem->y) + this->startPosition->y);
HXDLIN( 184)				this->set_y((a1 + (lerpVal * (this->y - a1))));
            			}
            		}
...
void Alphabet_obj::snapToPosition(){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_191_snapToPosition)
HXDLIN( 191)		if (this->isMenuItem) {
HXLINE( 193)			if (this->changeX) {
HXLINE( 194)				this->set_x(((( (Float)(this->targetY) ) * this->distancePerItem->x) + this->startPosition->x));
            			}
HXLINE( 195)			if (this->changeY) {
HXLINE( 196)				this->set_y((((( (Float)(this->targetY) ) * ((Float)1.3)) * this->distancePerItem->y) + this->startPosition->y));
            			}
            		}
            	}
...
void Alphabet_obj::createLetters(::String newText){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_203_createLetters)
HXLINE( 204)		int consecutiveSpaces = 0;
HXLINE( 206)		Float xPos = ( (Float)(0) );
HXLINE( 207)		::Array< Float > rowData = ::Array_obj< Float >::__new(0);
HXLINE( 208)		this->rows = 0;
HXLINE( 209)		{
HXLINE( 209)			int _g = 0;
HXDLIN( 209)			int _g1 = newText.length;
HXDLIN( 209)			while((_g < _g1)){
HXLINE( 209)				_g = (_g + 1);
HXDLIN( 209)				int i = (_g - 1);
HXLINE( 211)				::String character = newText.charAt(i);
HXLINE( 212)				if ((character != HX_("\n",0a,00,00,00))) {
HXLINE( 214)					bool spaceChar;
HXDLIN( 214)					if ((character != HX_(" ",20,00,00,00))) {
HXLINE( 214)						if (this->bold) {
HXLINE( 214)							spaceChar = (character == HX_("_",5f,00,00,00));
            						}
            						else {
HXLINE( 214)							spaceChar = false;
            						}
            					}
            					else {
HXLINE( 214)						spaceChar = true;
            					}
HXLINE( 215)					if (spaceChar) {
HXLINE( 215)						consecutiveSpaces = (consecutiveSpaces + 1);
            					}
HXLINE( 217)					bool isAlphabet = ::objects::AlphaCharacter_obj::isTypeAlphabet(character.toLowerCase());
HXLINE( 218)					bool _hx_tmp;
HXDLIN( 218)					::Dynamic this1 = ::objects::AlphaCharacter_obj::allLetters;
HXDLIN( 218)					if (( ( ::haxe::ds::StringMap)(this1) )->exists(character.toLowerCase())) {
HXLINE( 218)						if (this->bold) {
HXLINE( 218)							_hx_tmp = !(spaceChar);
            						}
            						else {
...
HXLINE( 220)						if ((consecutiveSpaces > 0)) {
HXLINE( 222)							xPos = (xPos + (( (Float)((28 * consecutiveSpaces)) ) * this->scaleX));
HXLINE( 223)							rowData[this->rows] = xPos;
HXLINE( 224)							bool _hx_tmp1;
HXDLIN( 224)							if (!(this->bold)) {
HXLINE( 224)								_hx_tmp1 = (xPos >= (( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.65)));
            							}
            							else {
HXLINE( 224)								_hx_tmp1 = false;
            							}
HXDLIN( 224)							if (_hx_tmp1) {
HXLINE( 226)								xPos = ( (Float)(0) );
HXLINE( 227)								this->rows++;
            							}
            						}
HXLINE( 230)						consecutiveSpaces = 0;
HXLINE( 232)						 ::Dynamic ObjectFactory = null();
HXDLIN( 232)						 ::objects::AlphaCharacter letter = ( ( ::objects::AlphaCharacter)(this->group->recycle(::hx::ClassOf< ::objects::AlphaCharacter >(),ObjectFactory,true,true).StaticCast<  ::flixel::FlxSprite >()) );
HXLINE( 233)						letter->scale->set_x(this->scaleX);
HXLINE( 234)						letter->scale->set_y(this->scaleY);
HXLINE( 235)						letter->rowWidth = ( (Float)(0) );
HXLINE( 237)						letter->setupAlphaCharacter(xPos,((( (Float)(this->rows) ) * ::objects::Alphabet_obj::Y_PER_ROW) * this->scale->y),character,this->bold);
HXLINE( 238)						letter->parent = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 240)						letter->row = this->rows;
HXLINE( 241)						Float off = ( (Float)(0) );
HXLINE( 242)						if (!(this->bold)) {
HXLINE( 242)							off = ( (Float)(2) );
            						}
HXLINE( 243)						Float xPos1 = letter->get_width();
HXDLIN( 243)						xPos = (xPos + (xPos1 + ((letter->letterOffset->__get(0) + off) * this->scale->x)));
HXLINE( 244)						rowData[this->rows] = xPos;
HXLINE( 246)						this->add(letter);
HXLINE( 247)						this->letters->push(letter);
            					}
            				}
            				else {
HXLINE( 252)					xPos = ( (Float)(0) );
HXLINE( 253)					this->rows++;
            				}
            			}
            		}
HXLINE( 257)		{
HXLINE( 257)			int _g2 = 0;
HXDLIN( 257)			::Array< ::Dynamic> _g3 = this->letters;
HXDLIN( 257)			while((_g2 < _g3->length)){
HXLINE( 257)				 ::objects::AlphaCharacter letter1 = _g3->__get(_g2).StaticCast<  ::objects::AlphaCharacter >();
HXDLIN( 257)				_g2 = (_g2 + 1);
HXLINE( 259)				letter1->rowWidth = (rowData->__get(letter1->row) / this->scale->x);
            			}
            		}
HXLINE( 262)		if ((this->letters->length > 0)) {
HXLINE( 262)			this->rows++;
            		}
            	}
...
bool Alphabet_obj::initialized;

void Alphabet_obj::ensureInit(){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_19_ensureInit)
HXLINE(  20)		if (::objects::Alphabet_obj::initialized) {
HXLINE(  20)			return;
            		}
HXLINE(  22)		::objects::AlphaCharacter_obj::loadAlphabet();
HXLINE(  23)		::objects::Alphabet_obj::initialized = true;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(Alphabet_obj,ensureInit,(void))
...
bool Alphabet_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"ensureInit") ) { outValue = ensureInit_dyn(); return true; }
		break;
	case 11:
...
static ::hx::StaticInfo Alphabet_obj_sStaticStorageInfo[] = {
	{::hx::fsBool,(void *) &Alphabet_obj::initialized,HX_("initialized",14,f5,0f,37)},
...
static void Alphabet_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Alphabet_obj::initialized,"initialized");
	HX_MARK_MEMBER_NAME(Alphabet_obj::Y_PER_ROW,"Y_PER_ROW");
};

#ifdef HXCPP_VISIT_ALLOCS
static void Alphabet_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Alphabet_obj::initialized,"initialized");
...
{
{
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_16_boot)
HXDLIN(  16)		initialized = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_200_boot)
HXDLIN( 200)		Y_PER_ROW = ((Float)85);
            	}
}
