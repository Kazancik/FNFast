...
HXDLIN(  13)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("checkboxanim",d4,35,91,c5),parentFolder,null());
HXDLIN(  13)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("checkboxanim",d4,35,91,c5)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN(  13)		 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp;
HXDLIN(  13)		bool _hx_tmp1;
HXDLIN(  13)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE(  13)			_hx_tmp1 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE(  13)			_hx_tmp1 = true;
            		}
HXDLIN(  13)		if (_hx_tmp1) {
HXLINE(  13)			_hx_tmp = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE(  13)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("checkboxanim",d4,35,91,c5)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  13)			_hx_tmp = null();
            		}
...
HXLINE(  23)		::String _hx_tmp2;
HXDLIN(  23)		if (( (bool)(checked) )) {
HXLINE(  23)			_hx_tmp2 = HX_("checking",1a,21,fb,ac);
            		}
            		else {
HXLINE(  23)			_hx_tmp2 = HX_("unchecking",73,08,bf,32);
            		}
HXDLIN(  23)		this->animationFinished(_hx_tmp2);
