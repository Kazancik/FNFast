...
HXLINE( 702)			Style->__SetField(HX_("titleOffset",4b,63,cb,f6), ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0),::hx::paccDynamic);
            		}
HXLINE( 704)		if (::hx::IsNull( Style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic) )) {
HXLINE( 706)			Style->__SetField(HX_("bodyOffset",d5,2b,5c,a7), ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0),::hx::paccDynamic);
            		}
