...
HXDLIN( 322)				pt =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,x,::Std_obj::parseFloat(arr->__get(1)));
            			}
            		}
...
HXLINE( 652)			pt =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
            		}
