...
HXDLIN( 449)		 ::flixel::math::FlxBasePoint hit = point;
...
HXDLIN( 592)					 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXLINE( 695)					{
HXLINE( 695)						 ::flixel::math::FlxBasePoint this1 = this->caret->offset;
HXDLIN( 695)						this1->set_x(this->caret->offset->set_y(( (Float)(0) )));
            					}
            				}
            				break;
            				case (int)1: {
...
HXLINE( 706)					{
HXLINE( 706)						 ::flixel::math::FlxBasePoint this2 = this->caret->offset;
HXDLIN( 706)						this2->set_x(this->caret->offset->set_y(( (Float)(0) )));
            					}
            				}
            				break;
...
HXLINE( 716)					{
HXLINE( 716)						 ::flixel::math::FlxBasePoint this3 = this->caret->offset;
HXDLIN( 716)						this3->set_x(this->caret->offset->set_y(this->borderSize));
            					}
            				}
            				break;
            			}
