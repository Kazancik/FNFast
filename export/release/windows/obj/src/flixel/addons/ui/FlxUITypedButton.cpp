...
HXLINE( 161)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
...
HXLINE( 143)		this->resize_point = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->resize_point)) );
...
HXLINE( 201)			this->_centerLabelOffset =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,other->_centerLabelOffset->x,other->_centerLabelOffset->y);
            		}
...
HXLINE( 243)		 ::flixel::math::FlxBasePoint ctPt = other->getCenterLabelOffset();
...
HXLINE( 247)				 ::flixel::math::FlxBasePoint flxPt = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 247)				_g = (_g + 1);
HXLINE( 249)				this->labelOffsets->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->set_x(flxPt->x);
HXLINE( 250)				this->labelOffsets->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->set_y(flxPt->y);
HXLINE( 251)				i = (i + 1);
            			}
            		}
HXLINE( 254)		i = 0;
...
HXDLIN( 267)			 ::flixel::math::FlxBasePoint labelOffset = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 267)			_g = (_g + 1);
HXLINE( 269)			{
HXLINE( 269)				labelOffset->set_x(X);
HXDLIN( 269)				labelOffset->set_y(Y);
            			}
            		}
            	}
...
HXLINE( 291)			theLabel->set_x(((this->x + this->_centerLabelOffset->x) + this->labelOffsets->__get(this->status).StaticCast<  ::flixel::math::FlxBasePoint >()->x));
HXLINE( 292)			theLabel->set_y(((this->y + this->_centerLabelOffset->y) + this->labelOffsets->__get(this->status).StaticCast<  ::flixel::math::FlxBasePoint >()->y));
...
HXLINE( 657)		 ::flixel::math::FlxBasePoint pt = ::flixel::addons::ui::U_obj::applyResize(this->resize_ratio,this->resize_ratio_axis,( (Float)(W) ),( (Float)(H) ),null());
...
HXDLIN( 960)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
...
HXLINE(1254)			this->_spriteLabel->set_x(((this->x + this->_centerLabelOffset->x) + this->labelOffsets->__get(this->status).StaticCast<  ::flixel::math::FlxBasePoint >()->x));
...
HXLINE(1275)			this->_spriteLabel->set_y(((this->y + this->_centerLabelOffset->y) + this->labelOffsets->__get(this->status).StaticCast<  ::flixel::math::FlxBasePoint >()->y));
