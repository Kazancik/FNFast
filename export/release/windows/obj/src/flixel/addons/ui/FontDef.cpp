...
HXLINE(  59)			this->format->set_size(i);
            		}
...
HXLINE( 316)			this->format->set_bold(true);
HXLINE( 317)			this->format->set_italic(false);
...
HXLINE( 322)			this->format->set_bold(true);
HXLINE( 323)			this->format->set_italic(true);
HXLINE( 321)			goto _hx_goto_18;
            		}
            		if (  (_hx_switch_0==HX_("i",69,00,00,00)) ||  (_hx_switch_0==HX_("italic",f0,2e,64,06)) ){
HXLINE( 319)			this->format->set_bold(false);
HXLINE( 320)			this->format->set_italic(true);
HXLINE( 318)			goto _hx_goto_18;
            		}
            		/* default */{
HXLINE( 325)			this->format->set_bold(false);
HXLINE( 326)			this->format->set_italic(false);
            		}
            		_hx_goto_18:;
...
HXLINE(  84)		fd->format->set_font(dtf->font);
HXLINE(  85)		fd->format->set_size(dtf->size);
HXLINE(  86)		fd->format->color = dtf->color;
HXLINE(  87)		fd->format->set_bold(dtf->bold);
HXLINE(  88)		fd->format->set_italic(dtf->italic);
...
HXLINE( 354)		fd->format->set_size(fontSize);
