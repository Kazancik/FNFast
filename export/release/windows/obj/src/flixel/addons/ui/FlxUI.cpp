...
HXLINE( 543)			if ((key == HX_("screen",6c,3b,5d,47))) {
HXLINE( 545)				::flixel::FlxG_obj::log->advanced(HX_("Failed to add a widget with the name 'screen', that is reserved by the system for the screen itself",a1,98,88,7b),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,null());
            			}
            			else {
HXLINE( 549)				::flixel::FlxG_obj::log->advanced(((HX_("Duplicate screen name '",d1,0b,e0,7e) + key) + HX_("'",27,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,null());
            			}
...
HXLINE( 868)							::flixel::FlxG_obj::log->advanced(((((HX_("Can't create FlxUI definition '",b5,82,49,00) + def_name1) + HX_("', because '",92,6b,a1,0c)) + error) + HX_("' is a reserved name prefix!",16,78,51,ae)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            						}
            						else {
...
HXLINE(1946)							HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + HX_("arrow",c9,79,8f,25)) + HX_("\"",22,00,00,00)));
            						...
            						if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            							...
            							::String msg1 = _hx_e;
HXLINE(1946)							 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN(1946)							_this1->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg1),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            						}
...
HXLINE(1970)		Float x = this->_loadWidth(node,( (Float)(0) ),HX_("x",78,00,00,00),null());
HXDLIN(1970)		 ::flixel::math::FlxBasePoint offset =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,x,this->_loadHeight(node,( (Float)(0) ),HX_("y",79,00,00,00),null()));
...
HXLINE(2005)			 ::Dynamic(tt->__Field(HX_("style",31,a5,1d,84),::hx::paccDynamic))->__SetField(HX_("bodyOffset",d5,2b,5c,a7),offset,::hx::paccDynamic);
...
HXLINE(1996)			 ::Dynamic(tt->__Field(HX_("style",31,a5,1d,84),::hx::paccDynamic))->__SetField(HX_("titleOffset",4b,63,cb,f6),offset,::hx::paccDynamic);
...
HXLINE(2152)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(2152)		point->_inPool = false;
HXDLIN(2152)		 ::flixel::math::FlxBasePoint fp = point;
...
HXLINE(2305)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(-1,-1);
HXDLIN(2305)				point->_inPool = false;
HXDLIN(2305)				 ::flixel::math::FlxBasePoint bounds = point;
...
HXLINE(2350)					if ((boundsError != HX_("",00,00,00,00))) {
HXLINE(2352)						if (!(suppressError)) {
HXLINE(2354)							::flixel::FlxG_obj::log->advanced(boundsError,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            						}
            					}
            				}
            			}
...
HXLINE(3155)		 ::flixel::math::FlxBasePoint prevOffset = null();
HXLINE(3156)		 ::flixel::math::FlxBasePoint nextOffset = null();
...
HXDLIN(3165)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
...
HXDLIN(3169)						 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
...
HXLINE(3378)					::flixel::FlxG_obj::log->advanced(((HX_("couldn't loadButton with definition \"",2d,5f,ac,2b) + button_def) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
...
HXLINE(3391)					::flixel::FlxG_obj::log->advanced(((HX_("couldn't loadText with definition \"",a8,f1,da,63) + label_def) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
...
HXLINE(3433)							::flixel::FlxG_obj::log->advanced(((HX_("couldn't loadButton with definition \"",2d,5f,ac,2b) + def_name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            						}
            						else {
            							HX_STACK_DO_THROW(_hx_e);
            						}
...
HXLINE(3550)		 ::flixel::math::FlxBasePoint resolution = ::flixel::addons::ui::U_obj::xml_pt(node,HX_("resolution",2c,35,49,6d),null());
HXLINE(3551)		if (::hx::IsNotNull( resolution )) {
HXLINE(3553)			match = true;
HXLINE(3554)			 ::flixel::math::FlxBasePoint toleranceRes = ::flixel::addons::ui::U_obj::xml_pt(node,HX_("tolerance",0d,3d,7c,33),null());
HXLINE(3555)			if (::hx::IsNull( toleranceRes )) {
HXLINE(3557)				toleranceRes =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0);
            			}
...
HXLINE(3710)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(tab_x,tab_y);
HXDLIN(3710)		point->_inPool = false;
HXDLIN(3710)		 ::flixel::math::FlxBasePoint tab_offset = point;
...
HXLINE(3887)				return  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,resize_ratio,defaultAxis);
            			}
            			else {
HXLINE(3892)				return  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,::Std_obj::parseFloat(str),1);
            			}
            		}
            		else {
HXLINE(3898)			return  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,::Std_obj::parseFloat(str),0);
            		}
...
HXLINE(3911)		 ::flixel::math::FlxBasePoint resize_point = this->_loadCompass(data,HX_("resize_point",85,44,f0,71));
...
HXLINE(4278)							sprite1->offset->set_x((sprite1->offset->x - ( (Float)(text_x) )));
HXLINE(4279)							sprite1->offset->set_y((sprite1->offset->y - ( (Float)(text_y) )));
...
HXLINE(4286)				 ::flixel::FlxSprite fh = ( ( ::flixel::FlxSprite)(fbs->label) );
HXDLIN(4286)				fh->offset->set_x((fh->offset->x - ( (Float)(text_x) )));
HXLINE(4287)				 ::flixel::FlxSprite fh1 = ( ( ::flixel::FlxSprite)(fbs->label) );
HXDLIN(4287)				fh1->offset->set_y((fh1->offset->y - ( (Float)(text_y) )));
HXLINE(4288)				if (::hx::IsNotNull( toggleSprite )) {
HXLINE(4290)					toggleSprite->offset->set_x((toggleSprite->offset->x - ( (Float)(text_x) )));
HXLINE(4291)					toggleSprite->offset->set_y((toggleSprite->offset->y - ( (Float)(text_y) )));
            				}
            			}
            		}
            		else {
HXLINE(4297)			 ::flixel::addons::ui::FlxUIButton fbu = ( ( ::flixel::addons::ui::FlxUIButton)(fb) );
HXLINE(4299)			 ::flixel::addons::ui::FlxUIText fh2 = ( ( ::flixel::addons::ui::FlxUIText)(fbu->label) );
HXDLIN(4299)			fh2->offset->set_x((fh2->offset->x - ( (Float)(text_x) )));
HXLINE(4300)			 ::flixel::addons::ui::FlxUIText fh3 = ( ( ::flixel::addons::ui::FlxUIText)(fbu->label) );
HXDLIN(4300)			fh3->offset->set_y((fh3->offset->y - ( (Float)(text_y) )));
            		}
...
HXLINE(4357)		 ::flixel::math::FlxBasePoint resize = this->getResizeRatio(data,null());
HXLINE(4358)		int color = this->_loadColor(data,null(),null());
HXLINE(4359)		Float resize_ratio = resize->x;
HXLINE(4360)		 ::flixel::math::FlxBasePoint resize_point = this->_loadCompass(data,HX_("resize_point",85,44,f0,71));
...
HXLINE(4371)						HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + HX_("src",e4,a6,57,00)) + HX_("\"",22,00,00,00)));
            					...
            					if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            						HX_STACK_BEGIN_CATCH
            						::String msg1 = _hx_e;
HXLINE(4371)						 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN(4371)						_this1->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg1),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            					}
            					else if (_hx_e.IsClass<  ::haxe::ValueException >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::haxe::ValueException _g = _hx_e;
...
HXLINE(4456)						HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + srcString) + HX_("\"",22,00,00,00)));
            					...
            					if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            						HX_STACK_BEGIN_CATCH
            						::String msg1 = _hx_e;
HXLINE(4456)						 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN(4456)						_this1->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg1),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            					}
            					else if (_hx_e.IsClass<  ::haxe::ValueException >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::haxe::ValueException _g = _hx_e;
...
HXLINE(4776)		 ::flixel::math::FlxBasePoint resize = this->getResizeRatio(data,-1);
HXLINE(4778)		Float resize_ratio = resize->x;
HXLINE(4779)		int resize_ratio_axis = ::Std_obj::_hx_int(resize->y);
HXLINE(4780)		 ::flixel::math::FlxBasePoint resize_point = this->_loadCompass(data,HX_("resize_point",85,44,f0,71));
...
HXLINE(4971)						HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + attName) + HX_("\"",22,00,00,00)));
            					...
            					if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            						HX_STACK_BEGIN_CATCH
            						::String msg1 = _hx_e;
HXLINE(4971)						 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN(4971)						_this1->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg1),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            					}
            					else if (_hx_e.IsClass<  ::haxe::ValueException >() ){
            						HX_STACK_BEGIN_CATCH
...
HXLINE(5693)		 ::openfl::text::TextFormat fd1 = fd->format;
HXDLIN(5693)		fd1->set_size(::flixel::addons::ui::FlxUI_obj::fontSize(fd->file,fontSize));
...
HXLINE( 288)			::flixel::FlxG_obj::log->advanced(HX_("Warning, FlxUI event not handled, IFlxUIWidgets need to exist within an IFlxUIState",71,f5,8f,fb),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            		}
