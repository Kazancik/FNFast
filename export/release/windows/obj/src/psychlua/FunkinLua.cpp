...
HXDLIN( 109)		this->set(HX_("difficultyPath",80,99,9c,95),::StringTools_obj::trim(hideChars3->replace(invalidChars2->replace(filePostfix,HX_("-",2d,00,00,00)),HX_("",00,00,00,00))).toLowerCase());
...
HXLINE(  65)			diffName3 = ::backend::Difficulty_obj::defaultDifficulty;
            		}
...
HXDLIN( 110)			 ::EReg hideChars4 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\/;:<>#.,'\"%?!]",85,3f,6d,6d),HX_("g",67,00,00,00));
HXDLIN( 110)			::String str1 = ( ( ::haxe::ds::StringMap)(this2) )->get_string(::StringTools_obj::trim(hideChars4->replace(::StringTools_obj::replace(key1,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
...
HXLINE( 110)			_hx_tmp2 = str1;
            		}
            		else {
HXLINE( 110)			_hx_tmp2 = diffName3;
            		}
HXDLIN( 110)		this->set(HX_("difficultyNameTranslation",6b,a8,7a,37),_hx_tmp2);
...
HXLINE( 145)			 ::Dynamic _hx_tmp3;
HXDLIN( 145)			if (::hx::IsNotNull( curSection )) {
HXLINE( 145)				_hx_tmp3 = ::hx::IsEq( curSection->__Field(HX_("mustHitSection",3b,5f,87,62),::hx::paccDynamic),true );
            			}
            			else {
HXLINE( 145)				_hx_tmp3 = false;
            			}
HXDLIN( 145)			this->set(HX_("mustHitSection",3b,5f,87,62),_hx_tmp3);
HXLINE( 146)			 ::Dynamic _hx_tmp4;
HXDLIN( 146)			if (::hx::IsNotNull( curSection )) {
HXLINE( 146)				_hx_tmp4 = ::hx::IsEq( curSection->__Field(HX_("altAnim",da,f3,f2,e5),::hx::paccDynamic),true );
            			}
            			else {
HXLINE( 146)				_hx_tmp4 = false;
            			}
HXDLIN( 146)			this->set(HX_("altAnim",da,f3,f2,e5),_hx_tmp4);
HXLINE( 147)			 ::Dynamic _hx_tmp5;
HXDLIN( 147)			if (::hx::IsNotNull( curSection )) {
HXLINE( 147)				_hx_tmp5 = ::hx::IsEq( curSection->__Field(HX_("gfSection",86,e5,63,d4),::hx::paccDynamic),true );
            			}
            			else {
HXLINE( 147)				_hx_tmp5 = false;
            			}
HXDLIN( 147)			this->set(HX_("gfSection",86,e5,63,d4),_hx_tmp5);
...
HXLINE( 178)			 ::Dynamic _hx_tmp6;
HXDLIN( 178)			if (::hx::IsNotNull( game->boyfriend )) {
HXLINE( 178)				_hx_tmp6 = game->boyfriend->curCharacter;
            			}
            			else {
HXLINE( 178)				_hx_tmp6 =  ::Dynamic(::states::PlayState_obj::SONG->__Field(HX_("player1",b0,09,15,8a),::hx::paccDynamic));
            			}
HXDLIN( 178)			this->set(HX_("boyfriendName",d5,c4,d2,4c),_hx_tmp6);
HXLINE( 179)			 ::Dynamic _hx_tmp7;
HXDLIN( 179)			if (::hx::IsNotNull( game->dad )) {
HXLINE( 179)				_hx_tmp7 = game->dad->curCharacter;
            			}
            			else {
HXLINE( 179)				_hx_tmp7 =  ::Dynamic(::states::PlayState_obj::SONG->__Field(HX_("player2",b1,09,15,8a),::hx::paccDynamic));
            			}
HXDLIN( 179)			this->set(HX_("dadName",32,04,eb,ce),_hx_tmp7);
HXLINE( 180)			 ::Dynamic _hx_tmp8;
HXDLIN( 180)			if (::hx::IsNotNull( game->gf )) {
HXLINE( 180)				_hx_tmp8 = game->gf->curCharacter;
            			}
            			else {
HXLINE( 180)				_hx_tmp8 =  ::Dynamic(::states::PlayState_obj::SONG->__Field(HX_("gfVersion",b9,c6,7d,f3),::hx::paccDynamic));
            			}
HXDLIN( 180)			this->set(HX_("gfName",0a,f4,79,1d),_hx_tmp8);
            		}
...
HXLINE(1585)			bool _hx_tmp9;
HXDLIN(1585)			if (::hx::IsNotNull( resultStr )) {
HXLINE(1585)				_hx_tmp9 = ::hx::IsNotEq( result,0 );
            			}
            			else {
HXLINE(1585)				_hx_tmp9 = false;
            			}
HXDLIN(1585)			if (_hx_tmp9) {
...
HXLINE(1638)			 cpp::Reference<lua_State> l = this->lua;
HXDLIN(1638)			 ::Dynamic ret = null();
HXDLIN(1638)			switch((int)(lua_type(l,-1))){
            				case (int)0: {
HXLINE(1638)					ret = null();
            				}
            				break;
            				case (int)1: {
HXLINE(1638)					ret = (lua_toboolean(l,-1) != 0);
            				}
            				break;
            				case (int)3: {
HXLINE(1638)					ret = lua_tonumber(l,-1);
            				}
            				break;
            				case (int)4: {
HXLINE(1638)					ret = linc::lua::tostring(l,-1);
            				}
            				break;
            				case (int)5: {
HXLINE(1638)					bool array = true;
HXDLIN(1638)					 ::Dynamic ret1 = null();
HXDLIN(1638)					lua_pushnil(l);
HXDLIN(1638)					while((lua_next(l,-2) != 0)){
HXLINE(1638)						if ((lua_type(l,-2) != 3)) {
HXLINE(1638)							array = false;
HXDLIN(1638)							lua_pop(l,2);
HXDLIN(1638)							goto _hx_goto_170;
            						}
HXDLIN(1638)						Float n = lua_tonumber(l,-2);
HXDLIN(1638)						if ((n != ::Std_obj::_hx_int(n))) {
HXLINE(1638)							array = false;
HXDLIN(1638)							lua_pop(l,2);
HXDLIN(1638)							goto _hx_goto_170;
            						}
HXDLIN(1638)						lua_pop(l,1);
            					}
            					_hx_goto_170:;
HXDLIN(1638)					if (array) {
HXLINE(1638)						::cpp::VirtualArray arr = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)						lua_pushnil(l);
HXDLIN(1638)						while((lua_next(l,-2) != 0)){
HXLINE(1638)							int index = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)							 ::Dynamic ret2 = null();
HXDLIN(1638)							switch((int)(lua_type(l,-1))){
            								case (int)0: {
HXLINE(1638)									ret2 = null();
            								}
            								break;
            								case (int)1: {
HXLINE(1638)									ret2 = (lua_toboolean(l,-1) != 0);
            								}
            								break;
            								case (int)3: {
HXLINE(1638)									ret2 = lua_tonumber(l,-1);
            								}
            								break;
            								case (int)4: {
HXLINE(1638)									ret2 = linc::lua::tostring(l,-1);
            								}
            								break;
            								case (int)5: {
HXLINE(1638)									bool array1 = true;
HXDLIN(1638)									 ::Dynamic ret3 = null();
HXDLIN(1638)									lua_pushnil(l);
HXDLIN(1638)									while((lua_next(l,-2) != 0)){
HXLINE(1638)										if ((lua_type(l,-2) != 3)) {
HXLINE(1638)											array1 = false;
HXDLIN(1638)											lua_pop(l,2);
HXDLIN(1638)											goto _hx_goto_172;
            										}
HXDLIN(1638)										Float n1 = lua_tonumber(l,-2);
HXDLIN(1638)										if ((n1 != ::Std_obj::_hx_int(n1))) {
HXLINE(1638)											array1 = false;
HXDLIN(1638)											lua_pop(l,2);
HXDLIN(1638)											goto _hx_goto_172;
            										}
HXDLIN(1638)										lua_pop(l,1);
            									...
            									_hx_goto_172:;
HXDLIN(1638)									if (array1) {
HXLINE(1638)										::cpp::VirtualArray arr1 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)										lua_pushnil(l);
HXDLIN(1638)										while((lua_next(l,-2) != 0)){
HXLINE(1638)											int index1 = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)											arr1->set(index1,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)											lua_pop(l,1);
            										}
HXDLIN(1638)										ret3 = arr1;
            									}
            									else {
HXLINE(1638)										 hx::Anon obj = hx::Anon_obj::Create();
HXDLIN(1638)										lua_pushnil(l);
HXDLIN(1638)										while((lua_next(l,-2) != 0)){
HXLINE(1638)											::String ret4;
HXDLIN(1638)											if (::hx::IsNull( ::llua::Convert_obj::fromLua(l,-2) )) {
HXLINE(1638)												ret4 = HX_("null",87,9e,0e,49);
            											}
            											else {
HXLINE(1638)												ret4 = ::Std_obj::string(::llua::Convert_obj::fromLua(l,-2));
            											}
HXDLIN(1638)											obj->hx::Anon_obj::Add(ret4,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)											lua_pop(l,1);
            										}
HXDLIN(1638)										ret3 = obj;
            									}
HXDLIN(1638)									ret2 = ret3;
            								}
            								break;
            								default:{
HXLINE(1638)									ret2 = null();
HXDLIN(1638)									::haxe::Log_obj::trace(HX_("return value not supported\n",48,41,fb,c8),::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),97,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            								}
            							}
HXDLIN(1638)							arr->set(index,ret2);
HXDLIN(1638)							lua_pop(l,1);
            						}
HXDLIN(1638)						ret1 = arr;
            					}
            					else {
HXLINE(1638)						 hx::Anon obj1 = hx::Anon_obj::Create();
HXDLIN(1638)						lua_pushnil(l);
HXDLIN(1638)						while((lua_next(l,-2) != 0)){
HXLINE(1638)							::String ret5;
HXDLIN(1638)							 ::Dynamic ret6 = null();
HXDLIN(1638)							switch((int)(lua_type(l,-2))){
            								case (int)0: {
HXLINE(1638)									ret6 = null();
            								}
            								break;
            								case (int)1: {
HXLINE(1638)									ret6 = (lua_toboolean(l,-2) != 0);
            								}
            								break;
            								case (int)3: {
HXLINE(1638)									ret6 = lua_tonumber(l,-2);
            								}
            								break;
            								case (int)4: {
HXLINE(1638)									ret6 = linc::lua::tostring(l,-2);
            								}
            								break;
            								case (int)5: {
HXLINE(1638)									bool array2 = true;
HXDLIN(1638)									 ::Dynamic ret7 = null();
HXDLIN(1638)									lua_pushnil(l);
HXDLIN(1638)									while((lua_next(l,-2) != 0)){
HXLINE(1638)										if ((lua_type(l,-2) != 3)) {
HXLINE(1638)											array2 = false;
HXDLIN(1638)											lua_pop(l,2);
HXDLIN(1638)											goto _hx_goto_176;
            										}
HXDLIN(1638)										Float n2 = lua_tonumber(l,-2);
HXDLIN(1638)										if ((n2 != ::Std_obj::_hx_int(n2))) {
HXLINE(1638)											array2 = false;
HXDLIN(1638)											lua_pop(l,2);
HXDLIN(1638)											goto _hx_goto_176;
            										}
HXDLIN(1638)										lua_pop(l,1);
            									...
            									_hx_goto_176:;
HXDLIN(1638)									if (array2) {
HXLINE(1638)										::cpp::VirtualArray arr2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)										lua_pushnil(l);
HXDLIN(1638)										while((lua_next(l,-2) != 0)){
HXLINE(1638)											int index2 = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)											arr2->set(index2,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)											lua_pop(l,1);
            										}
HXDLIN(1638)										ret7 = arr2;
            									}
            									else {
HXLINE(1638)										 hx::Anon obj2 = hx::Anon_obj::Create();
HXDLIN(1638)										lua_pushnil(l);
HXDLIN(1638)										while((lua_next(l,-2) != 0)){
HXLINE(1638)											::String ret8;
HXDLIN(1638)											if (::hx::IsNull( ::llua::Convert_obj::fromLua(l,-2) )) {
HXLINE(1638)												ret8 = HX_("null",87,9e,0e,49);
            											}
            											else {
HXLINE(1638)												ret8 = ::Std_obj::string(::llua::Convert_obj::fromLua(l,-2));
            											}
HXDLIN(1638)											obj2->hx::Anon_obj::Add(ret8,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)											lua_pop(l,1);
            										}
HXDLIN(1638)										ret7 = obj2;
            									}
HXDLIN(1638)									ret6 = ret7;
            								}
            								break;
            								default:{
HXLINE(1638)									ret6 = null();
...
HXDLIN(1638)							if (::hx::IsNull( ret6 )) {
HXLINE(1638)								ret5 = HX_("null",87,9e,0e,49);
            							}
            							else {
HXLINE(1638)								 ::Dynamic ret9 = null();
HXDLIN(1638)								switch((int)(lua_type(l,-2))){
            									case (int)0: {
HXLINE(1638)										ret9 = null();
            									}
            									break;
            									case (int)1: {
HXLINE(1638)										ret9 = (lua_toboolean(l,-2) != 0);
            									}
            									break;
            									case (int)3: {
HXLINE(1638)										ret9 = lua_tonumber(l,-2);
            									}
            									break;
            									case (int)4: {
HXLINE(1638)										ret9 = linc::lua::tostring(l,-2);
            									}
            									break;
            									case (int)5: {
HXLINE(1638)										bool array3 = true;
HXDLIN(1638)										 ::Dynamic ret10 = null();
HXDLIN(1638)										lua_pushnil(l);
HXDLIN(1638)										while((lua_next(l,-2) != 0)){
HXLINE(1638)											if ((lua_type(l,-2) != 3)) {
HXLINE(1638)												array3 = false;
HXDLIN(1638)												lua_pop(l,2);
HXDLIN(1638)												goto _hx_goto_179;
            											}
HXDLIN(1638)											Float n3 = lua_tonumber(l,-2);
HXDLIN(1638)											if ((n3 != ::Std_obj::_hx_int(n3))) {
HXLINE(1638)												array3 = false;
HXDLIN(1638)												lua_pop(l,2);
HXDLIN(1638)												goto _hx_goto_179;
            											}
HXDLIN(1638)											lua_pop(l,1);
            										...
            										_hx_goto_179:;
HXDLIN(1638)										if (array3) {
HXLINE(1638)											::cpp::VirtualArray arr3 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)											lua_pushnil(l);
HXDLIN(1638)											while((lua_next(l,-2) != 0)){
HXLINE(1638)												int index3 = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)												 ::Dynamic ret11 = null();
HXDLIN(1638)												switch((int)(lua_type(l,-1))){
            													case (int)0: {
HXLINE(1638)														ret11 = null();
            													}
            													break;
            													case (int)1: {
HXLINE(1638)														ret11 = (lua_toboolean(l,-1) != 0);
            													}
            													break;
            													case (int)3: {
HXLINE(1638)														ret11 = lua_tonumber(l,-1);
            													}
            													break;
            													case (int)4: {
HXLINE(1638)														ret11 = linc::lua::tostring(l,-1);
            													}
            													break;
            													case (int)5: {
HXLINE(1638)														bool array4 = true;
HXDLIN(1638)														 ::Dynamic ret12 = null();
HXDLIN(1638)														lua_pushnil(l);
HXDLIN(1638)														while((lua_next(l,-2) != 0)){
HXLINE(1638)															if ((lua_type(l,-2) != 3)) {
HXLINE(1638)																array4 = false;
HXDLIN(1638)																lua_pop(l,2);
HXDLIN(1638)																goto _hx_goto_181;
            															}
HXDLIN(1638)															Float n4 = lua_tonumber(l,-2);
HXDLIN(1638)															if ((n4 != ::Std_obj::_hx_int(n4))) {
HXLINE(1638)																array4 = false;
HXDLIN(1638)																lua_pop(l,2);
HXDLIN(1638)																goto _hx_goto_181;
            															}
HXDLIN(1638)															lua_pop(l,1);
            														...
            														_hx_goto_181:;
HXDLIN(1638)														if (array4) {
HXLINE(1638)															::cpp::VirtualArray arr4 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)															lua_pushnil(l);
HXDLIN(1638)															while((lua_next(l,-2) != 0)){
HXLINE(1638)																int index4 = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)																arr4->set(index4,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)																lua_pop(l,1);
            															}
HXDLIN(1638)															ret12 = arr4;
            														}
            														else {
HXLINE(1638)															 hx::Anon obj3 = hx::Anon_obj::Create();
HXDLIN(1638)															lua_pushnil(l);
HXDLIN(1638)															while((lua_next(l,-2) != 0)){
HXLINE(1638)																::String ret13;
HXDLIN(1638)																if (::hx::IsNull( ::llua::Convert_obj::fromLua(l,-2) )) {
HXLINE(1638)																	ret13 = HX_("null",87,9e,0e,49);
            																}
            																else {
HXLINE(1638)																	ret13 = ::Std_obj::string(::llua::Convert_obj::fromLua(l,-2));
            																}
HXDLIN(1638)																obj3->hx::Anon_obj::Add(ret13,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)																lua_pop(l,1);
            															}
HXDLIN(1638)															ret12 = obj3;
            														}
HXDLIN(1638)														ret11 = ret12;
            													}
            													break;
            													default:{
HXLINE(1638)														ret11 = null();
...
HXDLIN(1638)												arr3->set(index3,ret11);
HXDLIN(1638)												lua_pop(l,1);
            											}
HXDLIN(1638)											ret10 = arr3;
            										}
            										else {
HXLINE(1638)											 hx::Anon obj4 = hx::Anon_obj::Create();
HXDLIN(1638)											lua_pushnil(l);
HXDLIN(1638)											while((lua_next(l,-2) != 0)){
HXLINE(1638)												::String ret14;
HXDLIN(1638)												 ::Dynamic ret15 = null();
HXDLIN(1638)												switch((int)(lua_type(l,-2))){
            													case (int)0: {
HXLINE(1638)														ret15 = null();
            													}
            													break;
            													case (int)1: {
HXLINE(1638)														ret15 = (lua_toboolean(l,-2) != 0);
            													}
            													break;
            													case (int)3: {
HXLINE(1638)														ret15 = lua_tonumber(l,-2);
            													}
            													break;
            													case (int)4: {
HXLINE(1638)														ret15 = linc::lua::tostring(l,-2);
            													}
            													break;
            													case (int)5: {
HXLINE(1638)														bool array5 = true;
HXDLIN(1638)														 ::Dynamic ret16 = null();
HXDLIN(1638)														lua_pushnil(l);
HXDLIN(1638)														while((lua_next(l,-2) != 0)){
HXLINE(1638)															if ((lua_type(l,-2) != 3)) {
HXLINE(1638)																array5 = false;
HXDLIN(1638)																lua_pop(l,2);
HXDLIN(1638)																goto _hx_goto_185;
            															}
HXDLIN(1638)															Float n5 = lua_tonumber(l,-2);
HXDLIN(1638)															if ((n5 != ::Std_obj::_hx_int(n5))) {
HXLINE(1638)																array5 = false;
HXDLIN(1638)																lua_pop(l,2);
HXDLIN(1638)																goto _hx_goto_185;
            															}
HXDLIN(1638)															lua_pop(l,1);
            														...
            														_hx_goto_185:;
HXDLIN(1638)														if (array5) {
HXLINE(1638)															::cpp::VirtualArray arr5 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)															lua_pushnil(l);
HXDLIN(1638)															while((lua_next(l,-2) != 0)){
HXLINE(1638)																int index5 = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)																arr5->set(index5,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)																lua_pop(l,1);
            															}
HXDLIN(1638)															ret16 = arr5;
            														}
            														else {
HXLINE(1638)															 hx::Anon obj5 = hx::Anon_obj::Create();
HXDLIN(1638)															lua_pushnil(l);
HXDLIN(1638)															while((lua_next(l,-2) != 0)){
HXLINE(1638)																::String ret17;
HXDLIN(1638)																if (::hx::IsNull( ::llua::Convert_obj::fromLua(l,-2) )) {
HXLINE(1638)																	ret17 = HX_("null",87,9e,0e,49);
            																}
            																else {
HXLINE(1638)																	ret17 = ::Std_obj::string(::llua::Convert_obj::fromLua(l,-2));
            																}
HXDLIN(1638)																obj5->hx::Anon_obj::Add(ret17,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)																lua_pop(l,1);
            															}
HXDLIN(1638)															ret16 = obj5;
            														}
HXDLIN(1638)														ret15 = ret16;
            													}
            													break;
            													default:{
HXLINE(1638)														ret15 = null();
...
HXDLIN(1638)												if (::hx::IsNull( ret15 )) {
HXLINE(1638)													ret14 = HX_("null",87,9e,0e,49);
            												}
            												else {
HXLINE(1638)													 ::Dynamic ret18 = null();
HXDLIN(1638)													switch((int)(lua_type(l,-2))){
            														case (int)0: {
HXLINE(1638)															ret18 = null();
            														}
            														break;
            														case (int)1: {
HXLINE(1638)															ret18 = (lua_toboolean(l,-2) != 0);
            														}
            														break;
            														case (int)3: {
HXLINE(1638)															ret18 = lua_tonumber(l,-2);
            														}
            														break;
            														case (int)4: {
HXLINE(1638)															ret18 = linc::lua::tostring(l,-2);
            														}
            														break;
            														case (int)5: {
HXLINE(1638)															bool array6 = true;
HXDLIN(1638)															 ::Dynamic ret19 = null();
HXDLIN(1638)															lua_pushnil(l);
HXDLIN(1638)															while((lua_next(l,-2) != 0)){
HXLINE(1638)																if ((lua_type(l,-2) != 3)) {
HXLINE(1638)																	array6 = false;
HXDLIN(1638)																	lua_pop(l,2);
HXDLIN(1638)																	goto _hx_goto_188;
            																}
HXDLIN(1638)																Float n6 = lua_tonumber(l,-2);
HXDLIN(1638)																if ((n6 != ::Std_obj::_hx_int(n6))) {
HXLINE(1638)																	array6 = false;
HXDLIN(1638)																	lua_pop(l,2);
HXDLIN(1638)																	goto _hx_goto_188;
            																}
HXDLIN(1638)																lua_pop(l,1);
            															...
            															_hx_goto_188:;
HXDLIN(1638)															if (array6) {
HXLINE(1638)																::cpp::VirtualArray arr6 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)																lua_pushnil(l);
HXDLIN(1638)																while((lua_next(l,-2) != 0)){
HXLINE(1638)																	int index6 = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)																	arr6->set(index6,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)																	lua_pop(l,1);
            																}
HXDLIN(1638)																ret19 = arr6;
            															}
            															else {
HXLINE(1638)																 hx::Anon obj6 = hx::Anon_obj::Create();
HXDLIN(1638)																lua_pushnil(l);
HXDLIN(1638)																while((lua_next(l,-2) != 0)){
HXLINE(1638)																	::String ret20;
HXDLIN(1638)																	if (::hx::IsNull( ::llua::Convert_obj::fromLua(l,-2) )) {
HXLINE(1638)																		ret20 = HX_("null",87,9e,0e,49);
            																	}
            																	else {
HXLINE(1638)																		ret20 = ::Std_obj::string(::llua::Convert_obj::fromLua(l,-2));
            																	}
HXDLIN(1638)																	obj6->hx::Anon_obj::Add(ret20,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)																	lua_pop(l,1);
            																}
HXDLIN(1638)																ret19 = obj6;
            															}
HXDLIN(1638)															ret18 = ret19;
            														}
            														break;
            														default:{
HXLINE(1638)															ret18 = null();
...
HXDLIN(1638)													ret14 = ::Std_obj::string(ret18);
            												}
HXDLIN(1638)												 ::Dynamic ret21 = null();
HXDLIN(1638)												switch((int)(lua_type(l,-1))){
            													case (int)0: {
HXLINE(1638)														ret21 = null();
            													}
            													break;
            													case (int)1: {
HXLINE(1638)														ret21 = (lua_toboolean(l,-1) != 0);
            													}
            													break;
            													case (int)3: {
HXLINE(1638)														ret21 = lua_tonumber(l,-1);
            													}
            													break;
            													case (int)4: {
HXLINE(1638)														ret21 = linc::lua::tostring(l,-1);
            													}
            													break;
            													case (int)5: {
HXLINE(1638)														bool array7 = true;
HXDLIN(1638)														 ::Dynamic ret22 = null();
HXDLIN(1638)														lua_pushnil(l);
HXDLIN(1638)														while((lua_next(l,-2) != 0)){
HXLINE(1638)															if ((lua_type(l,-2) != 3)) {
HXLINE(1638)																array7 = false;
HXDLIN(1638)																lua_pop(l,2);
HXDLIN(1638)																goto _hx_goto_191;
            															}
HXDLIN(1638)															Float n7 = lua_tonumber(l,-2);
HXDLIN(1638)															if ((n7 != ::Std_obj::_hx_int(n7))) {
HXLINE(1638)																array7 = false;
HXDLIN(1638)																lua_pop(l,2);
HXDLIN(1638)																goto _hx_goto_191;
            															}
HXDLIN(1638)															lua_pop(l,1);
            														...
            														_hx_goto_191:;
HXDLIN(1638)														if (array7) {
HXLINE(1638)															::cpp::VirtualArray arr7 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)															lua_pushnil(l);
HXDLIN(1638)															while((lua_next(l,-2) != 0)){
HXLINE(1638)																int index7 = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)																arr7->set(index7,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)																lua_pop(l,1);
            															}
HXDLIN(1638)															ret22 = arr7;
            														}
            														else {
HXLINE(1638)															 hx::Anon obj7 = hx::Anon_obj::Create();
HXDLIN(1638)															lua_pushnil(l);
HXDLIN(1638)															while((lua_next(l,-2) != 0)){
HXLINE(1638)																::String ret23;
HXDLIN(1638)																if (::hx::IsNull( ::llua::Convert_obj::fromLua(l,-2) )) {
HXLINE(1638)																	ret23 = HX_("null",87,9e,0e,49);
            																}
            																else {
HXLINE(1638)																	ret23 = ::Std_obj::string(::llua::Convert_obj::fromLua(l,-2));
            																}
HXDLIN(1638)																obj7->hx::Anon_obj::Add(ret23,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)																lua_pop(l,1);
            															}
HXDLIN(1638)															ret22 = obj7;
            														}
HXDLIN(1638)														ret21 = ret22;
            													}
            													break;
            													default:{
HXLINE(1638)														ret21 = null();
...
HXDLIN(1638)												obj4->hx::Anon_obj::Add(ret14,ret21);
HXDLIN(1638)												lua_pop(l,1);
            											}
HXDLIN(1638)											ret10 = obj4;
            										}
HXDLIN(1638)										ret9 = ret10;
            									}
            									break;
            									default:{
HXLINE(1638)										ret9 = null();
...
HXDLIN(1638)								ret5 = ::Std_obj::string(ret9);
            							}
HXDLIN(1638)							 ::Dynamic ret24 = null();
HXDLIN(1638)							switch((int)(lua_type(l,-1))){
            								case (int)0: {
HXLINE(1638)									ret24 = null();
            								}
            								break;
            								case (int)1: {
HXLINE(1638)									ret24 = (lua_toboolean(l,-1) != 0);
            								}
            								break;
            								case (int)3: {
HXLINE(1638)									ret24 = lua_tonumber(l,-1);
            								}
            								break;
            								case (int)4: {
HXLINE(1638)									ret24 = linc::lua::tostring(l,-1);
            								}
            								break;
            								case (int)5: {
HXLINE(1638)									bool array8 = true;
HXDLIN(1638)									 ::Dynamic ret25 = null();
HXDLIN(1638)									lua_pushnil(l);
HXDLIN(1638)									while((lua_next(l,-2) != 0)){
HXLINE(1638)										if ((lua_type(l,-2) != 3)) {
HXLINE(1638)											array8 = false;
HXDLIN(1638)											lua_pop(l,2);
HXDLIN(1638)											goto _hx_goto_194;
            										}
HXDLIN(1638)										Float n8 = lua_tonumber(l,-2);
HXDLIN(1638)										if ((n8 != ::Std_obj::_hx_int(n8))) {
HXLINE(1638)											array8 = false;
HXDLIN(1638)											lua_pop(l,2);
HXDLIN(1638)											goto _hx_goto_194;
            										}
HXDLIN(1638)										lua_pop(l,1);
            									...
            									_hx_goto_194:;
HXDLIN(1638)									if (array8) {
HXLINE(1638)										::cpp::VirtualArray arr8 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1638)										lua_pushnil(l);
HXDLIN(1638)										while((lua_next(l,-2) != 0)){
HXLINE(1638)											int index8 = (lua_tointeger(l,-2) - 1);
HXDLIN(1638)											arr8->set(index8,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)											lua_pop(l,1);
            										}
HXDLIN(1638)										ret25 = arr8;
            									}
            									else {
HXLINE(1638)										 hx::Anon obj8 = hx::Anon_obj::Create();
HXDLIN(1638)										lua_pushnil(l);
HXDLIN(1638)										while((lua_next(l,-2) != 0)){
HXLINE(1638)											::String ret26;
HXDLIN(1638)											if (::hx::IsNull( ::llua::Convert_obj::fromLua(l,-2) )) {
HXLINE(1638)												ret26 = HX_("null",87,9e,0e,49);
            											}
            											else {
HXLINE(1638)												ret26 = ::Std_obj::string(::llua::Convert_obj::fromLua(l,-2));
            											}
HXDLIN(1638)											obj8->hx::Anon_obj::Add(ret26,::llua::Convert_obj::fromLua(l,-1));
HXDLIN(1638)											lua_pop(l,1);
            										}
HXDLIN(1638)										ret25 = obj8;
            									}
HXDLIN(1638)									ret24 = ret25;
            								}
            								break;
            								default:{
HXLINE(1638)									ret24 = null();
...
HXDLIN(1638)							obj1->hx::Anon_obj::Add(ret5,ret24);
HXDLIN(1638)							lua_pop(l,1);
            						}
HXDLIN(1638)						ret1 = obj1;
            					}
HXDLIN(1638)					ret = ret1;
            				}
            				break;
            				default:{
HXLINE(1638)					ret = null();
...
HXDLIN(1638)			 ::Dynamic result = ret;
...
HXLINE(1746)		 ::Dynamic ret = null();
HXDLIN(1746)		switch((int)(lua_type(lua,-1))){
            			case (int)0: {
HXLINE(1746)				ret = null();
            			}
            			break;
            			case (int)1: {
HXLINE(1746)				ret = (lua_toboolean(lua,-1) != 0);
            			}
            			break;
            			case (int)3: {
HXLINE(1746)				ret = lua_tonumber(lua,-1);
            			}
            			break;
            			case (int)4: {
HXLINE(1746)				ret = linc::lua::tostring(lua,-1);
            			}
            			break;
            			case (int)5: {
HXLINE(1746)				bool array = true;
HXDLIN(1746)				 ::Dynamic ret1 = null();
HXDLIN(1746)				lua_pushnil(lua);
HXDLIN(1746)				while((lua_next(lua,-2) != 0)){
HXLINE(1746)					if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)						array = false;
HXDLIN(1746)						lua_pop(lua,2);
HXDLIN(1746)						goto _hx_goto_211;
            					}
HXDLIN(1746)					Float n = lua_tonumber(lua,-2);
HXDLIN(1746)					if ((n != ::Std_obj::_hx_int(n))) {
HXLINE(1746)						array = false;
HXDLIN(1746)						lua_pop(lua,2);
HXDLIN(1746)						goto _hx_goto_211;
            					}
HXDLIN(1746)					lua_pop(lua,1);
            				}
            				_hx_goto_211:;
HXDLIN(1746)				if (array) {
HXLINE(1746)					::cpp::VirtualArray arr = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)					lua_pushnil(lua);
HXDLIN(1746)					while((lua_next(lua,-2) != 0)){
HXLINE(1746)						int index = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)						 ::Dynamic ret2 = null();
HXDLIN(1746)						switch((int)(lua_type(lua,-1))){
            							case (int)0: {
HXLINE(1746)								ret2 = null();
            							}
            							break;
            							case (int)1: {
HXLINE(1746)								ret2 = (lua_toboolean(lua,-1) != 0);
            							}
            							break;
            							case (int)3: {
HXLINE(1746)								ret2 = lua_tonumber(lua,-1);
            							}
            							break;
            							case (int)4: {
HXLINE(1746)								ret2 = linc::lua::tostring(lua,-1);
            							}
            							break;
            							case (int)5: {
HXLINE(1746)								bool array1 = true;
HXDLIN(1746)								 ::Dynamic ret3 = null();
HXDLIN(1746)								lua_pushnil(lua);
HXDLIN(1746)								while((lua_next(lua,-2) != 0)){
HXLINE(1746)									if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)										array1 = false;
HXDLIN(1746)										lua_pop(lua,2);
HXDLIN(1746)										goto _hx_goto_213;
            									}
HXDLIN(1746)									Float n1 = lua_tonumber(lua,-2);
HXDLIN(1746)									if ((n1 != ::Std_obj::_hx_int(n1))) {
HXLINE(1746)										array1 = false;
HXDLIN(1746)										lua_pop(lua,2);
HXDLIN(1746)										goto _hx_goto_213;
            									}
HXDLIN(1746)									lua_pop(lua,1);
            								...
            								_hx_goto_213:;
HXDLIN(1746)								if (array1) {
HXLINE(1746)									::cpp::VirtualArray arr1 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)									lua_pushnil(lua);
HXDLIN(1746)									while((lua_next(lua,-2) != 0)){
HXLINE(1746)										int index1 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)										 ::Dynamic ret4 = null();
HXDLIN(1746)										switch((int)(lua_type(lua,-1))){
            											case (int)0: {
HXLINE(1746)												ret4 = null();
            											}
            											break;
            											case (int)1: {
HXLINE(1746)												ret4 = (lua_toboolean(lua,-1) != 0);
            											}
            											break;
            											case (int)3: {
HXLINE(1746)												ret4 = lua_tonumber(lua,-1);
            											}
            											break;
            											case (int)4: {
HXLINE(1746)												ret4 = linc::lua::tostring(lua,-1);
            											}
            											break;
            											case (int)5: {
HXLINE(1746)												bool array2 = true;
HXDLIN(1746)												 ::Dynamic ret5 = null();
HXDLIN(1746)												lua_pushnil(lua);
HXDLIN(1746)												while((lua_next(lua,-2) != 0)){
HXLINE(1746)													if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)														array2 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_215;
            													}
HXDLIN(1746)													Float n2 = lua_tonumber(lua,-2);
HXDLIN(1746)													if ((n2 != ::Std_obj::_hx_int(n2))) {
HXLINE(1746)														array2 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_215;
            													}
HXDLIN(1746)													lua_pop(lua,1);
            												...
            												_hx_goto_215:;
HXDLIN(1746)												if (array2) {
HXLINE(1746)													::cpp::VirtualArray arr2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														int index2 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)														arr2->set(index2,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret5 = arr2;
            												}
            												else {
HXLINE(1746)													 hx::Anon obj = hx::Anon_obj::Create();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														::String ret6;
HXDLIN(1746)														if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)															ret6 = HX_("null",87,9e,0e,49);
            														}
            														else {
HXLINE(1746)															ret6 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            														}
HXDLIN(1746)														obj->hx::Anon_obj::Add(ret6,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret5 = obj;
            												}
HXDLIN(1746)												ret4 = ret5;
            											}
            											break;
            											default:{
HXLINE(1746)												ret4 = null();
HXDLIN(1746)												::haxe::Log_obj::trace(HX_("return value not supported\n",48,41,fb,c8),::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),97,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            											}
            										}
HXDLIN(1746)										arr1->set(index1,ret4);
HXDLIN(1746)										lua_pop(lua,1);
            									}
HXDLIN(1746)									ret3 = arr1;
            								}
            								else {
HXLINE(1746)									 hx::Anon obj1 = hx::Anon_obj::Create();
HXDLIN(1746)									lua_pushnil(lua);
HXDLIN(1746)									while((lua_next(lua,-2) != 0)){
HXLINE(1746)										::String ret7;
HXDLIN(1746)										 ::Dynamic ret8 = null();
HXDLIN(1746)										switch((int)(lua_type(lua,-2))){
            											case (int)0: {
HXLINE(1746)												ret8 = null();
            											}
            											break;
            											case (int)1: {
HXLINE(1746)												ret8 = (lua_toboolean(lua,-2) != 0);
            											}
            											break;
            											case (int)3: {
HXLINE(1746)												ret8 = lua_tonumber(lua,-2);
            											}
            											break;
            											case (int)4: {
HXLINE(1746)												ret8 = linc::lua::tostring(lua,-2);
            											}
            											break;
            											case (int)5: {
HXLINE(1746)												bool array3 = true;
HXDLIN(1746)												 ::Dynamic ret9 = null();
HXDLIN(1746)												lua_pushnil(lua);
HXDLIN(1746)												while((lua_next(lua,-2) != 0)){
HXLINE(1746)													if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)														array3 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_219;
            													}
HXDLIN(1746)													Float n3 = lua_tonumber(lua,-2);
HXDLIN(1746)													if ((n3 != ::Std_obj::_hx_int(n3))) {
HXLINE(1746)														array3 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_219;
            													}
HXDLIN(1746)													lua_pop(lua,1);
            												...
            												_hx_goto_219:;
HXDLIN(1746)												if (array3) {
HXLINE(1746)													::cpp::VirtualArray arr3 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														int index3 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)														arr3->set(index3,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret9 = arr3;
            												}
            												else {
HXLINE(1746)													 hx::Anon obj2 = hx::Anon_obj::Create();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														::String ret10;
HXDLIN(1746)														if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)															ret10 = HX_("null",87,9e,0e,49);
            														}
            														else {
HXLINE(1746)															ret10 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            														}
HXDLIN(1746)														obj2->hx::Anon_obj::Add(ret10,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret9 = obj2;
            												}
HXDLIN(1746)												ret8 = ret9;
            											}
            											break;
            											default:{
HXLINE(1746)												ret8 = null();
...
HXDLIN(1746)										if (::hx::IsNull( ret8 )) {
HXLINE(1746)											ret7 = HX_("null",87,9e,0e,49);
            										}
            										else {
HXLINE(1746)											 ::Dynamic ret11 = null();
HXDLIN(1746)											switch((int)(lua_type(lua,-2))){
            												case (int)0: {
HXLINE(1746)													ret11 = null();
            												}
            												break;
            												case (int)1: {
HXLINE(1746)													ret11 = (lua_toboolean(lua,-2) != 0);
            												}
            												break;
            												case (int)3: {
HXLINE(1746)													ret11 = lua_tonumber(lua,-2);
            												}
            												break;
            												case (int)4: {
HXLINE(1746)													ret11 = linc::lua::tostring(lua,-2);
            												}
            												break;
            												case (int)5: {
HXLINE(1746)													bool array4 = true;
HXDLIN(1746)													 ::Dynamic ret12 = null();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)															array4 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_222;
            														}
HXDLIN(1746)														Float n4 = lua_tonumber(lua,-2);
HXDLIN(1746)														if ((n4 != ::Std_obj::_hx_int(n4))) {
HXLINE(1746)															array4 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_222;
            														}
HXDLIN(1746)														lua_pop(lua,1);
            													...
            													_hx_goto_222:;
HXDLIN(1746)													if (array4) {
HXLINE(1746)														::cpp::VirtualArray arr4 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															int index4 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)															 ::Dynamic ret13 = null();
HXDLIN(1746)															switch((int)(lua_type(lua,-1))){
            																case (int)0: {
HXLINE(1746)																	ret13 = null();
            																}
            																break;
            																case (int)1: {
HXLINE(1746)																	ret13 = (lua_toboolean(lua,-1) != 0);
            																}
            																break;
            																case (int)3: {
HXLINE(1746)																	ret13 = lua_tonumber(lua,-1);
            																}
            																break;
            																case (int)4: {
HXLINE(1746)																	ret13 = linc::lua::tostring(lua,-1);
            																}
            																break;
            																case (int)5: {
HXLINE(1746)																	bool array5 = true;
HXDLIN(1746)																	 ::Dynamic ret14 = null();
HXDLIN(1746)																	lua_pushnil(lua);
HXDLIN(1746)																	while((lua_next(lua,-2) != 0)){
HXLINE(1746)																		if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																			array5 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_224;
            																		}
HXDLIN(1746)																		Float n5 = lua_tonumber(lua,-2);
HXDLIN(1746)																		if ((n5 != ::Std_obj::_hx_int(n5))) {
HXLINE(1746)																			array5 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_224;
            																		}
HXDLIN(1746)																		lua_pop(lua,1);
            																	...
            																	_hx_goto_224:;
HXDLIN(1746)																	if (array5) {
HXLINE(1746)																		::cpp::VirtualArray arr5 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			int index5 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																			arr5->set(index5,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret14 = arr5;
            																	}
            																	else {
HXLINE(1746)																		 hx::Anon obj3 = hx::Anon_obj::Create();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			::String ret15;
HXDLIN(1746)																			if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																				ret15 = HX_("null",87,9e,0e,49);
            																			}
            																			else {
HXLINE(1746)																				ret15 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																			}
HXDLIN(1746)																			obj3->hx::Anon_obj::Add(ret15,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret14 = obj3;
            																	}
HXDLIN(1746)																	ret13 = ret14;
            																}
            																break;
            																default:{
HXLINE(1746)																	ret13 = null();
...
HXDLIN(1746)															arr4->set(index4,ret13);
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret12 = arr4;
            													}
            													else {
HXLINE(1746)														 hx::Anon obj4 = hx::Anon_obj::Create();
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															::String ret16;
HXDLIN(1746)															 ::Dynamic ret17 = null();
HXDLIN(1746)															switch((int)(lua_type(lua,-2))){
            																case (int)0: {
HXLINE(1746)																	ret17 = null();
            																}
            																break;
            																case (int)1: {
HXLINE(1746)																	ret17 = (lua_toboolean(lua,-2) != 0);
            																}
            																break;
            																case (int)3: {
HXLINE(1746)																	ret17 = lua_tonumber(lua,-2);
            																}
            																break;
            																case (int)4: {
HXLINE(1746)																	ret17 = linc::lua::tostring(lua,-2);
            																}
            																break;
            																case (int)5: {
HXLINE(1746)																	bool array6 = true;
HXDLIN(1746)																	 ::Dynamic ret18 = null();
HXDLIN(1746)																	lua_pushnil(lua);
HXDLIN(1746)																	while((lua_next(lua,-2) != 0)){
HXLINE(1746)																		if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																			array6 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_228;
            																		}
HXDLIN(1746)																		Float n6 = lua_tonumber(lua,-2);
HXDLIN(1746)																		if ((n6 != ::Std_obj::_hx_int(n6))) {
HXLINE(1746)																			array6 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_228;
            																		}
HXDLIN(1746)																		lua_pop(lua,1);
            																	...
            																	_hx_goto_228:;
HXDLIN(1746)																	if (array6) {
HXLINE(1746)																		::cpp::VirtualArray arr6 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			int index6 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																			arr6->set(index6,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret18 = arr6;
            																	}
            																	else {
HXLINE(1746)																		 hx::Anon obj5 = hx::Anon_obj::Create();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			::String ret19;
HXDLIN(1746)																			if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																				ret19 = HX_("null",87,9e,0e,49);
            																			}
            																			else {
HXLINE(1746)																				ret19 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																			}
HXDLIN(1746)																			obj5->hx::Anon_obj::Add(ret19,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret18 = obj5;
            																	}
HXDLIN(1746)																	ret17 = ret18;
            																}
            																break;
            																default:{
HXLINE(1746)																	ret17 = null();
...
HXDLIN(1746)															if (::hx::IsNull( ret17 )) {
HXLINE(1746)																ret16 = HX_("null",87,9e,0e,49);
            															}
            															else {
HXLINE(1746)																 ::Dynamic ret20 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-2))){
            																	case (int)0: {
HXLINE(1746)																		ret20 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret20 = (lua_toboolean(lua,-2) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret20 = lua_tonumber(lua,-2);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret20 = linc::lua::tostring(lua,-2);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array7 = true;
HXDLIN(1746)																		 ::Dynamic ret21 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array7 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_231;
            																			}
HXDLIN(1746)																			Float n7 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n7 != ::Std_obj::_hx_int(n7))) {
HXLINE(1746)																				array7 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_231;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_231:;
HXDLIN(1746)																		if (array7) {
HXLINE(1746)																			::cpp::VirtualArray arr7 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index7 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr7->set(index7,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret21 = arr7;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj6 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret22;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret22 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret22 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj6->hx::Anon_obj::Add(ret22,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret21 = obj6;
            																		}
HXDLIN(1746)																		ret20 = ret21;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret20 = null();
...
HXDLIN(1746)																ret16 = ::Std_obj::string(ret20);
            															}
HXDLIN(1746)															 ::Dynamic ret23 = null();
HXDLIN(1746)															switch((int)(lua_type(lua,-1))){
            																case (int)0: {
HXLINE(1746)																	ret23 = null();
            																}
            																break;
            																case (int)1: {
HXLINE(1746)																	ret23 = (lua_toboolean(lua,-1) != 0);
            																}
            																break;
            																case (int)3: {
HXLINE(1746)																	ret23 = lua_tonumber(lua,-1);
            																}
            																break;
            																case (int)4: {
HXLINE(1746)																	ret23 = linc::lua::tostring(lua,-1);
            																}
            																break;
            																case (int)5: {
HXLINE(1746)																	bool array8 = true;
HXDLIN(1746)																	 ::Dynamic ret24 = null();
HXDLIN(1746)																	lua_pushnil(lua);
HXDLIN(1746)																	while((lua_next(lua,-2) != 0)){
HXLINE(1746)																		if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																			array8 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_234;
            																		}
HXDLIN(1746)																		Float n8 = lua_tonumber(lua,-2);
HXDLIN(1746)																		if ((n8 != ::Std_obj::_hx_int(n8))) {
HXLINE(1746)																			array8 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_234;
            																		}
HXDLIN(1746)																		lua_pop(lua,1);
            																	...
            																	_hx_goto_234:;
HXDLIN(1746)																	if (array8) {
HXLINE(1746)																		::cpp::VirtualArray arr8 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			int index8 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																			arr8->set(index8,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret24 = arr8;
            																	}
            																	else {
HXLINE(1746)																		 hx::Anon obj7 = hx::Anon_obj::Create();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			::String ret25;
HXDLIN(1746)																			if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																				ret25 = HX_("null",87,9e,0e,49);
            																			}
            																			else {
HXLINE(1746)																				ret25 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																			}
HXDLIN(1746)																			obj7->hx::Anon_obj::Add(ret25,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret24 = obj7;
            																	}
HXDLIN(1746)																	ret23 = ret24;
            																}
            																break;
            																default:{
HXLINE(1746)																	ret23 = null();
...
HXDLIN(1746)															obj4->hx::Anon_obj::Add(ret16,ret23);
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret12 = obj4;
            													}
HXDLIN(1746)													ret11 = ret12;
            												}
            												break;
            												default:{
HXLINE(1746)													ret11 = null();
...
HXDLIN(1746)											ret7 = ::Std_obj::string(ret11);
            										}
HXDLIN(1746)										 ::Dynamic ret26 = null();
HXDLIN(1746)										switch((int)(lua_type(lua,-1))){
            											case (int)0: {
HXLINE(1746)												ret26 = null();
            											}
            											break;
            											case (int)1: {
HXLINE(1746)												ret26 = (lua_toboolean(lua,-1) != 0);
            											}
            											break;
            											case (int)3: {
HXLINE(1746)												ret26 = lua_tonumber(lua,-1);
            											}
            											break;
            											case (int)4: {
HXLINE(1746)												ret26 = linc::lua::tostring(lua,-1);
            											}
            											break;
            											case (int)5: {
HXLINE(1746)												bool array9 = true;
HXDLIN(1746)												 ::Dynamic ret27 = null();
HXDLIN(1746)												lua_pushnil(lua);
HXDLIN(1746)												while((lua_next(lua,-2) != 0)){
HXLINE(1746)													if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)														array9 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_237;
            													}
HXDLIN(1746)													Float n9 = lua_tonumber(lua,-2);
HXDLIN(1746)													if ((n9 != ::Std_obj::_hx_int(n9))) {
HXLINE(1746)														array9 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_237;
            													}
HXDLIN(1746)													lua_pop(lua,1);
            												...
            												_hx_goto_237:;
HXDLIN(1746)												if (array9) {
HXLINE(1746)													::cpp::VirtualArray arr9 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														int index9 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)														arr9->set(index9,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret27 = arr9;
            												}
            												else {
HXLINE(1746)													 hx::Anon obj8 = hx::Anon_obj::Create();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														::String ret28;
HXDLIN(1746)														if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)															ret28 = HX_("null",87,9e,0e,49);
            														}
            														else {
HXLINE(1746)															ret28 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            														}
HXDLIN(1746)														obj8->hx::Anon_obj::Add(ret28,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret27 = obj8;
            												}
HXDLIN(1746)												ret26 = ret27;
            											}
            											break;
            											default:{
HXLINE(1746)												ret26 = null();
...
HXDLIN(1746)										obj1->hx::Anon_obj::Add(ret7,ret26);
HXDLIN(1746)										lua_pop(lua,1);
            									}
HXDLIN(1746)									ret3 = obj1;
            								}
HXDLIN(1746)								ret2 = ret3;
            							}
            							break;
            							default:{
HXLINE(1746)								ret2 = null();
...
HXDLIN(1746)						arr->set(index,ret2);
HXDLIN(1746)						lua_pop(lua,1);
            					}
HXDLIN(1746)					ret1 = arr;
            				}
            				else {
HXLINE(1746)					 hx::Anon obj9 = hx::Anon_obj::Create();
HXDLIN(1746)					lua_pushnil(lua);
HXDLIN(1746)					while((lua_next(lua,-2) != 0)){
HXLINE(1746)						::String ret29;
HXDLIN(1746)						 ::Dynamic ret301 = null();
HXDLIN(1746)						{
HXLINE(1746)							int _g1 = lua_type(lua,-2);
HXDLIN(1746)							switch((int)(_g1)){
            								case (int)0: {
HXLINE(1746)									ret301 = null();
            								}
            								break;
            								case (int)1: {
HXLINE(1746)									ret301 = (lua_toboolean(lua,-2) != 0);
            								}
            								break;
            								case (int)3: {
HXLINE(1746)									ret301 = lua_tonumber(lua,-2);
            								}
            								break;
            								case (int)4: {
HXLINE(1746)									ret301 = linc::lua::tostring(lua,-2);
            								}
            								break;
            								case (int)5: {
HXLINE(1746)									bool array101 = true;
HXDLIN(1746)									 ::Dynamic ret311 = null();
HXDLIN(1746)									lua_pushnil(lua);
HXDLIN(1746)									while((lua_next(lua,-2) != 0)){
HXLINE(1746)										if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)											array101 = false;
HXDLIN(1746)											lua_pop(lua,2);
HXDLIN(1746)											goto _hx_goto_241;
            										}
HXDLIN(1746)										Float n101 = lua_tonumber(lua,-2);
HXDLIN(1746)										if ((n101 != ::Std_obj::_hx_int(n101))) {
HXLINE(1746)											array101 = false;
HXDLIN(1746)											lua_pop(lua,2);
HXDLIN(1746)											goto _hx_goto_241;
            										}
HXDLIN(1746)										lua_pop(lua,1);
            									...
            									_hx_goto_241:;
HXDLIN(1746)									if (array101) {
HXLINE(1746)										::cpp::VirtualArray arr101 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)										lua_pushnil(lua);
HXDLIN(1746)										while((lua_next(lua,-2) != 0)){
HXLINE(1746)											int index101 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)											 ::Dynamic ret32 = null();
HXDLIN(1746)											switch((int)(lua_type(lua,-1))){
            												case (int)0: {
HXLINE(1746)													ret32 = null();
            												}
            												break;
            												case (int)1: {
HXLINE(1746)													ret32 = (lua_toboolean(lua,-1) != 0);
            												}
            												break;
            												case (int)3: {
HXLINE(1746)													ret32 = lua_tonumber(lua,-1);
            												}
            												break;
            												case (int)4: {
HXLINE(1746)													ret32 = linc::lua::tostring(lua,-1);
            												}
            												break;
            												case (int)5: {
HXLINE(1746)													bool array11 = true;
HXDLIN(1746)													 ::Dynamic ret33 = null();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)															array11 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_243;
            														}
HXDLIN(1746)														Float n11 = lua_tonumber(lua,-2);
HXDLIN(1746)														if ((n11 != ::Std_obj::_hx_int(n11))) {
HXLINE(1746)															array11 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_243;
            														}
HXDLIN(1746)														lua_pop(lua,1);
            													...
            													_hx_goto_243:;
HXDLIN(1746)													if (array11) {
HXLINE(1746)														::cpp::VirtualArray arr11 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															int index11 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)															arr11->set(index11,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret33 = arr11;
            													}
            													else {
HXLINE(1746)														 hx::Anon obj10 = hx::Anon_obj::Create();
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															::String ret34;
HXDLIN(1746)															if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																ret34 = HX_("null",87,9e,0e,49);
            															}
            															else {
HXLINE(1746)																ret34 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            															}
HXDLIN(1746)															obj10->hx::Anon_obj::Add(ret34,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret33 = obj10;
            													}
HXDLIN(1746)													ret32 = ret33;
            												}
            												break;
            												default:{
HXLINE(1746)													ret32 = null();
...
HXDLIN(1746)											arr101->set(index101,ret32);
HXDLIN(1746)											lua_pop(lua,1);
            										}
HXDLIN(1746)										ret311 = arr101;
            									}
            									else {
HXLINE(1746)										 hx::Anon obj111 = hx::Anon_obj::Create();
HXDLIN(1746)										lua_pushnil(lua);
HXDLIN(1746)										while((lua_next(lua,-2) != 0)){
HXLINE(1746)											 ::Dynamic ret35 = null();
HXDLIN(1746)											switch((int)(lua_type(lua,-2))){
            												case (int)0: {
HXLINE(1746)													ret35 = null();
            												}
            												break;
            												case (int)1: {
HXLINE(1746)													ret35 = (lua_toboolean(lua,-2) != 0);
            												}
            												break;
            												case (int)3: {
HXLINE(1746)													ret35 = lua_tonumber(lua,-2);
            												}
            												break;
            												case (int)4: {
HXLINE(1746)													ret35 = linc::lua::tostring(lua,-2);
            												}
            												break;
            												case (int)5: {
HXLINE(1746)													bool array12 = true;
HXDLIN(1746)													 ::Dynamic ret36 = null();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)															array12 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_247;
            														}
HXDLIN(1746)														Float n12 = lua_tonumber(lua,-2);
HXDLIN(1746)														if ((n12 != ::Std_obj::_hx_int(n12))) {
HXLINE(1746)															array12 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_247;
            														}
HXDLIN(1746)														lua_pop(lua,1);
            													...
            													_hx_goto_247:;
HXDLIN(1746)													if (array12) {
HXLINE(1746)														::cpp::VirtualArray arr12 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															int index12 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)															arr12->set(index12,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret36 = arr12;
            													}
            													else {
HXLINE(1746)														 hx::Anon obj12 = hx::Anon_obj::Create();
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															::String ret37;
HXDLIN(1746)															if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																ret37 = HX_("null",87,9e,0e,49);
            															}
            															else {
HXLINE(1746)																ret37 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            															}
HXDLIN(1746)															obj12->hx::Anon_obj::Add(ret37,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret36 = obj12;
            													}
HXDLIN(1746)													ret35 = ret36;
            												}
            												break;
            												default:{
HXLINE(1746)													ret35 = null();
...
HXDLIN(1746)											::String ret38 = ::Std_obj::string(ret35);
HXDLIN(1746)											 ::Dynamic ret39 = null();
HXDLIN(1746)											switch((int)(lua_type(lua,-1))){
            												case (int)0: {
HXLINE(1746)													ret39 = null();
            												}
            												break;
            												case (int)1: {
HXLINE(1746)													ret39 = (lua_toboolean(lua,-1) != 0);
            												}
            												break;
            												case (int)3: {
HXLINE(1746)													ret39 = lua_tonumber(lua,-1);
            												}
            												break;
            												case (int)4: {
HXLINE(1746)													ret39 = linc::lua::tostring(lua,-1);
            												}
            												break;
            												case (int)5: {
HXLINE(1746)													bool array13 = true;
HXDLIN(1746)													 ::Dynamic ret40 = null();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)															array13 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_250;
            														}
HXDLIN(1746)														Float n13 = lua_tonumber(lua,-2);
HXDLIN(1746)														if ((n13 != ::Std_obj::_hx_int(n13))) {
HXLINE(1746)															array13 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_250;
            														}
HXDLIN(1746)														lua_pop(lua,1);
            													...
            													_hx_goto_250:;
HXDLIN(1746)													if (array13) {
HXLINE(1746)														::cpp::VirtualArray arr13 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															int index13 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)															arr13->set(index13,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret40 = arr13;
            													}
            													else {
HXLINE(1746)														 hx::Anon obj13 = hx::Anon_obj::Create();
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															::String ret41;
HXDLIN(1746)															if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																ret41 = HX_("null",87,9e,0e,49);
            															}
            															else {
HXLINE(1746)																ret41 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            															}
HXDLIN(1746)															obj13->hx::Anon_obj::Add(ret41,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret40 = obj13;
            													}
HXDLIN(1746)													ret39 = ret40;
            												}
            												break;
            												default:{
HXLINE(1746)													ret39 = null();
...
HXDLIN(1746)											obj111->hx::Anon_obj::Add(ret38,ret39);
HXDLIN(1746)											lua_pop(lua,1);
            										}
HXDLIN(1746)										ret311 = obj111;
            									}
HXDLIN(1746)									ret301 = ret311;
            								}
            								break;
            								default:{
HXLINE(1746)									ret301 = null();
...
HXDLIN(1746)						if (::hx::IsNull( ret301 )) {
HXLINE(1746)							ret29 = HX_("null",87,9e,0e,49);
            						}
            						else {
HXLINE(1746)							 ::Dynamic ret301 = null();
HXDLIN(1746)							{
HXLINE(1746)								int _g1 = lua_type(lua,-2);
HXDLIN(1746)								switch((int)(_g1)){
            									case (int)0: {
...
HXDLIN(1746)											while((lua_next(lua,-2) != 0)){
HXLINE(1746)												int index101 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)												 ::Dynamic ret42 = null();
HXDLIN(1746)												switch((int)(lua_type(lua,-1))){
            													case (int)0: {
HXLINE(1746)														ret42 = null();
            													}
            													break;
            													case (int)1: {
HXLINE(1746)														ret42 = (lua_toboolean(lua,-1) != 0);
            													}
            													break;
            													case (int)3: {
HXLINE(1746)														ret42 = lua_tonumber(lua,-1);
            													}
            													break;
            													case (int)4: {
HXLINE(1746)														ret42 = linc::lua::tostring(lua,-1);
            													}
            													break;
            													case (int)5: {
HXLINE(1746)														bool array14 = true;
HXDLIN(1746)														 ::Dynamic ret43 = null();
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																array14 = false;
HXDLIN(1746)																lua_pop(lua,2);
HXDLIN(1746)																goto _hx_goto_255;
            															}
HXDLIN(1746)															Float n14 = lua_tonumber(lua,-2);
HXDLIN(1746)															if ((n14 != ::Std_obj::_hx_int(n14))) {
HXLINE(1746)																array14 = false;
HXDLIN(1746)																lua_pop(lua,2);
HXDLIN(1746)																goto _hx_goto_255;
            															}
HXDLIN(1746)															lua_pop(lua,1);
            														...
            														_hx_goto_255:;
HXDLIN(1746)														if (array14) {
HXLINE(1746)															::cpp::VirtualArray arr14 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)															lua_pushnil(lua);
HXDLIN(1746)															while((lua_next(lua,-2) != 0)){
HXLINE(1746)																int index14 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																 ::Dynamic ret44 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-1))){
            																	case (int)0: {
HXLINE(1746)																		ret44 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret44 = (lua_toboolean(lua,-1) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret44 = lua_tonumber(lua,-1);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret44 = linc::lua::tostring(lua,-1);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array15 = true;
HXDLIN(1746)																		 ::Dynamic ret45 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array15 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_257;
            																			}
HXDLIN(1746)																			Float n15 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n15 != ::Std_obj::_hx_int(n15))) {
HXLINE(1746)																				array15 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_257;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_257:;
HXDLIN(1746)																		if (array15) {
HXLINE(1746)																			::cpp::VirtualArray arr15 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index15 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr15->set(index15,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret45 = arr15;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj14 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret46;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret46 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret46 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj14->hx::Anon_obj::Add(ret46,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret45 = obj14;
            																		}
HXDLIN(1746)																		ret44 = ret45;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret44 = null();
...
HXDLIN(1746)																arr14->set(index14,ret44);
HXDLIN(1746)																lua_pop(lua,1);
            															}
HXDLIN(1746)															ret43 = arr14;
            														}
            														else {
HXLINE(1746)															 hx::Anon obj15 = hx::Anon_obj::Create();
HXDLIN(1746)															lua_pushnil(lua);
HXDLIN(1746)															while((lua_next(lua,-2) != 0)){
HXLINE(1746)																::String ret47;
HXDLIN(1746)																 ::Dynamic ret48 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-2))){
            																	case (int)0: {
HXLINE(1746)																		ret48 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret48 = (lua_toboolean(lua,-2) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret48 = lua_tonumber(lua,-2);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret48 = linc::lua::tostring(lua,-2);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array16 = true;
HXDLIN(1746)																		 ::Dynamic ret49 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array16 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_261;
            																			}
HXDLIN(1746)																			Float n16 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n16 != ::Std_obj::_hx_int(n16))) {
HXLINE(1746)																				array16 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_261;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_261:;
HXDLIN(1746)																		if (array16) {
HXLINE(1746)																			::cpp::VirtualArray arr16 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index16 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr16->set(index16,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret49 = arr16;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj16 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret50;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret50 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret50 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj16->hx::Anon_obj::Add(ret50,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret49 = obj16;
            																		}
HXDLIN(1746)																		ret48 = ret49;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret48 = null();
...
HXDLIN(1746)																if (::hx::IsNull( ret48 )) {
HXLINE(1746)																	ret47 = HX_("null",87,9e,0e,49);
            																}
            																else {
HXLINE(1746)																	 ::Dynamic ret51 = null();
HXDLIN(1746)																	switch((int)(lua_type(lua,-2))){
            																		case (int)0: {
HXLINE(1746)																			ret51 = null();
            																		}
            																		break;
            																		case (int)1: {
HXLINE(1746)																			ret51 = (lua_toboolean(lua,-2) != 0);
            																		}
            																		break;
            																		case (int)3: {
HXLINE(1746)																			ret51 = lua_tonumber(lua,-2);
            																		}
            																		break;
            																		case (int)4: {
HXLINE(1746)																			ret51 = linc::lua::tostring(lua,-2);
            																		}
            																		break;
            																		case (int)5: {
HXLINE(1746)																			bool array17 = true;
HXDLIN(1746)																			 ::Dynamic ret52 = null();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																					array17 = false;
HXDLIN(1746)																					lua_pop(lua,2);
HXDLIN(1746)																					goto _hx_goto_264;
            																				}
HXDLIN(1746)																				Float n17 = lua_tonumber(lua,-2);
HXDLIN(1746)																				if ((n17 != ::Std_obj::_hx_int(n17))) {
HXLINE(1746)																					array17 = false;
HXDLIN(1746)																					lua_pop(lua,2);
HXDLIN(1746)																					goto _hx_goto_264;
            																				}
HXDLIN(1746)																				lua_pop(lua,1);
            																			...
            																			_hx_goto_264:;
HXDLIN(1746)																			if (array17) {
HXLINE(1746)																				::cpp::VirtualArray arr17 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																				lua_pushnil(lua);
HXDLIN(1746)																				while((lua_next(lua,-2) != 0)){
HXLINE(1746)																					int index17 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																					arr17->set(index17,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																					lua_pop(lua,1);
            																				}
HXDLIN(1746)																				ret52 = arr17;
            																			}
            																			else {
HXLINE(1746)																				 hx::Anon obj17 = hx::Anon_obj::Create();
HXDLIN(1746)																				lua_pushnil(lua);
HXDLIN(1746)																				while((lua_next(lua,-2) != 0)){
HXLINE(1746)																					::String ret53;
HXDLIN(1746)																					if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																						ret53 = HX_("null",87,9e,0e,49);
            																					}
            																					else {
HXLINE(1746)																						ret53 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																					}
HXDLIN(1746)																					obj17->hx::Anon_obj::Add(ret53,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																					lua_pop(lua,1);
            																				}
HXDLIN(1746)																				ret52 = obj17;
            																			}
HXDLIN(1746)																			ret51 = ret52;
            																		}
            																		break;
            																		default:{
HXLINE(1746)																			ret51 = null();
...
HXDLIN(1746)																	ret47 = ::Std_obj::string(ret51);
            																}
HXDLIN(1746)																 ::Dynamic ret54 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-1))){
            																	case (int)0: {
HXLINE(1746)																		ret54 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret54 = (lua_toboolean(lua,-1) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret54 = lua_tonumber(lua,-1);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret54 = linc::lua::tostring(lua,-1);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array18 = true;
HXDLIN(1746)																		 ::Dynamic ret55 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array18 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_267;
            																			}
HXDLIN(1746)																			Float n18 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n18 != ::Std_obj::_hx_int(n18))) {
HXLINE(1746)																				array18 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_267;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_267:;
HXDLIN(1746)																		if (array18) {
HXLINE(1746)																			::cpp::VirtualArray arr18 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index18 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr18->set(index18,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret55 = arr18;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj18 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret56;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret56 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret56 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj18->hx::Anon_obj::Add(ret56,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret55 = obj18;
            																		}
HXDLIN(1746)																		ret54 = ret55;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret54 = null();
...
HXDLIN(1746)																obj15->hx::Anon_obj::Add(ret47,ret54);
HXDLIN(1746)																lua_pop(lua,1);
            															}
HXDLIN(1746)															ret43 = obj15;
            														}
HXDLIN(1746)														ret42 = ret43;
            													}
            													break;
            													default:{
HXLINE(1746)														ret42 = null();
...
HXDLIN(1746)												arr101->set(index101,ret42);
HXDLIN(1746)												lua_pop(lua,1);
            											}
HXDLIN(1746)											ret311 = arr101;
            										}
...
HXDLIN(1746)											lua_pushnil(lua);
HXDLIN(1746)											while((lua_next(lua,-2) != 0)){
HXLINE(1746)												 ::Dynamic ret57 = null();
HXDLIN(1746)												switch((int)(lua_type(lua,-2))){
            													case (int)0: {
HXLINE(1746)														ret57 = null();
            													}
            													break;
            													case (int)1: {
HXLINE(1746)														ret57 = (lua_toboolean(lua,-2) != 0);
            													}
            													break;
            													case (int)3: {
HXLINE(1746)														ret57 = lua_tonumber(lua,-2);
            													}
            													break;
            													case (int)4: {
HXLINE(1746)														ret57 = linc::lua::tostring(lua,-2);
            													}
            													break;
            													case (int)5: {
HXLINE(1746)														bool array19 = true;
HXDLIN(1746)														 ::Dynamic ret58 = null();
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																array19 = false;
HXDLIN(1746)																lua_pop(lua,2);
HXDLIN(1746)																goto _hx_goto_271;
            															}
HXDLIN(1746)															Float n19 = lua_tonumber(lua,-2);
HXDLIN(1746)															if ((n19 != ::Std_obj::_hx_int(n19))) {
HXLINE(1746)																array19 = false;
HXDLIN(1746)																lua_pop(lua,2);
HXDLIN(1746)																goto _hx_goto_271;
            															}
HXDLIN(1746)															lua_pop(lua,1);
            														...
            														_hx_goto_271:;
HXDLIN(1746)														if (array19) {
HXLINE(1746)															::cpp::VirtualArray arr19 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)															lua_pushnil(lua);
HXDLIN(1746)															while((lua_next(lua,-2) != 0)){
HXLINE(1746)																int index19 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																 ::Dynamic ret59 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-1))){
            																	case (int)0: {
HXLINE(1746)																		ret59 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret59 = (lua_toboolean(lua,-1) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret59 = lua_tonumber(lua,-1);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret59 = linc::lua::tostring(lua,-1);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array20 = true;
HXDLIN(1746)																		 ::Dynamic ret60 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array20 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_273;
            																			}
HXDLIN(1746)																			Float n20 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n20 != ::Std_obj::_hx_int(n20))) {
HXLINE(1746)																				array20 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_273;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_273:;
HXDLIN(1746)																		if (array20) {
HXLINE(1746)																			::cpp::VirtualArray arr20 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index20 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr20->set(index20,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret60 = arr20;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj19 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret61;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret61 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret61 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj19->hx::Anon_obj::Add(ret61,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret60 = obj19;
            																		}
HXDLIN(1746)																		ret59 = ret60;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret59 = null();
...
HXDLIN(1746)																arr19->set(index19,ret59);
HXDLIN(1746)																lua_pop(lua,1);
            															}
HXDLIN(1746)															ret58 = arr19;
            														}
            														else {
HXLINE(1746)															 hx::Anon obj20 = hx::Anon_obj::Create();
HXDLIN(1746)															lua_pushnil(lua);
HXDLIN(1746)															while((lua_next(lua,-2) != 0)){
HXLINE(1746)																::String ret62;
HXDLIN(1746)																 ::Dynamic ret63 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-2))){
            																	case (int)0: {
HXLINE(1746)																		ret63 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret63 = (lua_toboolean(lua,-2) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret63 = lua_tonumber(lua,-2);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret63 = linc::lua::tostring(lua,-2);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array21 = true;
HXDLIN(1746)																		 ::Dynamic ret64 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array21 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_277;
            																			}
HXDLIN(1746)																			Float n21 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n21 != ::Std_obj::_hx_int(n21))) {
HXLINE(1746)																				array21 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_277;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_277:;
HXDLIN(1746)																		if (array21) {
HXLINE(1746)																			::cpp::VirtualArray arr21 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index21 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr21->set(index21,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret64 = arr21;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj21 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret65;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret65 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret65 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj21->hx::Anon_obj::Add(ret65,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret64 = obj21;
            																		}
HXDLIN(1746)																		ret63 = ret64;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret63 = null();
...
HXDLIN(1746)																if (::hx::IsNull( ret63 )) {
HXLINE(1746)																	ret62 = HX_("null",87,9e,0e,49);
            																}
            																else {
HXLINE(1746)																	 ::Dynamic ret66 = null();
HXDLIN(1746)																	switch((int)(lua_type(lua,-2))){
            																		case (int)0: {
HXLINE(1746)																			ret66 = null();
            																		}
            																		break;
            																		case (int)1: {
HXLINE(1746)																			ret66 = (lua_toboolean(lua,-2) != 0);
            																		}
            																		break;
            																		case (int)3: {
HXLINE(1746)																			ret66 = lua_tonumber(lua,-2);
            																		}
            																		break;
            																		case (int)4: {
HXLINE(1746)																			ret66 = linc::lua::tostring(lua,-2);
            																		}
            																		break;
            																		case (int)5: {
HXLINE(1746)																			bool array22 = true;
HXDLIN(1746)																			 ::Dynamic ret67 = null();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																					array22 = false;
HXDLIN(1746)																					lua_pop(lua,2);
HXDLIN(1746)																					goto _hx_goto_280;
            																				}
HXDLIN(1746)																				Float n22 = lua_tonumber(lua,-2);
HXDLIN(1746)																				if ((n22 != ::Std_obj::_hx_int(n22))) {
HXLINE(1746)																					array22 = false;
HXDLIN(1746)																					lua_pop(lua,2);
HXDLIN(1746)																					goto _hx_goto_280;
            																				}
HXDLIN(1746)																				lua_pop(lua,1);
            																			...
            																			_hx_goto_280:;
HXDLIN(1746)																			if (array22) {
HXLINE(1746)																				::cpp::VirtualArray arr22 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																				lua_pushnil(lua);
HXDLIN(1746)																				while((lua_next(lua,-2) != 0)){
HXLINE(1746)																					int index22 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																					arr22->set(index22,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																					lua_pop(lua,1);
            																				}
HXDLIN(1746)																				ret67 = arr22;
            																			}
            																			else {
HXLINE(1746)																				 hx::Anon obj22 = hx::Anon_obj::Create();
HXDLIN(1746)																				lua_pushnil(lua);
HXDLIN(1746)																				while((lua_next(lua,-2) != 0)){
HXLINE(1746)																					::String ret68;
HXDLIN(1746)																					if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																						ret68 = HX_("null",87,9e,0e,49);
            																					}
            																					else {
HXLINE(1746)																						ret68 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																					}
HXDLIN(1746)																					obj22->hx::Anon_obj::Add(ret68,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																					lua_pop(lua,1);
            																				}
HXDLIN(1746)																				ret67 = obj22;
            																			}
HXDLIN(1746)																			ret66 = ret67;
            																		}
            																		break;
            																		default:{
HXLINE(1746)																			ret66 = null();
...
HXDLIN(1746)																	ret62 = ::Std_obj::string(ret66);
            																}
HXDLIN(1746)																 ::Dynamic ret69 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-1))){
            																	case (int)0: {
HXLINE(1746)																		ret69 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret69 = (lua_toboolean(lua,-1) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret69 = lua_tonumber(lua,-1);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret69 = linc::lua::tostring(lua,-1);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array23 = true;
HXDLIN(1746)																		 ::Dynamic ret70 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array23 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_283;
            																			}
HXDLIN(1746)																			Float n23 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n23 != ::Std_obj::_hx_int(n23))) {
HXLINE(1746)																				array23 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_283;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_283:;
HXDLIN(1746)																		if (array23) {
HXLINE(1746)																			::cpp::VirtualArray arr23 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index23 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr23->set(index23,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret70 = arr23;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj23 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret71;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret71 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret71 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj23->hx::Anon_obj::Add(ret71,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret70 = obj23;
            																		}
HXDLIN(1746)																		ret69 = ret70;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret69 = null();
...
HXDLIN(1746)																obj20->hx::Anon_obj::Add(ret62,ret69);
HXDLIN(1746)																lua_pop(lua,1);
            															}
HXDLIN(1746)															ret58 = obj20;
            														}
HXDLIN(1746)														ret57 = ret58;
            													}
            													break;
            													default:{
HXLINE(1746)														ret57 = null();
...
HXDLIN(1746)												::String ret72 = ::Std_obj::string(ret57);
HXDLIN(1746)												 ::Dynamic ret73 = null();
HXDLIN(1746)												switch((int)(lua_type(lua,-1))){
            													case (int)0: {
HXLINE(1746)														ret73 = null();
            													}
            													break;
            													case (int)1: {
HXLINE(1746)														ret73 = (lua_toboolean(lua,-1) != 0);
            													}
            													break;
            													case (int)3: {
HXLINE(1746)														ret73 = lua_tonumber(lua,-1);
            													}
            													break;
            													case (int)4: {
HXLINE(1746)														ret73 = linc::lua::tostring(lua,-1);
            													}
            													break;
            													case (int)5: {
HXLINE(1746)														bool array24 = true;
HXDLIN(1746)														 ::Dynamic ret74 = null();
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																array24 = false;
HXDLIN(1746)																lua_pop(lua,2);
HXDLIN(1746)																goto _hx_goto_286;
            															}
HXDLIN(1746)															Float n24 = lua_tonumber(lua,-2);
HXDLIN(1746)															if ((n24 != ::Std_obj::_hx_int(n24))) {
HXLINE(1746)																array24 = false;
HXDLIN(1746)																lua_pop(lua,2);
HXDLIN(1746)																goto _hx_goto_286;
            															}
HXDLIN(1746)															lua_pop(lua,1);
            														...
            														_hx_goto_286:;
HXDLIN(1746)														if (array24) {
HXLINE(1746)															::cpp::VirtualArray arr24 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)															lua_pushnil(lua);
HXDLIN(1746)															while((lua_next(lua,-2) != 0)){
HXLINE(1746)																int index24 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																 ::Dynamic ret75 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-1))){
            																	case (int)0: {
HXLINE(1746)																		ret75 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret75 = (lua_toboolean(lua,-1) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret75 = lua_tonumber(lua,-1);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret75 = linc::lua::tostring(lua,-1);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array25 = true;
HXDLIN(1746)																		 ::Dynamic ret76 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array25 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_288;
            																			}
HXDLIN(1746)																			Float n25 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n25 != ::Std_obj::_hx_int(n25))) {
HXLINE(1746)																				array25 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_288;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_288:;
HXDLIN(1746)																		if (array25) {
HXLINE(1746)																			::cpp::VirtualArray arr25 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index25 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr25->set(index25,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret76 = arr25;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj24 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret77;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret77 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret77 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj24->hx::Anon_obj::Add(ret77,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret76 = obj24;
            																		}
HXDLIN(1746)																		ret75 = ret76;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret75 = null();
...
HXDLIN(1746)																arr24->set(index24,ret75);
HXDLIN(1746)																lua_pop(lua,1);
            															}
HXDLIN(1746)															ret74 = arr24;
            														}
            														else {
HXLINE(1746)															 hx::Anon obj25 = hx::Anon_obj::Create();
HXDLIN(1746)															lua_pushnil(lua);
HXDLIN(1746)															while((lua_next(lua,-2) != 0)){
HXLINE(1746)																::String ret78;
HXDLIN(1746)																 ::Dynamic ret79 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-2))){
            																	case (int)0: {
HXLINE(1746)																		ret79 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret79 = (lua_toboolean(lua,-2) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret79 = lua_tonumber(lua,-2);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret79 = linc::lua::tostring(lua,-2);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array26 = true;
HXDLIN(1746)																		 ::Dynamic ret80 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array26 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_292;
            																			}
HXDLIN(1746)																			Float n26 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n26 != ::Std_obj::_hx_int(n26))) {
HXLINE(1746)																				array26 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_292;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_292:;
HXDLIN(1746)																		if (array26) {
HXLINE(1746)																			::cpp::VirtualArray arr26 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index26 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr26->set(index26,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret80 = arr26;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj26 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret81;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret81 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret81 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj26->hx::Anon_obj::Add(ret81,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret80 = obj26;
            																		}
HXDLIN(1746)																		ret79 = ret80;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret79 = null();
...
HXDLIN(1746)																if (::hx::IsNull( ret79 )) {
HXLINE(1746)																	ret78 = HX_("null",87,9e,0e,49);
            																}
            																else {
HXLINE(1746)																	 ::Dynamic ret82 = null();
HXDLIN(1746)																	switch((int)(lua_type(lua,-2))){
            																		case (int)0: {
HXLINE(1746)																			ret82 = null();
            																		}
            																		break;
            																		case (int)1: {
HXLINE(1746)																			ret82 = (lua_toboolean(lua,-2) != 0);
            																		}
            																		break;
            																		case (int)3: {
HXLINE(1746)																			ret82 = lua_tonumber(lua,-2);
            																		}
            																		break;
            																		case (int)4: {
HXLINE(1746)																			ret82 = linc::lua::tostring(lua,-2);
            																		}
            																		break;
            																		case (int)5: {
HXLINE(1746)																			bool array27 = true;
HXDLIN(1746)																			 ::Dynamic ret83 = null();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																					array27 = false;
HXDLIN(1746)																					lua_pop(lua,2);
HXDLIN(1746)																					goto _hx_goto_295;
            																				}
HXDLIN(1746)																				Float n27 = lua_tonumber(lua,-2);
HXDLIN(1746)																				if ((n27 != ::Std_obj::_hx_int(n27))) {
HXLINE(1746)																					array27 = false;
HXDLIN(1746)																					lua_pop(lua,2);
HXDLIN(1746)																					goto _hx_goto_295;
            																				}
HXDLIN(1746)																				lua_pop(lua,1);
            																			...
            																			_hx_goto_295:;
HXDLIN(1746)																			if (array27) {
HXLINE(1746)																				::cpp::VirtualArray arr27 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																				lua_pushnil(lua);
HXDLIN(1746)																				while((lua_next(lua,-2) != 0)){
HXLINE(1746)																					int index27 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																					arr27->set(index27,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																					lua_pop(lua,1);
            																				}
HXDLIN(1746)																				ret83 = arr27;
            																			}
            																			else {
HXLINE(1746)																				 hx::Anon obj27 = hx::Anon_obj::Create();
HXDLIN(1746)																				lua_pushnil(lua);
HXDLIN(1746)																				while((lua_next(lua,-2) != 0)){
HXLINE(1746)																					::String ret84;
HXDLIN(1746)																					if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																						ret84 = HX_("null",87,9e,0e,49);
            																					}
            																					else {
HXLINE(1746)																						ret84 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																					}
HXDLIN(1746)																					obj27->hx::Anon_obj::Add(ret84,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																					lua_pop(lua,1);
            																				}
HXDLIN(1746)																				ret83 = obj27;
            																			}
HXDLIN(1746)																			ret82 = ret83;
            																		}
            																		break;
            																		default:{
HXLINE(1746)																			ret82 = null();
...
HXDLIN(1746)																	ret78 = ::Std_obj::string(ret82);
            																}
HXDLIN(1746)																 ::Dynamic ret85 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-1))){
            																	case (int)0: {
HXLINE(1746)																		ret85 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret85 = (lua_toboolean(lua,-1) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret85 = lua_tonumber(lua,-1);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret85 = linc::lua::tostring(lua,-1);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array28 = true;
HXDLIN(1746)																		 ::Dynamic ret86 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array28 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_298;
            																			}
HXDLIN(1746)																			Float n28 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n28 != ::Std_obj::_hx_int(n28))) {
HXLINE(1746)																				array28 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_298;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_298:;
HXDLIN(1746)																		if (array28) {
HXLINE(1746)																			::cpp::VirtualArray arr28 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index28 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr28->set(index28,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret86 = arr28;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj28 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret87;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret87 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret87 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj28->hx::Anon_obj::Add(ret87,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret86 = obj28;
            																		}
HXDLIN(1746)																		ret85 = ret86;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret85 = null();
...
HXDLIN(1746)																obj25->hx::Anon_obj::Add(ret78,ret85);
HXDLIN(1746)																lua_pop(lua,1);
            															}
HXDLIN(1746)															ret74 = obj25;
            														}
HXDLIN(1746)														ret73 = ret74;
            													}
            													break;
            													default:{
HXLINE(1746)														ret73 = null();
...
HXDLIN(1746)												obj111->hx::Anon_obj::Add(ret72,ret73);
HXDLIN(1746)												lua_pop(lua,1);
            											}
HXDLIN(1746)											ret311 = obj111;
            										}
...
HXDLIN(1746)							ret29 = ::Std_obj::string(ret301);
            						}
HXDLIN(1746)						 ::Dynamic ret88 = null();
HXDLIN(1746)						switch((int)(lua_type(lua,-1))){
            							case (int)0: {
HXLINE(1746)								ret88 = null();
            							}
            							break;
            							case (int)1: {
HXLINE(1746)								ret88 = (lua_toboolean(lua,-1) != 0);
            							}
            							break;
            							case (int)3: {
HXLINE(1746)								ret88 = lua_tonumber(lua,-1);
            							}
            							break;
            							case (int)4: {
HXLINE(1746)								ret88 = linc::lua::tostring(lua,-1);
            							}
            							break;
            							case (int)5: {
HXLINE(1746)								bool array29 = true;
HXDLIN(1746)								 ::Dynamic ret89 = null();
HXDLIN(1746)								lua_pushnil(lua);
HXDLIN(1746)								while((lua_next(lua,-2) != 0)){
HXLINE(1746)									if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)										array29 = false;
HXDLIN(1746)										lua_pop(lua,2);
HXDLIN(1746)										goto _hx_goto_301;
            									}
HXDLIN(1746)									Float n29 = lua_tonumber(lua,-2);
HXDLIN(1746)									if ((n29 != ::Std_obj::_hx_int(n29))) {
HXLINE(1746)										array29 = false;
HXDLIN(1746)										lua_pop(lua,2);
HXDLIN(1746)										goto _hx_goto_301;
            									}
HXDLIN(1746)									lua_pop(lua,1);
            								...
            								_hx_goto_301:;
HXDLIN(1746)								if (array29) {
HXLINE(1746)									::cpp::VirtualArray arr29 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)									lua_pushnil(lua);
HXDLIN(1746)									while((lua_next(lua,-2) != 0)){
HXLINE(1746)										int index29 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)										 ::Dynamic ret90 = null();
HXDLIN(1746)										switch((int)(lua_type(lua,-1))){
            											case (int)0: {
HXLINE(1746)												ret90 = null();
            											}
            											break;
            											case (int)1: {
HXLINE(1746)												ret90 = (lua_toboolean(lua,-1) != 0);
            											}
            											break;
            											case (int)3: {
HXLINE(1746)												ret90 = lua_tonumber(lua,-1);
            											}
            											break;
            											case (int)4: {
HXLINE(1746)												ret90 = linc::lua::tostring(lua,-1);
            											}
            											break;
            											case (int)5: {
HXLINE(1746)												bool array30 = true;
HXDLIN(1746)												 ::Dynamic ret91 = null();
HXDLIN(1746)												lua_pushnil(lua);
HXDLIN(1746)												while((lua_next(lua,-2) != 0)){
HXLINE(1746)													if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)														array30 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_303;
            													}
HXDLIN(1746)													Float n30 = lua_tonumber(lua,-2);
HXDLIN(1746)													if ((n30 != ::Std_obj::_hx_int(n30))) {
HXLINE(1746)														array30 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_303;
            													}
HXDLIN(1746)													lua_pop(lua,1);
            												...
            												_hx_goto_303:;
HXDLIN(1746)												if (array30) {
HXLINE(1746)													::cpp::VirtualArray arr30 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														int index30 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)														arr30->set(index30,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret91 = arr30;
            												}
            												else {
HXLINE(1746)													 hx::Anon obj29 = hx::Anon_obj::Create();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														::String ret92;
HXDLIN(1746)														if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)															ret92 = HX_("null",87,9e,0e,49);
            														}
            														else {
HXLINE(1746)															ret92 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            														}
HXDLIN(1746)														obj29->hx::Anon_obj::Add(ret92,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret91 = obj29;
            												}
HXDLIN(1746)												ret90 = ret91;
            											}
            											break;
            											default:{
HXLINE(1746)												ret90 = null();
...
HXDLIN(1746)										arr29->set(index29,ret90);
HXDLIN(1746)										lua_pop(lua,1);
            									}
HXDLIN(1746)									ret89 = arr29;
            								}
            								else {
HXLINE(1746)									 hx::Anon obj30 = hx::Anon_obj::Create();
HXDLIN(1746)									lua_pushnil(lua);
HXDLIN(1746)									while((lua_next(lua,-2) != 0)){
HXLINE(1746)										::String ret93;
HXDLIN(1746)										 ::Dynamic ret94 = null();
HXDLIN(1746)										switch((int)(lua_type(lua,-2))){
            											case (int)0: {
HXLINE(1746)												ret94 = null();
            											}
            											break;
            											case (int)1: {
HXLINE(1746)												ret94 = (lua_toboolean(lua,-2) != 0);
            											}
            											break;
            											case (int)3: {
HXLINE(1746)												ret94 = lua_tonumber(lua,-2);
            											}
            											break;
            											case (int)4: {
HXLINE(1746)												ret94 = linc::lua::tostring(lua,-2);
            											}
            											break;
            											case (int)5: {
HXLINE(1746)												bool array31 = true;
HXDLIN(1746)												 ::Dynamic ret95 = null();
HXDLIN(1746)												lua_pushnil(lua);
HXDLIN(1746)												while((lua_next(lua,-2) != 0)){
HXLINE(1746)													if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)														array31 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_307;
            													}
HXDLIN(1746)													Float n31 = lua_tonumber(lua,-2);
HXDLIN(1746)													if ((n31 != ::Std_obj::_hx_int(n31))) {
HXLINE(1746)														array31 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_307;
            													}
HXDLIN(1746)													lua_pop(lua,1);
            												...
            												_hx_goto_307:;
HXDLIN(1746)												if (array31) {
HXLINE(1746)													::cpp::VirtualArray arr31 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														int index31 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)														arr31->set(index31,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret95 = arr31;
            												}
            												else {
HXLINE(1746)													 hx::Anon obj31 = hx::Anon_obj::Create();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														::String ret96;
HXDLIN(1746)														if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)															ret96 = HX_("null",87,9e,0e,49);
            														}
            														else {
HXLINE(1746)															ret96 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            														}
HXDLIN(1746)														obj31->hx::Anon_obj::Add(ret96,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret95 = obj31;
            												}
HXDLIN(1746)												ret94 = ret95;
            											}
            											break;
            											default:{
HXLINE(1746)												ret94 = null();
...
HXDLIN(1746)										if (::hx::IsNull( ret94 )) {
HXLINE(1746)											ret93 = HX_("null",87,9e,0e,49);
            										}
            										else {
HXLINE(1746)											 ::Dynamic ret97 = null();
HXDLIN(1746)											switch((int)(lua_type(lua,-2))){
            												case (int)0: {
HXLINE(1746)													ret97 = null();
            												}
            												break;
            												case (int)1: {
HXLINE(1746)													ret97 = (lua_toboolean(lua,-2) != 0);
            												}
            												break;
            												case (int)3: {
HXLINE(1746)													ret97 = lua_tonumber(lua,-2);
            												}
            												break;
            												case (int)4: {
HXLINE(1746)													ret97 = linc::lua::tostring(lua,-2);
            												}
            												break;
            												case (int)5: {
HXLINE(1746)													bool array32 = true;
HXDLIN(1746)													 ::Dynamic ret98 = null();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)															array32 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_310;
            														}
HXDLIN(1746)														Float n32 = lua_tonumber(lua,-2);
HXDLIN(1746)														if ((n32 != ::Std_obj::_hx_int(n32))) {
HXLINE(1746)															array32 = false;
HXDLIN(1746)															lua_pop(lua,2);
HXDLIN(1746)															goto _hx_goto_310;
            														}
HXDLIN(1746)														lua_pop(lua,1);
            													...
            													_hx_goto_310:;
HXDLIN(1746)													if (array32) {
HXLINE(1746)														::cpp::VirtualArray arr32 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															int index32 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)															 ::Dynamic ret99 = null();
HXDLIN(1746)															switch((int)(lua_type(lua,-1))){
            																case (int)0: {
HXLINE(1746)																	ret99 = null();
            																}
            																break;
            																case (int)1: {
HXLINE(1746)																	ret99 = (lua_toboolean(lua,-1) != 0);
            																}
            																break;
            																case (int)3: {
HXLINE(1746)																	ret99 = lua_tonumber(lua,-1);
            																}
            																break;
            																case (int)4: {
HXLINE(1746)																	ret99 = linc::lua::tostring(lua,-1);
            																}
            																break;
            																case (int)5: {
HXLINE(1746)																	bool array33 = true;
HXDLIN(1746)																	 ::Dynamic ret100 = null();
HXDLIN(1746)																	lua_pushnil(lua);
HXDLIN(1746)																	while((lua_next(lua,-2) != 0)){
HXLINE(1746)																		if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																			array33 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_312;
            																		}
HXDLIN(1746)																		Float n33 = lua_tonumber(lua,-2);
HXDLIN(1746)																		if ((n33 != ::Std_obj::_hx_int(n33))) {
HXLINE(1746)																			array33 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_312;
            																		}
HXDLIN(1746)																		lua_pop(lua,1);
            																	...
            																	_hx_goto_312:;
HXDLIN(1746)																	if (array33) {
HXLINE(1746)																		::cpp::VirtualArray arr33 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			int index33 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																			arr33->set(index33,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret100 = arr33;
            																	}
            																	else {
HXLINE(1746)																		 hx::Anon obj32 = hx::Anon_obj::Create();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			::String ret101;
HXDLIN(1746)																			if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																				ret101 = HX_("null",87,9e,0e,49);
            																			}
            																			else {
HXLINE(1746)																				ret101 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																			}
HXDLIN(1746)																			obj32->hx::Anon_obj::Add(ret101,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret100 = obj32;
            																	}
HXDLIN(1746)																	ret99 = ret100;
            																}
            																break;
            																default:{
HXLINE(1746)																	ret99 = null();
...
HXDLIN(1746)															arr32->set(index32,ret99);
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret98 = arr32;
            													}
            													else {
HXLINE(1746)														 hx::Anon obj33 = hx::Anon_obj::Create();
HXDLIN(1746)														lua_pushnil(lua);
HXDLIN(1746)														while((lua_next(lua,-2) != 0)){
HXLINE(1746)															::String ret102;
HXDLIN(1746)															 ::Dynamic ret103 = null();
HXDLIN(1746)															switch((int)(lua_type(lua,-2))){
            																case (int)0: {
HXLINE(1746)																	ret103 = null();
            																}
            																break;
            																case (int)1: {
HXLINE(1746)																	ret103 = (lua_toboolean(lua,-2) != 0);
            																}
            																break;
            																case (int)3: {
HXLINE(1746)																	ret103 = lua_tonumber(lua,-2);
            																}
            																break;
            																case (int)4: {
HXLINE(1746)																	ret103 = linc::lua::tostring(lua,-2);
            																}
            																break;
            																case (int)5: {
HXLINE(1746)																	bool array34 = true;
HXDLIN(1746)																	 ::Dynamic ret104 = null();
HXDLIN(1746)																	lua_pushnil(lua);
HXDLIN(1746)																	while((lua_next(lua,-2) != 0)){
HXLINE(1746)																		if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																			array34 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_316;
            																		}
HXDLIN(1746)																		Float n34 = lua_tonumber(lua,-2);
HXDLIN(1746)																		if ((n34 != ::Std_obj::_hx_int(n34))) {
HXLINE(1746)																			array34 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_316;
            																		}
HXDLIN(1746)																		lua_pop(lua,1);
            																	...
            																	_hx_goto_316:;
HXDLIN(1746)																	if (array34) {
HXLINE(1746)																		::cpp::VirtualArray arr34 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			int index34 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																			arr34->set(index34,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret104 = arr34;
            																	}
            																	else {
HXLINE(1746)																		 hx::Anon obj34 = hx::Anon_obj::Create();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			::String ret105;
HXDLIN(1746)																			if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																				ret105 = HX_("null",87,9e,0e,49);
            																			}
            																			else {
HXLINE(1746)																				ret105 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																			}
HXDLIN(1746)																			obj34->hx::Anon_obj::Add(ret105,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret104 = obj34;
            																	}
HXDLIN(1746)																	ret103 = ret104;
            																}
            																break;
            																default:{
HXLINE(1746)																	ret103 = null();
...
HXDLIN(1746)															if (::hx::IsNull( ret103 )) {
HXLINE(1746)																ret102 = HX_("null",87,9e,0e,49);
            															}
            															else {
HXLINE(1746)																 ::Dynamic ret106 = null();
HXDLIN(1746)																switch((int)(lua_type(lua,-2))){
            																	case (int)0: {
HXLINE(1746)																		ret106 = null();
            																	}
            																	break;
            																	case (int)1: {
HXLINE(1746)																		ret106 = (lua_toboolean(lua,-2) != 0);
            																	}
            																	break;
            																	case (int)3: {
HXLINE(1746)																		ret106 = lua_tonumber(lua,-2);
            																	}
            																	break;
            																	case (int)4: {
HXLINE(1746)																		ret106 = linc::lua::tostring(lua,-2);
            																	}
            																	break;
            																	case (int)5: {
HXLINE(1746)																		bool array35 = true;
HXDLIN(1746)																		 ::Dynamic ret107 = null();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																				array35 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_319;
            																			}
HXDLIN(1746)																			Float n35 = lua_tonumber(lua,-2);
HXDLIN(1746)																			if ((n35 != ::Std_obj::_hx_int(n35))) {
HXLINE(1746)																				array35 = false;
HXDLIN(1746)																				lua_pop(lua,2);
HXDLIN(1746)																				goto _hx_goto_319;
            																			}
HXDLIN(1746)																			lua_pop(lua,1);
            																		...
            																		_hx_goto_319:;
HXDLIN(1746)																		if (array35) {
HXLINE(1746)																			::cpp::VirtualArray arr35 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				int index35 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																				arr35->set(index35,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret107 = arr35;
            																		}
            																		else {
HXLINE(1746)																			 hx::Anon obj35 = hx::Anon_obj::Create();
HXDLIN(1746)																			lua_pushnil(lua);
HXDLIN(1746)																			while((lua_next(lua,-2) != 0)){
HXLINE(1746)																				::String ret108;
HXDLIN(1746)																				if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																					ret108 = HX_("null",87,9e,0e,49);
            																				}
            																				else {
HXLINE(1746)																					ret108 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																				}
HXDLIN(1746)																				obj35->hx::Anon_obj::Add(ret108,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																				lua_pop(lua,1);
            																			}
HXDLIN(1746)																			ret107 = obj35;
            																		}
HXDLIN(1746)																		ret106 = ret107;
            																	}
            																	break;
            																	default:{
HXLINE(1746)																		ret106 = null();
...
HXDLIN(1746)																ret102 = ::Std_obj::string(ret106);
            															}
HXDLIN(1746)															 ::Dynamic ret109 = null();
HXDLIN(1746)															switch((int)(lua_type(lua,-1))){
            																case (int)0: {
HXLINE(1746)																	ret109 = null();
            																}
            																break;
            																case (int)1: {
HXLINE(1746)																	ret109 = (lua_toboolean(lua,-1) != 0);
            																}
            																break;
            																case (int)3: {
HXLINE(1746)																	ret109 = lua_tonumber(lua,-1);
            																}
            																break;
            																case (int)4: {
HXLINE(1746)																	ret109 = linc::lua::tostring(lua,-1);
            																}
            																break;
            																case (int)5: {
HXLINE(1746)																	bool array36 = true;
HXDLIN(1746)																	 ::Dynamic ret110 = null();
HXDLIN(1746)																	lua_pushnil(lua);
HXDLIN(1746)																	while((lua_next(lua,-2) != 0)){
HXLINE(1746)																		if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)																			array36 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_322;
            																		}
HXDLIN(1746)																		Float n36 = lua_tonumber(lua,-2);
HXDLIN(1746)																		if ((n36 != ::Std_obj::_hx_int(n36))) {
HXLINE(1746)																			array36 = false;
HXDLIN(1746)																			lua_pop(lua,2);
HXDLIN(1746)																			goto _hx_goto_322;
            																		}
HXDLIN(1746)																		lua_pop(lua,1);
            																	...
            																	_hx_goto_322:;
HXDLIN(1746)																	if (array36) {
HXLINE(1746)																		::cpp::VirtualArray arr36 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			int index36 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)																			arr36->set(index36,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret110 = arr36;
            																	}
            																	else {
HXLINE(1746)																		 hx::Anon obj36 = hx::Anon_obj::Create();
HXDLIN(1746)																		lua_pushnil(lua);
HXDLIN(1746)																		while((lua_next(lua,-2) != 0)){
HXLINE(1746)																			::String ret111;
HXDLIN(1746)																			if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)																				ret111 = HX_("null",87,9e,0e,49);
            																			}
            																			else {
HXLINE(1746)																				ret111 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            																			}
HXDLIN(1746)																			obj36->hx::Anon_obj::Add(ret111,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)																			lua_pop(lua,1);
            																		}
HXDLIN(1746)																		ret110 = obj36;
            																	}
HXDLIN(1746)																	ret109 = ret110;
            																}
            																break;
            																default:{
HXLINE(1746)																	ret109 = null();
...
HXDLIN(1746)															obj33->hx::Anon_obj::Add(ret102,ret109);
HXDLIN(1746)															lua_pop(lua,1);
            														}
HXDLIN(1746)														ret98 = obj33;
            													}
HXDLIN(1746)													ret97 = ret98;
            												}
            												break;
            												default:{
HXLINE(1746)													ret97 = null();
...
HXDLIN(1746)											ret93 = ::Std_obj::string(ret97);
            										}
HXDLIN(1746)										 ::Dynamic ret112 = null();
HXDLIN(1746)										switch((int)(lua_type(lua,-1))){
            											case (int)0: {
HXLINE(1746)												ret112 = null();
            											}
            											break;
            											case (int)1: {
HXLINE(1746)												ret112 = (lua_toboolean(lua,-1) != 0);
            											}
            											break;
            											case (int)3: {
HXLINE(1746)												ret112 = lua_tonumber(lua,-1);
            											}
            											break;
            											case (int)4: {
HXLINE(1746)												ret112 = linc::lua::tostring(lua,-1);
            											}
            											break;
            											case (int)5: {
HXLINE(1746)												bool array37 = true;
HXDLIN(1746)												 ::Dynamic ret113 = null();
HXDLIN(1746)												lua_pushnil(lua);
HXDLIN(1746)												while((lua_next(lua,-2) != 0)){
HXLINE(1746)													if ((lua_type(lua,-2) != 3)) {
HXLINE(1746)														array37 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_325;
            													}
HXDLIN(1746)													Float n37 = lua_tonumber(lua,-2);
HXDLIN(1746)													if ((n37 != ::Std_obj::_hx_int(n37))) {
HXLINE(1746)														array37 = false;
HXDLIN(1746)														lua_pop(lua,2);
HXDLIN(1746)														goto _hx_goto_325;
            													}
HXDLIN(1746)													lua_pop(lua,1);
            												...
            												_hx_goto_325:;
HXDLIN(1746)												if (array37) {
HXLINE(1746)													::cpp::VirtualArray arr37 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														int index37 = (lua_tointeger(lua,-2) - 1);
HXDLIN(1746)														arr37->set(index37,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret113 = arr37;
            												}
            												else {
HXLINE(1746)													 hx::Anon obj37 = hx::Anon_obj::Create();
HXDLIN(1746)													lua_pushnil(lua);
HXDLIN(1746)													while((lua_next(lua,-2) != 0)){
HXLINE(1746)														::String ret114;
HXDLIN(1746)														if (::hx::IsNull( ::llua::Convert_obj::fromLua(lua,-2) )) {
HXLINE(1746)															ret114 = HX_("null",87,9e,0e,49);
            														}
            														else {
HXLINE(1746)															ret114 = ::Std_obj::string(::llua::Convert_obj::fromLua(lua,-2));
            														}
HXDLIN(1746)														obj37->hx::Anon_obj::Add(ret114,::llua::Convert_obj::fromLua(lua,-1));
HXDLIN(1746)														lua_pop(lua,1);
            													}
HXDLIN(1746)													ret113 = obj37;
            												}
HXDLIN(1746)												ret112 = ret113;
            											}
            											break;
            											default:{
HXLINE(1746)												ret112 = null();
...
HXDLIN(1746)										obj30->hx::Anon_obj::Add(ret93,ret112);
HXDLIN(1746)										lua_pop(lua,1);
            									}
HXDLIN(1746)									ret89 = obj30;
            								}
HXDLIN(1746)								ret88 = ret89;
            							}
            							break;
            							default:{
HXLINE(1746)								ret88 = null();
...
HXDLIN(1746)						obj9->hx::Anon_obj::Add(ret29,ret88);
HXDLIN(1746)						lua_pop(lua,1);
            					}
HXDLIN(1746)					ret1 = obj9;
            				}
HXDLIN(1746)				ret = ret1;
            			}
            			break;
            			default:{
HXLINE(1746)				ret = null();
