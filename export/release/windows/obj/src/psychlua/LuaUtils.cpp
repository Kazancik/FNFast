...
HXDLIN( 348)			 ::flixel::graphics::FlxGraphic image1 = ::backend::Paths_obj::image(image,parentFolder2,null());
HXDLIN( 348)			::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + image) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder2,null());
HXDLIN( 348)			 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp2;
HXDLIN( 348)			bool _hx_tmp3;
HXDLIN( 348)			if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE( 348)				_hx_tmp3 = ::lime::utils::Assets_obj::exists(xml,null());
            			}
            			else {
HXLINE( 348)				_hx_tmp3 = true;
            			}
HXDLIN( 348)			if (_hx_tmp3) {
HXLINE( 348)				_hx_tmp2 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image1,::lime::utils::Assets_obj::getText(xml));
            			}
            			else {
HXLINE( 348)				::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + image) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN( 348)				_hx_tmp2 = null();
            			}
HXDLIN( 348)			spr->set_frames(_hx_tmp2);
