...
void SaveVariables_obj::__construct( ::Dynamic downScroll, ::Dynamic middleScroll, ::Dynamic opponentStrums, ::Dynamic showFPS, ::Dynamic autoPause, ::Dynamic antialiasing,::String noteSkin,::String splashSkin, ::Dynamic splashAlpha, ::Dynamic lowQuality, ::Dynamic shaders,::String authToken,::String username, ::Dynamic flashing, ::Dynamic cacheOnGPU, ::Dynamic framerate, ::Dynamic camZooms, ::Dynamic hideHud, ::Dynamic noteOffset,::Array< ::Dynamic> arrowRGB,::Array< ::Dynamic> arrowRGBPixel, ::Dynamic ghostTapping,::String timeBarType, ::Dynamic scoreZoom, ::Dynamic noReset, ::Dynamic healthBarAlpha, ::Dynamic hitsoundVolume,::String pauseMusic, ::Dynamic checkForUpdates, ::Dynamic comboStacking, ::Dynamic seenTutorial, ::haxe::ds::StringMap gameplaySettings,::Array< int > comboOffset, ::Dynamic ratingOffset, ::Dynamic sickWindow, ::Dynamic goodWindow, ::Dynamic badWindow, ::Dynamic safeFrames, ::Dynamic guitarHeroSustains, ::Dynamic discordRPC, ::Dynamic loadingScreen,::String language){
            	HX_GC_STACKFRAME(&_hx_pos_c0fe648b9977b22a_10_new)
HXLINE(  89)		this->language = HX_("en-US",02,7f,50,70);
HXLINE(  88)		this->loadingScreen = true;
HXLINE(  87)		this->discordRPC = true;
HXLINE(  86)		this->guitarHeroSustains = true;
HXLINE(  85)		this->safeFrames = ((Float)10.0);
HXLINE(  84)		this->badWindow = ((Float)135.0);
HXLINE(  83)		this->goodWindow = ((Float)90.0);
HXLINE(  82)		this->sickWindow = ((Float)45.0);
HXLINE(  81)		this->ratingOffset = 0;
HXLINE(  80)		this->comboOffset = ::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_1,4);
HXLINE(  58)		 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN(  58)		_g->set(HX_("scrollspeed",5a,70,19,38),((Float)1.0));
HXDLIN(  58)		_g->set(HX_("scrolltype",47,55,ef,1f),HX_("multiplicative",96,7a,3f,fa));
HXDLIN(  58)		_g->set(HX_("songspeed",92,6f,b6,1d),((Float)1.0));
HXDLIN(  58)		_g->set(HX_("healthgain",1b,97,1b,16),((Float)1.0));
HXDLIN(  58)		_g->set(HX_("healthloss",7f,50,74,19),((Float)1.0));
HXDLIN(  58)		_g->set(HX_("instakill",f9,72,23,49),false);
HXDLIN(  58)		_g->set(HX_("practice",bb,00,e7,a0),false);
HXDLIN(  58)		_g->set(HX_("botplay",7b,fb,a9,61),false);
HXDLIN(  58)		_g->set(HX_("opponentplay",11,7a,4c,86),false);
HXDLIN(  58)		this->gameplaySettings = _g;
HXLINE(  56)		this->seenTutorial = false;
HXLINE(  55)		this->comboStacking = true;
HXLINE(  54)		this->checkForUpdates = true;
HXLINE(  53)		this->pauseMusic = HX_("Tea Time",9d,d4,cb,99);
HXLINE(  52)		this->hitsoundVolume = ((Float)0);
HXLINE(  51)		this->healthBarAlpha = ((Float)1);
HXLINE(  50)		this->noReset = false;
HXLINE(  49)		this->scoreZoom = true;
HXLINE(  48)		this->timeBarType = HX_("Time Left",fa,08,f2,62);
HXLINE(  47)		this->ghostTapping = true;
HXLINE(  41)		this->arrowRGBPixel = ::Array_obj< ::Dynamic>::__new(4)->init(0,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_2,3))->init(1,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_3,3))->init(2,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_4,3))->init(3,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_5,3));
HXLINE(  36)		this->arrowRGB = ::Array_obj< ::Dynamic>::__new(4)->init(0,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_6,3))->init(1,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_7,3))->init(2,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_8,3))->init(3,::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_9,3));
HXLINE(  35)		this->noteOffset = 0;
HXLINE(  34)		this->hideHud = false;
HXLINE(  33)		this->camZooms = true;
HXLINE(  32)		this->framerate = 60;
HXLINE(  31)		this->cacheOnGPU = false;
HXLINE(  30)		this->flashing = true;
HXLINE(  27)		this->username = HX_("",00,00,00,00);
HXLINE(  26)		this->authToken = HX_("",00,00,00,00);
...
HXDLIN(  10)		if (::hx::IsNotNull( authToken )) {
HXDLIN(  10)			this->authToken = authToken;
            		}
HXDLIN(  10)		if (::hx::IsNotNull( username )) {
HXDLIN(  10)			this->username = username;
            		}
...
HXDLIN(  10)		if (::hx::IsNotNull( seenTutorial )) {
HXDLIN(  10)			this->seenTutorial = ( (bool)(seenTutorial) );
            		}
...
::hx::ObjectPtr< SaveVariables_obj > SaveVariables_obj::__new( ::Dynamic downScroll, ::Dynamic middleScroll, ::Dynamic opponentStrums, ::Dynamic showFPS, ::Dynamic autoPause, ::Dynamic antialiasing,::String noteSkin,::String splashSkin, ::Dynamic splashAlpha, ::Dynamic lowQuality, ::Dynamic shaders,::String authToken,::String username, ::Dynamic flashing, ::Dynamic cacheOnGPU, ::Dynamic framerate, ::Dynamic camZooms, ::Dynamic hideHud, ::Dynamic noteOffset,::Array< ::Dynamic> arrowRGB,::Array< ::Dynamic> arrowRGBPixel, ::Dynamic ghostTapping,::String timeBarType, ::Dynamic scoreZoom, ::Dynamic noReset, ::Dynamic healthBarAlpha, ::Dynamic hitsoundVolume,::String pauseMusic, ::Dynamic checkForUpdates, ::Dynamic comboStacking, ::Dynamic seenTutorial, ::haxe::ds::StringMap gameplaySettings,::Array< int > comboOffset, ::Dynamic ratingOffset, ::Dynamic sickWindow, ::Dynamic goodWindow, ::Dynamic badWindow, ::Dynamic safeFrames, ::Dynamic guitarHeroSustains, ::Dynamic discordRPC, ::Dynamic loadingScreen,::String language) {
	...
	__this->__construct(downScroll,middleScroll,opponentStrums,showFPS,autoPause,antialiasing,noteSkin,splashSkin,splashAlpha,lowQuality,shaders,authToken,username,flashing,cacheOnGPU,framerate,camZooms,hideHud,noteOffset,arrowRGB,arrowRGBPixel,ghostTapping,timeBarType,scoreZoom,noReset,healthBarAlpha,hitsoundVolume,pauseMusic,checkForUpdates,comboStacking,seenTutorial,gameplaySettings,comboOffset,ratingOffset,sickWindow,goodWindow,badWindow,safeFrames,guitarHeroSustains,discordRPC,loadingScreen,language);
	return __this;
}
...
void SaveVariables_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(authToken,"authToken");
	...
	HX_MARK_MEMBER_NAME(seenTutorial,"seenTutorial");
...
void SaveVariables_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(authToken,"authToken");
	...
	HX_VISIT_MEMBER_NAME(seenTutorial,"seenTutorial");
...
::hx::Val SaveVariables_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"authToken") ) { return ::hx::Val( authToken ); }
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"seenTutorial") ) { return ::hx::Val( seenTutorial ); }
...
::hx::Val SaveVariables_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"authToken") ) { authToken=inValue.Cast< ::String >(); return inValue; }
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"seenTutorial") ) { seenTutorial=inValue.Cast< bool >(); return inValue; }
...
void SaveVariables_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("authToken",71,3a,b7,25));
	...
	outFields->push(HX_("seenTutorial",39,44,42,3e));
...
static ::hx::StorageInfo SaveVariables_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(SaveVariables_obj,authToken),HX_("authToken",71,3a,b7,25)},
	{::hx::fsString,(int)offsetof(SaveVariables_obj,username),HX_("username",16,86,eb,20)},
	...
	{::hx::fsBool,(int)offsetof(SaveVariables_obj,seenTutorial),HX_("seenTutorial",39,44,42,3e)},
