...
HX_LOCAL_STACK_FRAME(_hx_pos_db09ff2b98ac40f1_70_convert,"backend.Song","convert",0x35f02114,"backend.Song.convert","backend/Song.hx",70,0x16217dae)
HX_LOCAL_STACK_FRAME(_hx_pos_db09ff2b98ac40f1_127_loadFromJson,"backend.Song","loadFromJson",0xc81ee237,"backend.Song.loadFromJson","backend/Song.hx",127,0x16217dae)
...
HXLINE(  67)		this->format = HX_("psych_v1",bf,0a,17,5b);
HXLINE(  66)		this->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  65)		this->player2 = HX_("dad",47,36,4c,00);
HXLINE(  64)		this->player1 = HX_("bf",c4,55,00,00);
HXLINE(  62)		this->speed = ((Float)1);
HXLINE(  61)		this->disableNoteRGB = false;
...
void Song_obj::convert( ::Dynamic songJson){
            	HX_STACKFRAME(&_hx_pos_db09ff2b98ac40f1_70_convert)
HXLINE(  71)		if (::hx::IsNull( songJson->__Field(HX_("gfVersion",b9,c6,7d,f3),::hx::paccDynamic) )) {
HXLINE(  73)			songJson->__SetField(HX_("gfVersion",b9,c6,7d,f3),songJson->__Field(HX_("player3",b2,09,15,8a),::hx::paccDynamic),::hx::paccDynamic);
HXLINE(  74)			if (::Reflect_obj::hasField(songJson,HX_("player3",b2,09,15,8a))) {
HXLINE(  74)				::Reflect_obj::deleteField(songJson,HX_("player3",b2,09,15,8a));
            			}
            		}
HXLINE(  77)		if (::hx::IsNull( songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic) )) {
HXLINE(  79)			songJson->__SetField(HX_("events",19,4f,6a,96),::cpp::VirtualArray_obj::__new(0),::hx::paccDynamic);
HXLINE(  80)			{
HXLINE(  80)				int _g = 0;
HXDLIN(  80)				int _g1 = ( (int)( ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic)) );
HXDLIN(  80)				while((_g < _g1)){
HXLINE(  80)					_g = (_g + 1);
HXDLIN(  80)					int secNum = (_g - 1);
HXLINE(  82)					 ::Dynamic sec =  ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(secNum);
HXLINE(  84)					int i = 0;
HXLINE(  85)					::cpp::VirtualArray notes = ( (::cpp::VirtualArray)(sec->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) );
HXLINE(  86)					int len = notes->get_length();
HXLINE(  87)					while((i < len)){
HXLINE(  89)						::cpp::VirtualArray note = ( (::cpp::VirtualArray)(notes->__get(i)) );
HXLINE(  90)						if (::hx::IsLess( note->__get(1),0 )) {
HXLINE(  92)							 ::Dynamic(songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic))->__Field(HX_("push",da,11,61,4a),::hx::paccDynamic)(::Array_obj< ::Dynamic>::__new(2)->init(0,note->__get(0))->init(1,::Array_obj< ::Dynamic>::__new(1)->init(0,::cpp::VirtualArray_obj::__new(3)->init(0,note->__get(2))->init(1,note->__get(3))->init(2,note->__get(4)))));
HXLINE(  93)							notes->remove(note);
HXLINE(  94)							len = notes->get_length();
            						}
            						else {
HXLINE(  96)							i = (i + 1);
            						}
...
HXLINE( 101)		::Array< ::Dynamic> sectionsData = ( (::Array< ::Dynamic>)(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)) );
HXLINE( 102)		if (::hx::IsNull( sectionsData )) {
HXLINE( 102)			return;
            		}
HXLINE( 104)		{
HXLINE( 104)			int _g2 = 0;
HXDLIN( 104)			while((_g2 < sectionsData->length)){
HXLINE( 104)				 ::Dynamic section = sectionsData->__get(_g2);
HXDLIN( 104)				_g2 = (_g2 + 1);
HXLINE( 106)				 ::Dynamic beats = section->__Field(HX_("sectionBeats",18,52,2e,0f),::hx::paccDynamic);
HXLINE( 107)				bool _hx_tmp;
HXDLIN( 107)				if (::hx::IsNotNull( beats )) {
HXLINE( 107)					_hx_tmp = ::Math_obj::isNaN(( (Float)(beats) ));
            				}
            				else {
HXLINE( 107)					_hx_tmp = true;
            				}
HXDLIN( 107)				if (_hx_tmp) {
HXLINE( 109)					section->__SetField(HX_("sectionBeats",18,52,2e,0f),4,::hx::paccDynamic);
HXLINE( 110)					if (::Reflect_obj::hasField(section,HX_("lengthInSteps",3c,ed,41,db))) {
HXLINE( 110)						::Reflect_obj::deleteField(section,HX_("lengthInSteps",3c,ed,41,db));
            					}
            				}
HXLINE( 113)				{
HXLINE( 113)					int _g3 = 0;
HXDLIN( 113)					::cpp::VirtualArray _g4 = ( (::cpp::VirtualArray)(section->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) );
HXDLIN( 113)					while((_g3 < _g4->get_length())){
HXLINE( 113)						 ::Dynamic note1 = _g4->__get(_g3);
HXDLIN( 113)						_g3 = (_g3 + 1);
HXLINE( 115)						bool gottaHitNote;
HXDLIN( 115)						if (::hx::IsLess( note1->__GetItem(1),4 )) {
HXLINE( 115)							gottaHitNote = ( (bool)(section->__Field(HX_("mustHitSection",3b,5f,87,62),::hx::paccDynamic)) );
            						}
            						else {
HXLINE( 115)							gottaHitNote = !(( (bool)(section->__Field(HX_("mustHitSection",3b,5f,87,62),::hx::paccDynamic)) ));
            						}
HXLINE( 116)						int _hx_tmp1;
HXDLIN( 116)						if (gottaHitNote) {
HXLINE( 116)							_hx_tmp1 = 0;
            						}
            						else {
HXLINE( 116)							_hx_tmp1 = 4;
            						}
HXDLIN( 116)						note1->__SetItem(1,(::hx::Mod(note1->__GetItem(1),4) + _hx_tmp1));
HXLINE( 118)						if (!(::Std_obj::isOfType(note1->__GetItem(3),::hx::ClassOf< ::String >()))) {
HXLINE( 119)							note1->__SetItem(3,::objects::Note_obj::defaultNoteTypes->__get(( (int)(note1->__GetItem(3)) )));
            						}
            					}
            				}
            			}
...
::String Song_obj::loadedSongName;
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_db09ff2b98ac40f1_127_loadFromJson)
HXLINE( 128)		if (::hx::IsNull( folder )) {
HXLINE( 128)			folder = jsonInput;
            		}
HXLINE( 129)		::states::PlayState_obj::SONG = ::backend::Song_obj::getChart(jsonInput,folder);
HXLINE( 130)		::backend::Song_obj::loadedSongName = folder;
HXLINE( 131)		::backend::Song_obj::chartPath = ::backend::Song_obj::_lastPath;
HXLINE( 134)		::backend::Song_obj::chartPath = ::StringTools_obj::replace(::backend::Song_obj::chartPath,HX_("/",2f,00,00,00),HX_("\\",5c,00,00,00));
...
HXDLIN( 146)		 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[.,'\"%?!]",ca,d9,c0,ac),HX_("g",67,00,00,00));
...
HXDLIN( 147)		 ::EReg hideChars1 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[.,'\"%?!]",ca,d9,c0,ac),HX_("g",67,00,00,00));
...
HXLINE( 162)		 ::Dynamic songJson =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawData)->doParse();
HXLINE( 163)		if (::Reflect_obj::hasField(songJson,HX_("song",d5,23,58,4c))) {
HXLINE( 165)			 ::Dynamic subSong = ::Reflect_obj::field(songJson,HX_("song",d5,23,58,4c));
HXLINE( 166)			bool _hx_tmp;
HXDLIN( 166)			if (::hx::IsNotNull( subSong )) {
HXLINE( 166)				_hx_tmp = ::hx::IsPointerEq( ::Type_obj::_hx_typeof(subSong),::ValueType_obj::TObject_dyn() );
            			}
            			else {
HXLINE( 166)				_hx_tmp = false;
            			}
HXDLIN( 166)			if (_hx_tmp) {
HXLINE( 167)				songJson = subSong;
            			}
            		}
HXLINE( 170)		bool _hx_tmp1;
HXDLIN( 170)		if (::hx::IsNotNull( convertTo )) {
HXLINE( 170)			_hx_tmp1 = (convertTo.length > 0);
            		}
            		else {
HXLINE( 170)			_hx_tmp1 = false;
            		}
HXDLIN( 170)		if (_hx_tmp1) {
HXLINE( 172)			::String fmt = ( (::String)(songJson->__Field(HX_("format",37,8f,8e,fd),::hx::paccDynamic)) );
HXLINE( 173)			if (::hx::IsNull( fmt )) {
HXLINE( 173)				fmt = (songJson->__SetField(HX_("format",37,8f,8e,fd),HX_("unknown",8a,23,7b,e1),::hx::paccDynamic));
            			}
HXLINE( 175)			if ((convertTo == HX_("psych_v1",bf,0a,17,5b))) {
HXLINE( 178)				if (!(::StringTools_obj::startsWith(fmt,HX_("psych_v1",bf,0a,17,5b)))) {
HXLINE( 180)					::haxe::Log_obj::trace(((((HX_("converting chart ",b3,bc,de,62) + nameForError) + HX_(" with format ",0f,a1,93,fc)) + fmt) + HX_(" to psych_v1 format...",db,cf,34,c9)),::hx::SourceInfo(HX_("source/backend/Song.hx",3a,61,1f,b3),180,HX_("backend.Song",8f,fa,b1,a5),HX_("parseJSON",db,2f,f6,cd)));
HXLINE( 181)					songJson->__SetField(HX_("format",37,8f,8e,fd),HX_("psych_v1_convert",33,b9,d0,ee),::hx::paccDynamic);
HXLINE( 182)					::backend::Song_obj::convert(songJson);
            				}
            			}
            		}
HXLINE( 186)		return songJson;
            	}
