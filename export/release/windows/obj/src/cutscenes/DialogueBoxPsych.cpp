...
HXDLIN(  75)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("speech_bubble",49,db,97,da),parentFolder,null());
HXDLIN(  75)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN(  75)		 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp4;
HXDLIN(  75)		bool _hx_tmp5;
HXDLIN(  75)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE(  75)			_hx_tmp5 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE(  75)			_hx_tmp5 = true;
            		}
HXDLIN(  75)		if (_hx_tmp5) {
HXLINE(  75)			_hx_tmp4 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE(  75)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("speech_bubble",49,db,97,da)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  75)			_hx_tmp4 = null();
            		}
HXDLIN(  75)		_hx_tmp3->set_frames(_hx_tmp4);
HXLINE(  76)		{
HXLINE(  76)			 ::flixel::math::FlxBasePoint this2 = this->box->scrollFactor;
...
HXLINE(  87)		 ::flixel::FlxSprite _hx_tmp6 = this->box;
HXDLIN(  87)		_hx_tmp6->setGraphicSize(::Std_obj::_hx_int((this->box->get_width() * ((Float)0.9))),null());
...
HXLINE(  95)		int _hx_tmp7 = (::flixel::FlxG_obj::width - 320);
HXDLIN(  95)		int _hx_tmp8 = (::flixel::FlxG_obj::height - 30);
HXDLIN(  95)		::cpp::VirtualArray values = null();
HXDLIN(  95)		::Dynamic this3 = ::backend::Language_obj::phrases;
HXDLIN(  95)		 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\/;:<>#.,'\"%?!]",85,3f,6d,6d),HX_("g",67,00,00,00));
HXDLIN(  95)		::String str = ( ( ::haxe::ds::StringMap)(this3) )->get_string(::StringTools_obj::trim(hideChars->replace(::StringTools_obj::replace(HX_("dialogue_skip",46,8e,1f,07),HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
HXDLIN(  95)		if (::hx::IsNull( str )) {
HXLINE(  62)			str = HX_("Press BACK to Skip",48,df,73,8e);
            		}
HXLINE(  95)		if (::hx::IsNull( str )) {
HXLINE(  68)			str = HX_("dialogue_skip",46,8e,1f,07);
            		}
...
HXLINE(  95)		this->skipText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,_hx_tmp7,_hx_tmp8,300,str,16,null());
