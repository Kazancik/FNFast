...
HX_LOCAL_STACK_FRAME(_hx_pos_0e0824d2a0189e14_199_unzip,"haxe.zip.Reader","unzip",0x282047d2,"haxe.zip.Reader.unzip","C:\\HaxeToolkit\\haxe\\std/haxe/zip/Reader.hx",199,0x0c8b1c7d)
namespace haxe{
namespace zip{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Reader_obj,readZip,return )
 ...
 ::haxe::io::Bytes Reader_obj::unzip( ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_0e0824d2a0189e14_199_unzip)
HXLINE( 200)		if (!(( (bool)(f->__Field(HX_("compressed",81,4c,da,67),::hx::paccDynamic)) ))) {
HXLINE( 201)			return ( ( ::haxe::io::Bytes)(f->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic)) );
            		}
HXLINE( 202)		 ::haxe::zip::Uncompress c =  ::haxe::zip::Uncompress_obj::__alloc( HX_CTX ,-15);
HXLINE( 203)		 ::haxe::io::Bytes s = ::haxe::io::Bytes_obj::alloc(( (int)(f->__Field(HX_("fileSize",5d,89,97,65),::hx::paccDynamic)) ));
HXLINE( 204)		 ::Dynamic r = c->execute(( ( ::haxe::io::Bytes)(f->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic)) ),0,s,0);
HXLINE( 205)		c->close();
HXLINE( 206)		bool _hx_tmp;
HXDLIN( 206)		bool _hx_tmp1;
HXDLIN( 206)		if (( (bool)(r->__Field(HX_("done",82,f0,6d,42),::hx::paccDynamic)) )) {
HXLINE( 206)			_hx_tmp1 = ::hx::IsNotEq( r->__Field(HX_("read",56,4b,a7,4b),::hx::paccDynamic),( ( ::haxe::io::Bytes)(f->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic)) )->length );
            		}
            		else {
HXLINE( 206)			_hx_tmp1 = true;
            		}
HXDLIN( 206)		if (!(_hx_tmp1)) {
HXLINE( 206)			_hx_tmp = ::hx::IsNotEq( r->__Field(HX_("write",df,6c,59,d0),::hx::paccDynamic),f->__Field(HX_("fileSize",5d,89,97,65),::hx::paccDynamic) );
            		}
            		else {
HXLINE( 206)			_hx_tmp = true;
            		}
HXDLIN( 206)		if (_hx_tmp) {
HXLINE( 207)			HX_STACK_DO_THROW( ::Dynamic((HX_("Invalid compressed data for ",37,5a,72,7b) + f->__Field(HX_("fileName",e7,5a,43,62),::hx::paccDynamic))));
            		}
HXLINE( 208)		f->__SetField(HX_("compressed",81,4c,da,67),false,::hx::paccDynamic);
HXLINE( 209)		f->__SetField(HX_("dataSize",0b,80,c7,8b),f->__Field(HX_("fileSize",5d,89,97,65),::hx::paccDynamic),::hx::paccDynamic);
HXLINE( 210)		f->__SetField(HX_("data",2a,56,63,42),s,::hx::paccDynamic);
HXLINE( 211)		return ( ( ::haxe::io::Bytes)(f->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic)) );
            	}
