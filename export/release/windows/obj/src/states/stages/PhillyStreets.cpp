...
HXDLIN( 461)				 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("PicoBullet",27,2d,bf,cb),parentFolder,null());
HXDLIN( 461)				::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("PicoBullet",27,2d,bf,cb)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN( 461)				 ::flixel::graphics::frames::FlxAtlasFrames precacheCasing;
HXDLIN( 461)				bool precacheCasing1;
HXDLIN( 461)				if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE( 461)					precacheCasing1 = ::lime::utils::Assets_obj::exists(xml,null());
            				}
            				else {
HXLINE( 461)					precacheCasing1 = true;
            				}
HXDLIN( 461)				if (precacheCasing1) {
HXLINE( 461)					precacheCasing = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            				}
            				else {
HXLINE( 461)					::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("PicoBullet",27,2d,bf,cb)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN( 461)					precacheCasing = null();
            				}
HXDLIN( 461)				_gthis->casingFrames = precacheCasing;
