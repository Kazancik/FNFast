...
HXDLIN( 336)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("characters/BOYFRIEND",65,2c,9c,1b),parentFolder,null());
HXDLIN( 336)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/BOYFRIEND",65,2c,9c,1b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN( 336)		 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp1;
HXDLIN( 336)		bool _hx_tmp2;
HXDLIN( 336)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE( 336)			_hx_tmp2 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE( 336)			_hx_tmp2 = true;
            		}
HXDLIN( 336)		if (_hx_tmp2) {
HXLINE( 336)			_hx_tmp1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE( 336)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("characters/BOYFRIEND",65,2c,9c,1b)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN( 336)			_hx_tmp1 = null();
            		}
HXDLIN( 336)		_hx_tmp->set_frames(_hx_tmp1);
