...
HXDLIN(  21)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("tankmanKilled1",04,7a,c5,c3),parentFolder,null());
HXDLIN(  21)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("tankmanKilled1",04,7a,c5,c3)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN(  21)		 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp;
HXDLIN(  21)		bool _hx_tmp1;
HXDLIN(  21)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE(  21)			_hx_tmp1 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE(  21)			_hx_tmp1 = true;
            		}
HXDLIN(  21)		if (_hx_tmp1) {
HXLINE(  21)			_hx_tmp = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE(  21)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("tankmanKilled1",04,7a,c5,c3)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  21)			_hx_tmp = null();
            		}
HXDLIN(  21)		this->set_frames(_hx_tmp);
