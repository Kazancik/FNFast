...
HXDLIN(  46)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("abot/aBotViz",58,ab,36,10),parentFolder,null());
HXDLIN(  46)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("abot/aBotViz",58,ab,36,10)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN(  46)		 ::flixel::graphics::frames::FlxAtlasFrames vizFrames;
HXDLIN(  46)		bool vizFrames1;
HXDLIN(  46)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE(  46)			vizFrames1 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE(  46)			vizFrames1 = true;
            		}
HXDLIN(  46)		if (vizFrames1) {
HXLINE(  46)			vizFrames = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE(  46)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("abot/aBotViz",58,ab,36,10)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  46)			vizFrames = null();
            		}
HXLINE(  47)		{
HXLINE(  47)			int _g = 1;
...
HXLINE(  53)				viz->set_frames(vizFrames);
...
HXLINE(  65)		{
HXLINE(  65)			 ::flixel::math::FlxBasePoint this1 = this->eyeBg->scale;
HXDLIN(  65)			this1->set_x(( (Float)(160) ));
HXDLIN(  65)			this1->set_y(( (Float)(60) ));
            		}
