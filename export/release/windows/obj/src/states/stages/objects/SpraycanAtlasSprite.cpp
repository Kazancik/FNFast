...
HXDLIN(  32)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("spraypaintExplosionEZ",b9,a3,49,79),parentFolder,null());
HXDLIN(  32)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("spraypaintExplosionEZ",b9,a3,49,79)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN(  32)		 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp2;
HXDLIN(  32)		bool _hx_tmp3;
HXDLIN(  32)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE(  32)			_hx_tmp3 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE(  32)			_hx_tmp3 = true;
            		}
HXDLIN(  32)		if (_hx_tmp3) {
HXLINE(  32)			_hx_tmp2 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE(  32)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("spraypaintExplosionEZ",b9,a3,49,79)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  32)			_hx_tmp2 = null();
            		}
HXDLIN(  32)		_hx_tmp1->set_frames(_hx_tmp2);
...
HXLINE(  35)		 ::flixel::FlxSprite _hx_tmp4 = this->explosion;
HXDLIN(  35)		_hx_tmp4->set_visible(this->explosion->set_active(false));
