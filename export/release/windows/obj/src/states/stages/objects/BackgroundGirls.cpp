...
HXDLIN(  11)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("weeb/bgFreaks",d9,71,bd,0f),parentFolder,null());
HXDLIN(  11)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
...
HXLINE(  11)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
