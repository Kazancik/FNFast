...
static const ::String _hx_array_data_79985863_7[] = {
	HX_("FNFast Was Made By",0f,31,31,d1),
};
static const ::String _hx_array_data_79985863_8[] = {
	HX_("Kazancik",b4,ab,d2,6d),HX_("",00,00,00,00),HX_("I made it!",c2,76,25,88),HX_("https://github.com/Kazancik",7e,42,c1,45),HX_("444444",80,a8,eb,dd),
};
static const ::String _hx_array_data_79985863_9[] = {
	HX_("Font For Menus",ec,9b,01,8c),
};
static const ::String _hx_array_data_79985863_10[] = {
	HX_("Hl33",c4,7c,e9,2f),HX_("",00,00,00,00),HX_("FNF font for menus",ee,3b,e8,b0),HX_("https://gamebanana.com/members/3434197",81,dd,24,5b),HX_("CF2D2D",47,38,36,39),
};
...
static const ::String _hx_array_data_79985863_37[] = {
...
HX_LOCAL_STACK_FRAME(_hx_pos_178cfd7cdc100066_140_update,"states.CreditsState","update",0xdf05a6b4,"states.CreditsState.update","states/CreditsState.hx",140,0xc8f2335a)
HX_LOCAL_STACK_FRAME(_hx_pos_178cfd7cdc100066_213_changeSelection,"states.CreditsState","changeSelection",0xb16f8ab1,"states.CreditsState.changeSelection","states/CreditsState.hx",213,0xc8f2335a)
HX_LOCAL_STACK_FRAME(_hx_pos_178cfd7cdc100066_258_pushModCreditsToList,"states.CreditsState","pushModCreditsToList",0xbcc6d8f6,"states.CreditsState.pushModCreditsToList","states/CreditsState.hx",258,0xc8f2335a)
static const ::String _hx_array_data_79985863_46[] = {
	HX_("",00,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_178cfd7cdc100066_281_unselectableCheck,"states.CreditsState","unselectableCheck",0x9a60714e,"states.CreditsState.unselectableCheck","states/CreditsState.hx",281,0xc8f2335a)
namespace states{

void CreditsState_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_178cfd7cdc100066_5_new)
HXLINE( 211)		this->moveTween = null();
HXLINE( 138)		this->holdTime = ((Float)0);
HXLINE( 137)		this->quitting = false;
...
HXLINE(  40)		::Array< ::Dynamic> defaultList = ::Array_obj< ::Dynamic>::__new(32)->init(0,::Array_obj< ::String >::fromData( _hx_array_data_79985863_7,1))->init(1,::Array_obj< ::String >::fromData( _hx_array_data_79985863_8,5))->init(2,::Array_obj< ::String >::fromData( _hx_array_data_79985863_9,1))->init(3,::Array_obj< ::String >::fromData( _hx_array_data_79985863_10,5))->init(4,::Array_obj< ::String >::fromData( _hx_array_data_79985863_11,1))->init(5,::Array_obj< ::String >::fromData( _hx_array_data_79985863_12,5))->init(6,::Array_obj< ::String >::fromData( _hx_array_data_79985863_13,5))->init(7,::Array_obj< ::String >::fromData( _hx_array_data_79985863_14,1))->init(8,::Array_obj< ::String >::fromData( _hx_array_data_79985863_15,1))->init(9,::Array_obj< ::String >::fromData( _hx_array_data_79985863_16,5))->init(10,::Array_obj< ::String >::fromData( _hx_array_data_79985863_17,1))->init(11,::Array_obj< ::String >::fromData( _hx_array_data_79985863_18,1))->init(12,::Array_obj< ::String >::fromData( _hx_array_data_79985863_19,5))->init(13,::Array_obj< ::String >::fromData( _hx_array_data_79985863_20,5))->init(14,::Array_obj< ::String >::fromData( _hx_array_data_79985863_21,5))->init(15,::Array_obj< ::String >::fromData( _hx_array_data_79985863_22,5))->init(16,::Array_obj< ::String >::fromData( _hx_array_data_79985863_23,5))->init(17,::Array_obj< ::String >::fromData( _hx_array_data_79985863_24,5))->init(18,::Array_obj< ::String >::fromData( _hx_array_data_79985863_25,5))->init(19,::Array_obj< ::String >::fromData( _hx_array_data_79985863_26,5))->init(20,::Array_obj< ::String >::fromData( _hx_array_data_79985863_27,5))->init(21,::Array_obj< ::String >::fromData( _hx_array_data_79985863_28,5))->init(22,::Array_obj< ::String >::fromData( _hx_array_data_79985863_29,5))->init(23,::Array_obj< ::String >::fromData( _hx_array_data_79985863_30,1))->init(24,::Array_obj< ::String >::fromData( _hx_array_data_79985863_31,1))->init(25,::Array_obj< ::String >::fromData( _hx_array_data_79985863_32,5))->init(26,::Array_obj< ::String >::fromData( _hx_array_data_79985863_33,5))->init(27,::Array_obj< ::String >::fromData( _hx_array_data_79985863_34,5))->init(28,::Array_obj< ::String >::fromData( _hx_array_data_79985863_35,5))->init(29,::Array_obj< ::String >::fromData( _hx_array_data_79985863_36,1))->init(30,::Array_obj< ::String >::fromData( _hx_array_data_79985863_37,1))->init(31,::Array_obj< ::String >::fromData( _hx_array_data_79985863_38,5));
HXLINE(  75)		{
HXLINE(  75)			int _g7 = 0;
HXDLIN(  75)			while((_g7 < defaultList->length)){
HXLINE(  75)				::Array< ::String > i1 = defaultList->__get(_g7).StaticCast< ::Array< ::String > >();
HXDLIN(  75)				_g7 = (_g7 + 1);
HXLINE(  76)				this->creditsStuff->push(i1);
            			}
            		}
HXLINE(  78)		{
HXLINE(  78)			int _g_current = 0;
HXDLIN(  78)			::Array< ::Dynamic> _g_array = this->creditsStuff;
HXDLIN(  78)			while((_g_current < _g_array->length)){
HXLINE(  78)				::Array< ::String > _g_value = _g_array->__get(_g_current).StaticCast< ::Array< ::String > >();
HXDLIN(  78)				_g_current = (_g_current + 1);
HXDLIN(  78)				int _g_key = (_g_current - 1);
HXDLIN(  78)				int i2 = _g_key;
HXDLIN(  78)				::Array< ::String > credit = _g_value;
HXLINE(  79)				{
HXLINE(  80)					bool isSelectable = !(this->unselectableCheck(i2));
HXLINE(  81)					 ::objects::Alphabet optionText =  ::objects::Alphabet_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) / ( (Float)(2) )),( (Float)(300) ),credit->__get(0),!(isSelectable));
HXLINE(  82)					optionText->isMenuItem = true;
HXLINE(  83)					optionText->targetY = i2;
HXLINE(  84)					optionText->changeX = false;
HXLINE(  85)					optionText->snapToPosition();
HXLINE(  86)					this->grpOptions->add(optionText).StaticCast<  ::objects::Alphabet >();
HXLINE(  88)					if (isSelectable) {
HXLINE(  90)						if (::hx::IsNotNull( credit->__get(5) )) {
HXLINE(  91)							::backend::Mods_obj::currentModDirectory = credit->__get(5);
            						}
HXLINE(  93)						::String str = HX_("credits/missing_icon",87,66,74,31);
HXLINE(  94)						bool _hx_tmp5;
HXDLIN(  94)						if (::hx::IsNotNull( credit->__get(1) )) {
HXLINE(  94)							_hx_tmp5 = (credit->__get(1).length > 0);
            						}
            						else {
HXLINE(  94)							_hx_tmp5 = false;
            						}
HXDLIN(  94)						if (_hx_tmp5) {
HXLINE(  96)							::String fileName = (HX_("credits/",d5,48,ee,de) + credit->__get(1));
HXLINE(  97)							if (::backend::Paths_obj::fileExists(((HX_("images/",77,50,74,c1) + fileName) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),null(),null())) {
HXLINE(  97)								str = fileName;
            							}
            							else {
HXLINE(  98)								if (::backend::Paths_obj::fileExists(((HX_("images/",77,50,74,c1) + fileName) + HX_("-pixel.png",f4,c0,84,ba)),HX_("IMAGE",3b,57,57,3b),null(),null())) {
HXLINE(  98)									str = (fileName + HX_("-pixel",39,03,b3,c0));
            								}
            							}
            						}
HXLINE( 101)						 ::objects::AttachedSprite icon =  ::objects::AttachedSprite_obj::__alloc( HX_CTX ,str,null(),null(),null());
HXLINE( 102)						if (::StringTools_obj::endsWith(str,HX_("-pixel",39,03,b3,c0))) {
HXLINE( 102)							icon->set_antialiasing(false);
            						}
HXLINE( 103)						icon->xAdd = (optionText->get_width() + 10);
HXLINE( 104)						icon->sprTracker = optionText;
HXLINE( 107)						this->iconArray->push(icon);
HXLINE( 108)						this->add(icon);
HXLINE( 109)						::backend::Mods_obj::currentModDirectory = HX_("",00,00,00,00);
HXLINE( 111)						if ((this->curSelected == -1)) {
HXLINE( 111)							this->curSelected = i2;
            						}
            					}
            					else {
HXLINE( 113)						optionText->set_alignment(::objects::Alignment_obj::CENTERED_dyn());
            					}
            				}
            			}
            		}
HXLINE( 116)		this->descBox =  ::objects::AttachedSprite_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 117)		this->descBox->makeGraphic(1,1,-16777216,null(),null());
HXLINE( 118)		this->descBox->xAdd = ( (Float)(-10) );
HXLINE( 119)		this->descBox->yAdd = ( (Float)(-10) );
HXLINE( 120)		this->descBox->alphaMult = ((Float)0.6);
HXLINE( 121)		this->descBox->set_alpha(((Float)0.6));
HXLINE( 122)		this->add(this->descBox);
HXLINE( 124)		this->descText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,50,((::flixel::FlxG_obj::height + this->offsetThing) - ( (Float)(25) )),1180,HX_("",00,00,00,00),32,null());
HXLINE( 125)		 ::flixel::text::FlxText _hx_tmp6 = this->descText;
HXDLIN( 125)		::String key = (HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82));
HXDLIN( 125)		::Dynamic this1 = ::backend::Language_obj::phrases;
HXDLIN( 125)		::String str1 = ( ( ::haxe::ds::StringMap)(this1) )->get_string(::StringTools_obj::trim(key).toLowerCase());
HXDLIN( 125)		if (::hx::IsNotNull( str1 )) {
HXLINE(  82)			key = str1;
            		}
HXLINE( 125)		::String folderKey = key;
HXDLIN( 125)		::String file = ::backend::Paths_obj::modFolders(folderKey);
HXDLIN( 125)		::String _hx_tmp7;
HXDLIN( 125)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 125)			_hx_tmp7 = file;
            		}
            		else {
HXLINE( 125)			_hx_tmp7 = (HX_("assets/",4c,2a,dc,36) + folderKey);
            		}
HXDLIN( 125)		_hx_tmp6->setFormat(_hx_tmp7,32,-1,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE( 126)		{
HXLINE( 126)			 ::flixel::math::FlxBasePoint this2 = this->descText->scrollFactor;
HXDLIN( 126)			this2->set_x(( (Float)(0) ));
HXDLIN( 126)			this2->set_y(( (Float)(0) ));
            		}
HXLINE( 128)		this->descBox->sprTracker = this->descText;
HXLINE( 129)		this->add(this->descText);
HXLINE( 131)		 ::flixel::FlxSprite _hx_tmp8 = this->bg;
HXDLIN( 131)		::String color = this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(4);
HXDLIN( 131)		 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[\t\n\r]",ac,57,71,6b),HX_("",00,00,00,00));
HXDLIN( 131)		::String color1 = ::StringTools_obj::trim(hideChars->split(color)->join(HX_("",00,00,00,00)));
HXDLIN( 131)		if (::StringTools_obj::startsWith(color1,HX_("0x",48,2a,00,00))) {
HXLINE(  59)			color1 = color1.substring((color1.length - 6),null());
            		}
HXLINE( 131)		 ::Dynamic colorNum = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(color1);
HXDLIN( 131)		if (::hx::IsNull( colorNum )) {
HXLINE(  62)			colorNum = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString((HX_("#",23,00,00,00) + color1));
            		}
HXLINE( 131)		int _hx_tmp9;
HXDLIN( 131)		if (::hx::IsNotNull( colorNum )) {
HXLINE( 131)			_hx_tmp9 = ( (int)(colorNum) );
            		}
            		else {
HXLINE( 131)			_hx_tmp9 = -1;
            		}
HXDLIN( 131)		_hx_tmp8->set_color(_hx_tmp9);
HXLINE( 132)		this->intendedColor = this->bg->color;
...
void CreditsState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_178cfd7cdc100066_140_update)
HXLINE( 141)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.7))) {
HXLINE( 143)			 ::flixel::sound::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 143)			fh->set_volume((fh->_volume + (((Float)0.5) * elapsed)));
            		}
HXLINE( 146)		if (!(this->quitting)) {
HXLINE( 148)			if ((this->creditsStuff->length > 1)) {
HXLINE( 150)				int shiftMult = 1;
HXLINE( 151)				 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 151)				if (_this->keyManager->checkStatusUnsafe(16,_this->status)) {
HXLINE( 151)					shiftMult = 3;
            				}
HXLINE( 153)				bool upP = this->get_controls()->get_UI_UP_P();
HXLINE( 154)				bool downP = this->get_controls()->get_UI_DOWN_P();
HXLINE( 156)				if (upP) {
HXLINE( 158)					this->changeSelection(-(shiftMult));
HXLINE( 159)					this->holdTime = ( (Float)(0) );
            				}
HXLINE( 161)				if (downP) {
HXLINE( 163)					this->changeSelection(shiftMult);
HXLINE( 164)					this->holdTime = ( (Float)(0) );
            				}
HXLINE( 167)				bool _hx_tmp;
HXDLIN( 167)				if (!(this->get_controls()->get_UI_DOWN())) {
HXLINE( 167)					_hx_tmp = this->get_controls()->get_UI_UP();
            				}
            				else {
HXLINE( 167)					_hx_tmp = true;
            				}
HXDLIN( 167)				if (_hx_tmp) {
HXLINE( 169)					int checkLastHold = ::Math_obj::floor(((this->holdTime - ((Float)0.5)) * ( (Float)(10) )));
HXLINE( 170)					 ::states::CreditsState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 170)					_hx_tmp1->holdTime = (_hx_tmp1->holdTime + elapsed);
HXLINE( 171)					int checkNewHold = ::Math_obj::floor(((this->holdTime - ((Float)0.5)) * ( (Float)(10) )));
HXLINE( 173)					bool _hx_tmp2;
HXDLIN( 173)					if ((this->holdTime > ((Float)0.5))) {
HXLINE( 173)						_hx_tmp2 = ((checkNewHold - checkLastHold) > 0);
            					}
            					else {
HXLINE( 173)						_hx_tmp2 = false;
            					}
HXDLIN( 173)					if (_hx_tmp2) {
HXLINE( 175)						int _hx_tmp3;
HXDLIN( 175)						if (this->get_controls()->get_UI_UP()) {
HXLINE( 175)							_hx_tmp3 = -(shiftMult);
            						}
            						else {
HXLINE( 175)							_hx_tmp3 = shiftMult;
            						}
HXDLIN( 175)						this->changeSelection(((checkNewHold - checkLastHold) * _hx_tmp3));
            					}
            				}
            			}
HXLINE( 180)			bool _hx_tmp4;
HXDLIN( 180)			if (this->get_controls()->get_ACCEPT()) {
HXLINE( 180)				if (::hx::IsNotNull( this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(3) )) {
HXLINE( 180)					_hx_tmp4 = (this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(3).length > 4);
            				}
            				else {
HXLINE( 180)					_hx_tmp4 = true;
            				}
            			}
            			else {
...
HXLINE( 181)				::String url = this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(3);
HXDLIN( 181)				if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^.\\w+?:/*",16,3c,ef,2d),HX_("",00,00,00,00))->match(url))) {
HXLINE( 181)					url = (HX_("https://",cf,b4,ae,3e) + url);
            				}
HXDLIN( 181)				::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,url),HX_("_blank",95,26,d9,b0));
            			}
HXLINE( 183)			if (this->get_controls()->get_BACK()) {
HXLINE( 185)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp5 = ::flixel::FlxG_obj::sound;
HXDLIN( 185)				_hx_tmp5->play(::backend::Paths_obj::returnSound((HX_("sounds/",eb,02,a5,b6) + HX_("cancelMenu",39,a4,43,b7)),null(),true,null()),null(),null(),null(),null(),null());
HXLINE( 186)				::backend::MusicBeatState_obj::switchState( ::states::MainMenuState_obj::__alloc( HX_CTX ));
HXLINE( 187)				this->quitting = true;
            			}
            		}
HXLINE( 191)		{
HXLINE( 191)			int _g = 0;
HXDLIN( 191)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 191)			while((_g < _g1->length)){
HXLINE( 191)				 ::objects::Alphabet item = _g1->__get(_g).StaticCast<  ::objects::Alphabet >();
HXDLIN( 191)				_g = (_g + 1);
HXLINE( 193)				if (!(item->bold)) {
HXLINE( 195)					Float lerpVal = ::Math_obj::exp((-(elapsed) * ( (Float)(12) )));
HXLINE( 196)					if ((item->targetY == 0)) {
HXLINE( 198)						Float lastX = item->x;
HXLINE( 199)						{
HXLINE( 199)							int axes = 1;
HXDLIN( 199)							bool _hx_tmp6;
HXDLIN( 199)							if ((axes != 1)) {
HXLINE( 199)								_hx_tmp6 = (axes == 17);
            							}
            							else {
HXLINE( 199)								_hx_tmp6 = true;
            							}
HXDLIN( 199)							if (_hx_tmp6) {
HXLINE( 199)								int _hx_tmp7 = ::flixel::FlxG_obj::width;
HXDLIN( 199)								item->set_x(((( (Float)(_hx_tmp7) ) - item->get_width()) / ( (Float)(2) )));
            							}
HXDLIN( 199)							bool _hx_tmp8;
HXDLIN( 199)							if ((axes != 16)) {
HXLINE( 199)								_hx_tmp8 = (axes == 17);
            							}
            							else {
HXLINE( 199)								_hx_tmp8 = true;
            							}
HXDLIN( 199)							if (_hx_tmp8) {
HXLINE( 199)								int _hx_tmp9 = ::flixel::FlxG_obj::height;
HXDLIN( 199)								item->set_y(((( (Float)(_hx_tmp9) ) - item->get_height()) / ( (Float)(2) )));
            							}
            						}
HXLINE( 200)						Float a = (item->x - ( (Float)(70) ));
HXDLIN( 200)						item->set_x((a + (lerpVal * (lastX - a))));
            					}
            					else {
HXLINE( 204)						Float a1 = (200 + (( (Float)(-40) ) * ::Math_obj::abs(( (Float)(item->targetY) ))));
HXDLIN( 204)						item->set_x((a1 + (lerpVal * (item->x - a1))));
            					}
            				}
            			}
            		}
HXLINE( 208)		this->super::update(elapsed);
            	}


void CreditsState_obj::changeSelection(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_178cfd7cdc100066_213_changeSelection)
HXLINE( 214)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 214)		_hx_tmp->play(::backend::Paths_obj::returnSound((HX_("sounds/",eb,02,a5,b6) + HX_("scrollMenu",4c,d4,18,06)),null(),true,null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 215)		do {
HXLINE( 217)			this->curSelected = ::flixel::math::FlxMath_obj::wrap((this->curSelected + change),0,(this->creditsStuff->length - 1));
            		} while(this->unselectableCheck(this->curSelected));
;
HXLINE( 221)		::String color = this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(4);
HXDLIN( 221)		 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[\t\n\r]",ac,57,71,6b),HX_("",00,00,00,00));
HXDLIN( 221)		::String color1 = ::StringTools_obj::trim(hideChars->split(color)->join(HX_("",00,00,00,00)));
HXDLIN( 221)		if (::StringTools_obj::startsWith(color1,HX_("0x",48,2a,00,00))) {
HXLINE(  59)			color1 = color1.substring((color1.length - 6),null());
            		}
HXLINE( 221)		 ::Dynamic colorNum = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(color1);
HXDLIN( 221)		if (::hx::IsNull( colorNum )) {
HXLINE(  62)			colorNum = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString((HX_("#",23,00,00,00) + color1));
            		}
HXLINE( 221)		int newColor;
HXDLIN( 221)		if (::hx::IsNotNull( colorNum )) {
HXLINE( 221)			newColor = ( (int)(colorNum) );
            		}
            		else {
HXLINE( 221)			newColor = -1;
            		}
HXLINE( 223)		if ((newColor != this->intendedColor)) {
HXLINE( 225)			this->intendedColor = newColor;
HXLINE( 226)			::flixel::tweens::FlxTween_obj::cancelTweensOf(this->bg,null());
HXLINE( 227)			::flixel::tweens::FlxTween_obj::color(this->bg,1,this->bg->color,this->intendedColor,null());
            		}
HXLINE( 230)		{
HXLINE( 230)			int _g_current = 0;
HXDLIN( 230)			::Array< ::Dynamic> _g_array = this->grpOptions->members;
HXDLIN( 230)			while((_g_current < _g_array->length)){
HXLINE( 230)				 ::objects::Alphabet _g_value = _g_array->__get(_g_current).StaticCast<  ::objects::Alphabet >();
HXDLIN( 230)				_g_current = (_g_current + 1);
HXDLIN( 230)				int _g_key = (_g_current - 1);
HXDLIN( 230)				int num = _g_key;
HXDLIN( 230)				 ::objects::Alphabet item = _g_value;
HXLINE( 231)				{
HXLINE( 232)					item->targetY = (num - this->curSelected);
HXLINE( 233)					if (!(this->unselectableCheck(num))) {
HXLINE( 234)						item->set_alpha(((Float)0.6));
HXLINE( 235)						if ((item->targetY == 0)) {
HXLINE( 236)							item->set_alpha(( (Float)(1) ));
            						}
            					}
            				}
            			}
            		}
HXLINE( 241)		this->descText->set_text(this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(2));
HXLINE( 242)		if ((::StringTools_obj::trim(this->descText->text).length > 0)) {
HXLINE( 244)			 ::flixel::text::FlxText _hx_tmp1 = this->descText;
HXDLIN( 244)			_hx_tmp1->set_visible(this->descBox->set_visible(true));
HXLINE( 245)			 ::flixel::text::FlxText _hx_tmp2 = this->descText;
HXDLIN( 245)			int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN( 245)			Float _hx_tmp4 = (( (Float)(_hx_tmp3) ) - this->descText->get_height());
HXDLIN( 245)			_hx_tmp2->set_y(((_hx_tmp4 + this->offsetThing) - ( (Float)(60) )));
HXLINE( 247)			if (::hx::IsNotNull( this->moveTween )) {
HXLINE( 247)				this->moveTween->cancel();
            			}
HXLINE( 248)			this->moveTween = ::flixel::tweens::FlxTween_obj::tween(this->descText, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 250)			 ::objects::AttachedSprite _hx_tmp5 = this->descBox;
HXDLIN( 250)			int _hx_tmp6 = ::Std_obj::_hx_int((this->descText->get_width() + 20));
HXDLIN( 250)			_hx_tmp5->setGraphicSize(_hx_tmp6,::Std_obj::_hx_int((this->descText->get_height() + 25)));
HXLINE( 251)			this->descBox->updateHitbox();
            		}
            		else {
HXLINE( 253)			 ::flixel::text::FlxText _hx_tmp7 = this->descText;
HXDLIN( 253)			_hx_tmp7->set_visible(this->descBox->set_visible(false));
            		}
            	}
...
void CreditsState_obj::pushModCreditsToList(::String folder){
            	HX_STACKFRAME(&_hx_pos_178cfd7cdc100066_258_pushModCreditsToList)
HXLINE( 259)		::String key = (folder + HX_("/data/credits.txt",a6,fd,31,d1));
HXDLIN( 259)		if (::hx::IsNull( key )) {
HXLINE( 259)			key = HX_("",00,00,00,00);
            		}
HXDLIN( 259)		::String creditsFile = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 263)		::String key1 = (folder + ((HX_("/data/credits-",09,73,cc,c0) + ::backend::ClientPrefs_obj::data->language) + HX_(".txt",02,3f,c0,1e)));
HXDLIN( 263)		if (::hx::IsNull( key1 )) {
HXLINE( 263)			key1 = HX_("",00,00,00,00);
            		}
HXDLIN( 263)		::String translatedCredits = (HX_("mods/",9e,2f,58,0c) + key1);
HXLINE( 266)		bool _hx_tmp;
HXDLIN( 266)		bool _hx_tmp1;
HXDLIN( 266)		if (::sys::FileSystem_obj::exists(translatedCredits)) {
HXLINE( 266)			creditsFile = translatedCredits;
HXDLIN( 266)			_hx_tmp1 = (creditsFile == translatedCredits);
            		}
            		else {
HXLINE( 266)			_hx_tmp1 = false;
            		}
HXDLIN( 266)		if (!(_hx_tmp1)) {
HXLINE( 266)			_hx_tmp = ::sys::FileSystem_obj::exists(creditsFile);
            		}
            		else {
HXLINE( 266)			_hx_tmp = true;
            		}
HXDLIN( 266)		if (_hx_tmp) {
HXLINE( 268)			::Array< ::String > firstarray = ::sys::io::File_obj::getContent(creditsFile).split(HX_("\n",0a,00,00,00));
HXLINE( 269)			{
HXLINE( 269)				int _g = 0;
HXDLIN( 269)				while((_g < firstarray->length)){
HXLINE( 269)					::String i = firstarray->__get(_g);
HXDLIN( 269)					_g = (_g + 1);
HXLINE( 271)					::Array< ::String > arr = ::StringTools_obj::replace(i,HX_("\\n",92,50,00,00),HX_("\n",0a,00,00,00)).split(HX_("::",c0,32,00,00));
HXLINE( 272)					if ((arr->length >= 5)) {
HXLINE( 272)						arr->push(folder);
            					}
HXLINE( 273)					this->creditsStuff->push(arr);
            				}
            			}
HXLINE( 275)			this->creditsStuff->push(::Array_obj< ::String >::fromData( _hx_array_data_79985863_46,1));
            		}
            	}
...
bool CreditsState_obj::unselectableCheck(int num){
            	HX_STACKFRAME(&_hx_pos_178cfd7cdc100066_281_unselectableCheck)
HXDLIN( 281)		return (this->creditsStuff->__get(num).StaticCast< ::Array< ::String > >()->length <= 1);
            	}
