...
HXDLIN(  46)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("campaign_menu_UI_assets",fd,f3,ba,6a),parentFolder,null());
HXDLIN(  46)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("campaign_menu_UI_assets",fd,f3,ba,6a)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN(  46)		 ::flixel::graphics::frames::FlxAtlasFrames ui_tex;
HXDLIN(  46)		bool ui_tex1;
HXDLIN(  46)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE(  46)			ui_tex1 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE(  46)			ui_tex1 = true;
            		}
HXDLIN(  46)		if (ui_tex1) {
HXLINE(  46)			ui_tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE(  46)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("campaign_menu_UI_assets",fd,f3,ba,6a)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  46)			ui_tex = null();
            		}
...
HXLINE(  62)		this->lock->set_frames(ui_tex);
...
HXDLIN(  69)		::String key1 = (HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82));
HXDLIN(  69)		::Dynamic this2 = ::backend::Language_obj::phrases;
HXDLIN(  69)		::String str1 = ( ( ::haxe::ds::StringMap)(this2) )->get_string(::StringTools_obj::trim(key1).toLowerCase());
HXDLIN(  69)		if (::hx::IsNotNull( str1 )) {
HXLINE(  69)			key1 = str1;
            		}
HXDLIN(  69)		::String folderKey1 = key1;
...
HXDLIN(  92)		::String key2 = (HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82));
HXDLIN(  92)		::Dynamic this3 = ::backend::Language_obj::phrases;
HXDLIN(  92)		::String str2 = ( ( ::haxe::ds::StringMap)(this3) )->get_string(::StringTools_obj::trim(key2).toLowerCase());
HXDLIN(  92)		if (::hx::IsNotNull( str2 )) {
HXLINE(  92)			key2 = str2;
            		}
HXDLIN(  92)		::String folderKey2 = key2;
