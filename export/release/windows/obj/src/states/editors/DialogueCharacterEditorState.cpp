...
HXDLIN(  93)		 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(HX_("speech_bubble",49,db,97,da),parentFolder,null());
HXDLIN(  93)		::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN(  93)		 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp3;
HXDLIN(  93)		bool _hx_tmp4;
HXDLIN(  93)		if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE(  93)			_hx_tmp4 = ::lime::utils::Assets_obj::exists(xml,null());
            		}
            		else {
HXLINE(  93)			_hx_tmp4 = true;
            		}
HXDLIN(  93)		if (_hx_tmp4) {
HXLINE(  93)			_hx_tmp3 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            		}
            		else {
HXLINE(  93)			::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + HX_("speech_bubble",49,db,97,da)) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN(  93)			_hx_tmp3 = null();
            		}
HXDLIN(  93)		_hx_tmp2->set_frames(_hx_tmp3);
HXLINE(  94)		{
HXLINE(  94)			 ::flixel::math::FlxBasePoint this2 = this->box->scrollFactor;
...
HXLINE(  98)		 ::flixel::FlxSprite _hx_tmp5 = this->box;
HXDLIN(  98)		_hx_tmp5->setGraphicSize(::Std_obj::_hx_int((this->box->get_width() * ((Float)0.9))),null());
...
HXLINE( 103)		 ::flixel::text::FlxText _hx_tmp6 = this->tipText;
HXDLIN( 103)		::String key = (HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82));
HXDLIN( 103)		::Dynamic this3 = ::backend::Language_obj::phrases;
HXDLIN( 103)		::String str = ( ( ::haxe::ds::StringMap)(this3) )->get_string(::StringTools_obj::trim(key).toLowerCase());
HXDLIN( 103)		if (::hx::IsNotNull( str )) {
HXLINE( 103)			key = str;
            		}
HXDLIN( 103)		::String folderKey = key;
...
HXLINE( 103)			_hx_tmp7 = (HX_("assets/",4c,2a,dc,36) + folderKey);
            		}
HXDLIN( 103)		_hx_tmp6->setFormat(_hx_tmp7,16,-1,HX_("right",dc,0b,64,e9),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 104)		this->tipText->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,this->camHUD));
HXLINE( 105)		{
HXLINE( 105)			 ::flixel::math::FlxBasePoint this4 = this->tipText->scrollFactor;
HXDLIN( 105)			this4->set_x(( (Float)(0) ));
HXDLIN( 105)			this4->set_y(( (Float)(0) ));
            		}
...
HXLINE( 109)		 ::flixel::text::FlxText _hx_tmp8 = this->offsetLoopText;
HXDLIN( 109)		::String key1 = (HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82));
HXDLIN( 109)		::Dynamic this5 = ::backend::Language_obj::phrases;
HXDLIN( 109)		::String str1 = ( ( ::haxe::ds::StringMap)(this5) )->get_string(::StringTools_obj::trim(key1).toLowerCase());
HXDLIN( 109)		if (::hx::IsNotNull( str1 )) {
HXLINE( 109)			key1 = str1;
            		}
HXDLIN( 109)		::String folderKey1 = key1;
...
HXLINE( 109)			_hx_tmp9 = file1;
            		}
            		else {
HXLINE( 109)			_hx_tmp9 = (HX_("assets/",4c,2a,dc,36) + folderKey1);
            		}
HXDLIN( 109)		_hx_tmp8->setFormat(_hx_tmp9,32,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 110)		this->offsetLoopText->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,this->camHUD));
HXLINE( 111)		{
HXLINE( 111)			 ::flixel::math::FlxBasePoint this6 = this->offsetLoopText->scrollFactor;
HXDLIN( 111)			this6->set_x(( (Float)(0) ));
HXDLIN( 111)			this6->set_y(( (Float)(0) ));
            		}
...
HXLINE( 116)		 ::flixel::text::FlxText _hx_tmp10 = this->offsetIdleText;
HXDLIN( 116)		::String key2 = (HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82));
HXDLIN( 116)		::Dynamic this7 = ::backend::Language_obj::phrases;
HXDLIN( 116)		::String str2 = ( ( ::haxe::ds::StringMap)(this7) )->get_string(::StringTools_obj::trim(key2).toLowerCase());
HXDLIN( 116)		if (::hx::IsNotNull( str2 )) {
HXLINE( 116)			key2 = str2;
            		}
HXDLIN( 116)		::String folderKey2 = key2;
HXDLIN( 116)		::String file2 = ::backend::Paths_obj::modFolders(folderKey2);
HXDLIN( 116)		::String _hx_tmp11;
HXDLIN( 116)		if (::sys::FileSystem_obj::exists(file2)) {
HXLINE( 116)			_hx_tmp11 = file2;
            		}
            		else {
HXLINE( 116)			_hx_tmp11 = (HX_("assets/",4c,2a,dc,36) + folderKey2);
            		}
HXDLIN( 116)		_hx_tmp10->setFormat(_hx_tmp11,32,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 117)		this->offsetIdleText->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,this->camHUD));
HXLINE( 118)		{
HXLINE( 118)			 ::flixel::math::FlxBasePoint this8 = this->offsetIdleText->scrollFactor;
HXDLIN( 118)			this8->set_x(( (Float)(0) ));
HXDLIN( 118)			this8->set_y(( (Float)(0) ));
            		}
...
HXLINE( 123)		 ::flixel::text::FlxText _hx_tmp12 = this->animText;
HXDLIN( 123)		::String key3 = (HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82));
HXDLIN( 123)		::Dynamic this9 = ::backend::Language_obj::phrases;
HXDLIN( 123)		::String str3 = ( ( ::haxe::ds::StringMap)(this9) )->get_string(::StringTools_obj::trim(key3).toLowerCase());
HXDLIN( 123)		if (::hx::IsNotNull( str3 )) {
HXLINE( 123)			key3 = str3;
            		}
HXDLIN( 123)		::String folderKey3 = key3;
HXDLIN( 123)		::String file3 = ::backend::Paths_obj::modFolders(folderKey3);
HXDLIN( 123)		::String _hx_tmp13;
HXDLIN( 123)		if (::sys::FileSystem_obj::exists(file3)) {
HXLINE( 123)			_hx_tmp13 = file3;
            		}
            		else {
HXLINE( 123)			_hx_tmp13 = (HX_("assets/",4c,2a,dc,36) + folderKey3);
            		}
HXDLIN( 123)		_hx_tmp12->setFormat(_hx_tmp13,24,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 124)		{
HXLINE( 124)			 ::flixel::math::FlxBasePoint this10 = this->animText->scrollFactor;
HXDLIN( 124)			this10->set_x(( (Float)(0) ));
HXDLIN( 124)			this10->set_y(( (Float)(0) ));
            		}
...
HXDLIN( 364)				 ::flixel::graphics::FlxGraphic image = ::backend::Paths_obj::image(key,parentFolder,null());
HXDLIN( 364)				::String xml = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),parentFolder,null());
HXDLIN( 364)				 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp;
HXDLIN( 364)				bool _hx_tmp1;
HXDLIN( 364)				if (!(::sys::FileSystem_obj::exists(xml))) {
HXLINE( 364)					_hx_tmp1 = ::lime::utils::Assets_obj::exists(xml,null());
            				}
            				else {
HXLINE( 364)					_hx_tmp1 = true;
            				}
HXDLIN( 364)				if (_hx_tmp1) {
HXLINE( 364)					_hx_tmp = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(image,::lime::utils::Assets_obj::getText(xml));
            				}
            				else {
HXLINE( 364)					::haxe::Log_obj::trace((((HX_("CRITICAL: XML not found for ",10,60,e6,9a) + key) + HX_(" at path: ",f8,de,24,03)) + xml),::hx::SourceInfo(HX_("source/backend/Paths.hx",ff,43,8c,3d),405,HX_("backend.Paths",34,17,99,92),HX_("getSparrowAtlas",55,ab,b7,a7)));
HXDLIN( 364)					_hx_tmp = null();
            				}
HXDLIN( 364)				_hx_char->set_frames(_hx_tmp);
HXLINE( 365)				_hx_char->jsonFile = this->character->jsonFile;
HXLINE( 366)				_hx_char->reloadAnimations();
HXLINE( 367)				Float _hx_tmp2 = _hx_char->get_width();
HXDLIN( 367)				_hx_char->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp2 * ::cutscenes::DialogueCharacter_obj::DEFAULT_SCALE) * ( (Float)(this->character->jsonFile->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic)) ))),null());
...
HXLINE( 375)			 ::cutscenes::DialogueCharacter _hx_tmp3 = this->character;
HXDLIN( 375)			int _hx_tmp4 = ::flixel::FlxG_obj::width;
HXDLIN( 375)			Float _hx_tmp5 = (( (Float)(_hx_tmp4) ) - this->character->get_width());
HXDLIN( 375)			_hx_tmp3->set_x((_hx_tmp5 + ::cutscenes::DialogueBoxPsych_obj::RIGHT_CHAR_X));
...
HXLINE( 389)			 ::flixel::text::FlxText _hx_tmp6 = this->offsetLoopText;
HXDLIN( 389)			_hx_tmp6->set_text((HX_("Loop: ",2a,ae,4d,96) + ::Std_obj::string( ::Dynamic(animShit->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic)))));
HXLINE( 390)			 ::flixel::text::FlxText _hx_tmp7 = this->offsetIdleText;
HXDLIN( 390)			_hx_tmp7->set_text((HX_("Idle: ",da,3a,cf,0b) + ::Std_obj::string( ::Dynamic(animShit->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic)))));
            		}
